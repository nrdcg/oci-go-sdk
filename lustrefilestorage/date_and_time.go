...
// DateAndTime A generic object to show date and time in the below specified format
type DateAndTime struct {

	// A user-friendly date.
	// Example: `2025-04-25`
	Date *string `mandatory:"false" json:"date"`
...
func (m DateAndTime) ValidateEnumValue() (bool, error) {
	errMessage := []string{}

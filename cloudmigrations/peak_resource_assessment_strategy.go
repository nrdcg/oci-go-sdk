...
func (m PeakResourceAssessmentStrategy) MarshalJSON() (buff []byte, e error) {
	type MarshalTypePeakResourceAssessmentStrategy PeakResourceAssessmentStrategy
	s := struct {
		DiscriminatorParam string `json:"strategyType"`
		MarshalTypePeakResourceAssessmentStrategy
	}{
		"PEAK",
		(MarshalTypePeakResourceAssessmentStrategy)(m),
	}

...
// UploadEmailSubdomainCertificateDetails Add certificate for email subdomain
type UploadEmailSubdomainCertificateDetails struct {
...
func (m UploadEmailSubdomainCertificateDetails) String() string {
...
func (m UploadEmailSubdomainCertificateDetails) ValidateEnumValue() (bool, error) {
	errMessage := []string{}

...
// MarketingBrandSummary marketing brand details for fusion environment
type MarketingBrandSummary struct {
...
func (m MarketingBrandSummary) String() string {
...
func (m MarketingBrandSummary) ValidateEnumValue() (bool, error) {
	errMessage := []string{}

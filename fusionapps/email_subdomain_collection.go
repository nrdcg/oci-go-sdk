...
// EmailSubdomainCollection Results of email subdomains for a marketing brand.
type EmailSubdomainCollection struct {

	// A page of EmailSubdomainSummary objects.
	Items []EmailSubdomainSummary `mandatory:"true" json:"items"`
}

func (m EmailSubdomainCollection) String() string {
...
func (m EmailSubdomainCollection) ValidateEnumValue() (bool, error) {
	errMessage := []string{}

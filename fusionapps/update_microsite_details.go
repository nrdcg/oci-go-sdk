...
// UpdateMicrositeDetails Details for microsite
type UpdateMicrositeDetails struct {
...
func (m UpdateMicrositeDetails) String() string {
...
func (m UpdateMicrositeDetails) ValidateEnumValue() (bool, error) {
	errMessage := []string{}

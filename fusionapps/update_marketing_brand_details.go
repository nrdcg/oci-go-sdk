...
// UpdateMarketingBrandDetails Details for marketing brand
type UpdateMarketingBrandDetails struct {
...
func (m UpdateMarketingBrandDetails) String() string {
...
func (m UpdateMarketingBrandDetails) ValidateEnumValue() (bool, error) {
	errMessage := []string{}

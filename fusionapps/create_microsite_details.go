...
// CreateMicrositeDetails Details for microsite.
type CreateMicrositeDetails struct {
...
func (m CreateMicrositeDetails) String() string {
...
func (m CreateMicrositeDetails) ValidateEnumValue() (bool, error) {
	errMessage := []string{}

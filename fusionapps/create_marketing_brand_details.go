...
// CreateMarketingBrandDetails Configuration details for marketing brand
type CreateMarketingBrandDetails struct {
...
func (m CreateMarketingBrandDetails) String() string {
...
func (m CreateMarketingBrandDetails) ValidateEnumValue() (bool, error) {
	errMessage := []string{}

...
func (request ListFusionEnvironmentsRequest) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
	if _, ok := GetMappingFusionEnvironmentLifecycleStateEnum(string(request.LifecycleState)); !ok && request.LifecycleState != "" {
		errMessage = append(errMessage, fmt.Sprintf("unsupported enum value for LifecycleState: %s. Supported values are: %s.", request.LifecycleState, strings.Join(GetFusionEnvironmentLifecycleStateEnumStringValues(), ",")))
	}
	if _, ok := GetMappingListFusionEnvironmentsSortOrderEnum(string(request.SortOrder)); !ok && request.SortOrder != "" {
		errMessage = append(errMessage, fmt.Sprintf("unsupported enum value for SortOrder: %s. Supported values are: %s.", request.SortOrder, strings.Join(GetListFusionEnvironmentsSortOrderEnumStringValues(), ",")))
	}
	if _, ok := GetMappingListFusionEnvironmentsSortByEnum(string(request.SortBy)); !ok && request.SortBy != "" {
		errMessage = append(errMessage, fmt.Sprintf("unsupported enum value for SortBy: %s. Supported values are: %s.", request.SortBy, strings.Join(GetListFusionEnvironmentsSortByEnumStringValues(), ",")))
	}
	if len(errMessage) > 0 {
...
var mappingListFusionEnvironmentsSortOrderEnum = map[string]ListFusionEnvironmentsSortOrderEnum{
	"ASC":  ListFusionEnvironmentsSortOrderAsc,
	"DESC": ListFusionEnvironmentsSortOrderDesc,
}

var mappingListFusionEnvironmentsSortOrderEnumLowerCase = map[string]ListFusionEnvironmentsSortOrderEnum{
	"asc":  ListFusionEnvironmentsSortOrderAsc,
	"desc": ListFusionEnvironmentsSortOrderDesc,
}
...
func GetListFusionEnvironmentsSortOrderEnumValues() []ListFusionEnvironmentsSortOrderEnum {
	values := make([]ListFusionEnvironmentsSortOrderEnum, 0)
	for _, v := range mappingListFusionEnvironmentsSortOrderEnum {
...
func GetMappingListFusionEnvironmentsSortOrderEnum(val string) (ListFusionEnvironmentsSortOrderEnum, bool) {
	enum, ok := mappingListFusionEnvironmentsSortOrderEnumLowerCase[strings.ToLower(val)]
	return enum, ok
}
...
var mappingListFusionEnvironmentsSortByEnum = map[string]ListFusionEnvironmentsSortByEnum{
	"TIME_CREATED": ListFusionEnvironmentsSortByTimeCreated,
	"DISPLAY_NAME": ListFusionEnvironmentsSortByDisplayName,
}

var mappingListFusionEnvironmentsSortByEnumLowerCase = map[string]ListFusionEnvironmentsSortByEnum{
	"time_created": ListFusionEnvironmentsSortByTimeCreated,
	"display_name": ListFusionEnvironmentsSortByDisplayName,
}
...
func GetListFusionEnvironmentsSortByEnumValues() []ListFusionEnvironmentsSortByEnum {
	values := make([]ListFusionEnvironmentsSortByEnum, 0)
	for _, v := range mappingListFusionEnvironmentsSortByEnum {
		values = append(values, v)
	}
	return values
}
...
func GetMappingListFusionEnvironmentsSortByEnum(val string) (ListFusionEnvironmentsSortByEnum, bool) {
	enum, ok := mappingListFusionEnvironmentsSortByEnumLowerCase[strings.ToLower(val)]
	return enum, ok
}

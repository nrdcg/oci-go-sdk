...
// MarketingBrandEmailSubdomainCsr email subdomain CSR response
type MarketingBrandEmailSubdomainCsr struct {
...
func (m MarketingBrandEmailSubdomainCsr) String() string {
...
func (m MarketingBrandEmailSubdomainCsr) ValidateEnumValue() (bool, error) {
	errMessage := []string{}

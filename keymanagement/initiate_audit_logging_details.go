...
// InitiateAuditLoggingDetails The information required for updating management audit logging details.
type InitiateAuditLoggingDetails struct {
...
func (m InitiateAuditLoggingDetails) String() string {
...
func (m InitiateAuditLoggingDetails) ValidateEnumValue() (bool, error) {
	errMessage := []string{}

...
type HsmCluster struct {
	...
	AuditLogConfig *HsmClusterAuditLoggingInfo `mandatory:"false" json:"auditLogConfig"`

	PendingInstructions *HsmClusterPendingInstructions `mandatory:"false" json:"pendingInstructions"`
}

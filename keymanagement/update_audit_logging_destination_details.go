...
// UpdateAuditLoggingDestinationDetails The information required for updating management audit logging details.
type UpdateAuditLoggingDestinationDetails struct {
...
func (m UpdateAuditLoggingDestinationDetails) String() string {
...
func (m UpdateAuditLoggingDestinationDetails) ValidateEnumValue() (bool, error) {
	errMessage := []string{}

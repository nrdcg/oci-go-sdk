...
// UpdateRegisteredVaultForMtlsDetails The details of the registered mTLS vault that you wish to update.
type UpdateRegisteredVaultForMtlsDetails struct {

	// Identifier of the fleet associated with the mTLS connection.
	FleetId *string `mandatory:"true" json:"fleetId"`
}

func (m UpdateRegisteredVaultForMtlsDetails) String() string {
...
func (m UpdateRegisteredVaultForMtlsDetails) ValidateEnumValue() (bool, error) {
	errMessage := []string{}

...
// GetDataFileRequest wrapper for the GetDataFile operation
//
// # See also
//
// Click https://docs.oracle.com/en-us/iaas/tools/go-sdk-examples/latest/apmconfig/GetDataFile.go.html to see an example of how to use GetDataFileRequest.
...
func (request GetDataFileRequest) String() string {
	return common.PointerString(request)
}

// HTTPRequest implements the OCIRequest interface
func (request GetDataFileRequest) HTTPRequest(method, path string, binaryRequestBody *common.OCIReadSeekCloser, extraHeaders map[string]string) (http.Request, error) {
...
func (request GetDataFileRequest) BinaryRequestBody() (*common.OCIReadSeekCloser, bool) {
...
func (request GetDataFileRequest) RetryPolicy() *common.RetryPolicy {
...
func (request GetDataFileRequest) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
	if len(errMessage) > 0 {
...
// GetDataFileResponse wrapper for the GetDataFile operation
...
func (response GetDataFileResponse) String() string {
	return common.PointerString(response)
}

// HTTPResponse implements the OCIResponse interface
func (response GetDataFileResponse) HTTPResponse() *http.Response {

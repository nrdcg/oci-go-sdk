...
func (request ListLimitsIncreaseRequestsRequest) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
	if _, ok := GetMappingListLimitsIncreaseRequestsSortOrderEnum(string(request.SortOrder)); !ok && request.SortOrder != "" {
		errMessage = append(errMessage, fmt.Sprintf("unsupported enum value for SortOrder: %s. Supported values are: %s.", request.SortOrder, strings.Join(GetListLimitsIncreaseRequestsSortOrderEnumStringValues(), ",")))
	}
	if _, ok := GetMappingListLimitsIncreaseRequestsSortByEnum(string(request.SortBy)); !ok && request.SortBy != "" {
		errMessage = append(errMessage, fmt.Sprintf("unsupported enum value for SortBy: %s. Supported values are: %s.", request.SortBy, strings.Join(GetListLimitsIncreaseRequestsSortByEnumStringValues(), ",")))
	}
	if len(errMessage) > 0 {
...
var mappingListLimitsIncreaseRequestsSortOrderEnum = map[string]ListLimitsIncreaseRequestsSortOrderEnum{
	"ASC":  ListLimitsIncreaseRequestsSortOrderAsc,
	"DESC": ListLimitsIncreaseRequestsSortOrderDesc,
}

var mappingListLimitsIncreaseRequestsSortOrderEnumLowerCase = map[string]ListLimitsIncreaseRequestsSortOrderEnum{
	"asc":  ListLimitsIncreaseRequestsSortOrderAsc,
	"desc": ListLimitsIncreaseRequestsSortOrderDesc,
}
...
func GetListLimitsIncreaseRequestsSortOrderEnumValues() []ListLimitsIncreaseRequestsSortOrderEnum {
	values := make([]ListLimitsIncreaseRequestsSortOrderEnum, 0)
	for _, v := range mappingListLimitsIncreaseRequestsSortOrderEnum {
...
func GetMappingListLimitsIncreaseRequestsSortOrderEnum(val string) (ListLimitsIncreaseRequestsSortOrderEnum, bool) {
	enum, ok := mappingListLimitsIncreaseRequestsSortOrderEnumLowerCase[strings.ToLower(val)]
	return enum, ok
}
...
var mappingListLimitsIncreaseRequestsSortByEnum = map[string]ListLimitsIncreaseRequestsSortByEnum{
	"timeCreated": ListLimitsIncreaseRequestsSortByTimecreated,
	"displayName": ListLimitsIncreaseRequestsSortByDisplayname,
}

var mappingListLimitsIncreaseRequestsSortByEnumLowerCase = map[string]ListLimitsIncreaseRequestsSortByEnum{
	"timecreated": ListLimitsIncreaseRequestsSortByTimecreated,
	"displayname": ListLimitsIncreaseRequestsSortByDisplayname,
}
...
func GetListLimitsIncreaseRequestsSortByEnumValues() []ListLimitsIncreaseRequestsSortByEnum {
	values := make([]ListLimitsIncreaseRequestsSortByEnum, 0)
	for _, v := range mappingListLimitsIncreaseRequestsSortByEnum {
		values = append(values, v)
	}
	return values
}
...
func GetMappingListLimitsIncreaseRequestsSortByEnum(val string) (ListLimitsIncreaseRequestsSortByEnum, bool) {
	enum, ok := mappingListLimitsIncreaseRequestsSortByEnumLowerCase[strings.ToLower(val)]
	return enum, ok
}

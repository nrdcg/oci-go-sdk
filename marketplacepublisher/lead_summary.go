...
// LeadSummary A placeholder for list of leads
type LeadSummary struct {
	...
	LifecycleState LeadLifecycleStateEnum `mandatory:"false" json:"lifecycleState,omitempty"`
...
func (m LeadSummary) String() string {
...
func (m LeadSummary) ValidateEnumValue() (bool, error) {
	errMessage := []string{}

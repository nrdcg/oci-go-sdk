...
// AdminListingRevisionPackageSummary The model for a summary of a package.
type AdminListingRevisionPackageSummary struct {
...
func (m AdminListingRevisionPackageSummary) String() string {
...
func (m AdminListingRevisionPackageSummary) ValidateEnumValue() (bool, error) {
	errMessage := []string{}

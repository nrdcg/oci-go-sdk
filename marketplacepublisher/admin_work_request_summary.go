...
// AdminWorkRequestSummary A summary of the status of a work request.
type AdminWorkRequestSummary struct {
...
func (m AdminWorkRequestSummary) String() string {
...
func (m AdminWorkRequestSummary) ValidateEnumValue() (bool, error) {
	errMessage := []string{}

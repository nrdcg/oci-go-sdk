...
// AdminOciListingRevision Listing revision details for listings
type AdminOciListingRevision struct {
	...
	Markets []AdminMarket `mandatory:"false" json:"markets"`
...
// GetId returns Id
func (m AdminOciListingRevision) GetId() *string {
	return m.Id
}

// GetLegacyId returns LegacyId
func (m AdminOciListingRevision) GetLegacyId() *string {
	return m.LegacyId
}

// GetListingId returns ListingId
func (m AdminOciListingRevision) GetListingId() *string {
	return m.ListingId
}

// GetCompartmentId returns CompartmentId
func (m AdminOciListingRevision) GetCompartmentId() *string {
	return m.CompartmentId
}

// GetPublisherId returns PublisherId
func (m AdminOciListingRevision) GetPublisherId() *string {
	return m.PublisherId
}

// GetApproverId returns ApproverId
func (m AdminOciListingRevision) GetApproverId() *string {
	return m.ApproverId
}

// GetApproverEmail returns ApproverEmail
func (m AdminOciListingRevision) GetApproverEmail() *string {
	return m.ApproverEmail
}

// GetDisplayName returns DisplayName
func (m AdminOciListingRevision) GetDisplayName() *string {
	return m.DisplayName
}

// GetRevisionNumber returns RevisionNumber
func (m AdminOciListingRevision) GetRevisionNumber() *string {
	return m.RevisionNumber
}

// GetHeadline returns Headline
func (m AdminOciListingRevision) GetHeadline() *string {
	return m.Headline
}

// GetTagline returns Tagline
func (m AdminOciListingRevision) GetTagline() *string {
	return m.Tagline
}

// GetKeywords returns Keywords
func (m AdminOciListingRevision) GetKeywords() *string {
	return m.Keywords
}

// GetShortDescription returns ShortDescription
func (m AdminOciListingRevision) GetShortDescription() *string {
	return m.ShortDescription
}

// GetUsageInformation returns UsageInformation
func (m AdminOciListingRevision) GetUsageInformation() *string {
	return m.UsageInformation
}

// GetLongDescription returns LongDescription
func (m AdminOciListingRevision) GetLongDescription() *string {
	return m.LongDescription
}

// GetTimeCreated returns TimeCreated
func (m AdminOciListingRevision) GetTimeCreated() *common.SDKTime {
	return m.TimeCreated
}

// GetTimeUpdated returns TimeUpdated
func (m AdminOciListingRevision) GetTimeUpdated() *common.SDKTime {
	return m.TimeUpdated
}

// GetContentLanguage returns ContentLanguage
func (m AdminOciListingRevision) GetContentLanguage() *LanguageItem {
	return m.ContentLanguage
}

// GetSupportedlanguages returns Supportedlanguages
func (m AdminOciListingRevision) GetSupportedlanguages() []LanguageItem {
	return m.Supportedlanguages
}

// GetSupportContacts returns SupportContacts
func (m AdminOciListingRevision) GetSupportContacts() []SupportContact {
	return m.SupportContacts
}

// GetSupportLinks returns SupportLinks
func (m AdminOciListingRevision) GetSupportLinks() []NamedLink {
	return m.SupportLinks
}

// GetIcon returns Icon
func (m AdminOciListingRevision) GetIcon() *ListingRevisionIconAttachment {
	return m.Icon
}

// GetBanner returns Banner
func (m AdminOciListingRevision) GetBanner() *ListingRevisionBannerAttachment {
	return m.Banner
}

// GetStatus returns Status
func (m AdminOciListingRevision) GetStatus() ListingRevisionStatusEnum {
	return m.Status
}

// GetStatusNotes returns StatusNotes
func (m AdminOciListingRevision) GetStatusNotes() *string {
	return m.StatusNotes
}

// GetLifecycleState returns LifecycleState
func (m AdminOciListingRevision) GetLifecycleState() ListingRevisionLifecycleStateEnum {
	return m.LifecycleState
}

// GetPackageType returns PackageType
func (m AdminOciListingRevision) GetPackageType() PackageTypeEnum {
	return m.PackageType
}

// GetExtendedMetadata returns ExtendedMetadata
func (m AdminOciListingRevision) GetExtendedMetadata() map[string]string {
	return m.ExtendedMetadata
}

// GetFreeformTags returns FreeformTags
func (m AdminOciListingRevision) GetFreeformTags() map[string]string {
	return m.FreeformTags
}

// GetDefinedTags returns DefinedTags
func (m AdminOciListingRevision) GetDefinedTags() map[string]map[string]interface{} {
	return m.DefinedTags
}

// GetSystemTags returns SystemTags
func (m AdminOciListingRevision) GetSystemTags() map[string]map[string]interface{} {
	return m.SystemTags
}

func (m AdminOciListingRevision) String() string {
...
func (m AdminOciListingRevision) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
...
func (m AdminOciListingRevision) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeAdminOciListingRevision AdminOciListingRevision
	s := struct {
		DiscriminatorParam string `json:"listingType"`
		MarshalTypeAdminOciListingRevision
	}{
		"OCI_APPLICATION",
		(MarshalTypeAdminOciListingRevision)(m),
	}
...
func (m *AdminOciListingRevision) UnmarshalJSON(data []byte) (e error) {
	model := struct {
		...
		Markets                         []AdminMarket                     `json:"markets"`
	...
	m.ApproverId = model.ApproverId

	m.ApproverEmail = model.ApproverEmail
	...
	m.Markets = make([]AdminMarket, len(model.Markets))

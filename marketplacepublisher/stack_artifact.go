...
// StackArtifact Stack artifact details.
...
// GetId returns Id
func (m StackArtifact) GetId() *string {
	return m.Id
}

// GetDisplayName returns DisplayName
func (m StackArtifact) GetDisplayName() *string {
	return m.DisplayName
}

// GetStatus returns Status
func (m StackArtifact) GetStatus() ArtifactStatusEnum {
	return m.Status
}

// GetStatusNotes returns StatusNotes
func (m StackArtifact) GetStatusNotes() *string {
	return m.StatusNotes
}

// GetLifecycleState returns LifecycleState
func (m StackArtifact) GetLifecycleState() ArtifactLifecycleStateEnum {
	return m.LifecycleState
}

// GetTimeCreated returns TimeCreated
func (m StackArtifact) GetTimeCreated() *common.SDKTime {
	return m.TimeCreated
}

// GetCompartmentId returns CompartmentId
func (m StackArtifact) GetCompartmentId() *string {
	return m.CompartmentId
}

// GetPublisherId returns PublisherId
func (m StackArtifact) GetPublisherId() *string {
	return m.PublisherId
}

// GetTimeUpdated returns TimeUpdated
func (m StackArtifact) GetTimeUpdated() *common.SDKTime {
	return m.TimeUpdated
}

// GetFreeformTags returns FreeformTags
func (m StackArtifact) GetFreeformTags() map[string]string {
	return m.FreeformTags
}

// GetDefinedTags returns DefinedTags
func (m StackArtifact) GetDefinedTags() map[string]map[string]interface{} {
	return m.DefinedTags
}

// GetSystemTags returns SystemTags
func (m StackArtifact) GetSystemTags() map[string]map[string]interface{} {
	return m.SystemTags
}

func (m StackArtifact) String() string {
...
func (m StackArtifact) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
...
func (m StackArtifact) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeStackArtifact StackArtifact
	s := struct {
		DiscriminatorParam string `json:"artifactType"`
		MarshalTypeStackArtifact
	}{
		"STACK",
		(MarshalTypeStackArtifact)(m),
	}

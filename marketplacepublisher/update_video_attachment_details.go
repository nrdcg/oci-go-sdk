...
func (m UpdateVideoAttachmentDetails) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeUpdateVideoAttachmentDetails UpdateVideoAttachmentDetails
	s := struct {
		DiscriminatorParam string `json:"attachmentType"`
		MarshalTypeUpdateVideoAttachmentDetails
	}{
		"VIDEO",
		(MarshalTypeUpdateVideoAttachmentDetails)(m),
	}

...
// AdminTermVersionSummary The model for the admin term version summary.
type AdminTermVersionSummary struct {
...
func (m AdminTermVersionSummary) String() string {
...
func (m AdminTermVersionSummary) ValidateEnumValue() (bool, error) {
	errMessage := []string{}

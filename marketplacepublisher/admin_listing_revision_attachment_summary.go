...
// AdminListingRevisionAttachmentSummary The model for a summary of a admin listing revision related attachments.
type AdminListingRevisionAttachmentSummary struct {
...
func (m AdminListingRevisionAttachmentSummary) String() string {
...
func (m AdminListingRevisionAttachmentSummary) ValidateEnumValue() (bool, error) {
	errMessage := []string{}

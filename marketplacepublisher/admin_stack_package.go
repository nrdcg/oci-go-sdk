...
// AdminStackPackage A package for Stack listings.
type AdminStackPackage struct {
...
// GetId returns Id
func (m AdminStackPackage) GetId() *string {
	return m.Id
}

// GetLegacyId returns LegacyId
func (m AdminStackPackage) GetLegacyId() *string {
	return m.LegacyId
}

// GetDisplayName returns DisplayName
func (m AdminStackPackage) GetDisplayName() *string {
	return m.DisplayName
}

// GetDescription returns Description
func (m AdminStackPackage) GetDescription() *string {
	return m.Description
}

// GetListingRevisionId returns ListingRevisionId
func (m AdminStackPackage) GetListingRevisionId() *string {
	return m.ListingRevisionId
}

// GetCompartmentId returns CompartmentId
func (m AdminStackPackage) GetCompartmentId() *string {
	return m.CompartmentId
}

// GetArtifactId returns ArtifactId
func (m AdminStackPackage) GetArtifactId() *string {
	return m.ArtifactId
}

// GetTermId returns TermId
func (m AdminStackPackage) GetTermId() *string {
	return m.TermId
}

// GetPackageVersion returns PackageVersion
func (m AdminStackPackage) GetPackageVersion() *string {
	return m.PackageVersion
}

// GetLifecycleState returns LifecycleState
func (m AdminStackPackage) GetLifecycleState() ListingRevisionPackageLifecycleStateEnum {
	return m.LifecycleState
}

// GetStatus returns Status
func (m AdminStackPackage) GetStatus() ListingRevisionPackageStatusEnum {
	return m.Status
}

// GetAreSecurityUpgradesProvided returns AreSecurityUpgradesProvided
func (m AdminStackPackage) GetAreSecurityUpgradesProvided() *bool {
	return m.AreSecurityUpgradesProvided
}

// GetIsDefault returns IsDefault
func (m AdminStackPackage) GetIsDefault() *bool {
	return m.IsDefault
}

// GetTimeCreated returns TimeCreated
func (m AdminStackPackage) GetTimeCreated() *common.SDKTime {
	return m.TimeCreated
}

// GetTimeUpdated returns TimeUpdated
func (m AdminStackPackage) GetTimeUpdated() *common.SDKTime {
	return m.TimeUpdated
}

// GetExtendedMetadata returns ExtendedMetadata
func (m AdminStackPackage) GetExtendedMetadata() map[string]string {
	return m.ExtendedMetadata
}

// GetFreeformTags returns FreeformTags
func (m AdminStackPackage) GetFreeformTags() map[string]string {
	return m.FreeformTags
}

// GetDefinedTags returns DefinedTags
func (m AdminStackPackage) GetDefinedTags() map[string]map[string]interface{} {
	return m.DefinedTags
}

// GetSystemTags returns SystemTags
func (m AdminStackPackage) GetSystemTags() map[string]map[string]interface{} {
	return m.SystemTags
}

func (m AdminStackPackage) String() string {
...
func (m AdminStackPackage) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
...
func (m AdminStackPackage) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeAdminStackPackage AdminStackPackage
	s := struct {
		DiscriminatorParam string `json:"packageType"`
		MarshalTypeAdminStackPackage
	}{
		"STACK",
		(MarshalTypeAdminStackPackage)(m),
	}

...
// AdminReviewSupportDocumentAttachment Review support attachment for the listing revision.
type AdminReviewSupportDocumentAttachment struct {
...
// GetId returns Id
func (m AdminReviewSupportDocumentAttachment) GetId() *string {
	return m.Id
}

// GetCompartmentId returns CompartmentId
func (m AdminReviewSupportDocumentAttachment) GetCompartmentId() *string {
	return m.CompartmentId
}

// GetListingRevisionId returns ListingRevisionId
func (m AdminReviewSupportDocumentAttachment) GetListingRevisionId() *string {
	return m.ListingRevisionId
}

// GetDisplayName returns DisplayName
func (m AdminReviewSupportDocumentAttachment) GetDisplayName() *string {
	return m.DisplayName
}

// GetDescription returns Description
func (m AdminReviewSupportDocumentAttachment) GetDescription() *string {
	return m.Description
}

// GetSourceType returns SourceType
func (m AdminReviewSupportDocumentAttachment) GetSourceType() ListingRevisionAttachmentSourceTypeEnum {
	return m.SourceType
}

// GetLifecycleState returns LifecycleState
func (m AdminReviewSupportDocumentAttachment) GetLifecycleState() ListingRevisionAttachmentLifecycleStateEnum {
	return m.LifecycleState
}

// GetTimeCreated returns TimeCreated
func (m AdminReviewSupportDocumentAttachment) GetTimeCreated() *common.SDKTime {
	return m.TimeCreated
}

// GetTimeUpdated returns TimeUpdated
func (m AdminReviewSupportDocumentAttachment) GetTimeUpdated() *common.SDKTime {
	return m.TimeUpdated
}

// GetFreeformTags returns FreeformTags
func (m AdminReviewSupportDocumentAttachment) GetFreeformTags() map[string]string {
	return m.FreeformTags
}

// GetDefinedTags returns DefinedTags
func (m AdminReviewSupportDocumentAttachment) GetDefinedTags() map[string]map[string]interface{} {
	return m.DefinedTags
}

// GetSystemTags returns SystemTags
func (m AdminReviewSupportDocumentAttachment) GetSystemTags() map[string]map[string]interface{} {
	return m.SystemTags
}

func (m AdminReviewSupportDocumentAttachment) String() string {
...
func (m AdminReviewSupportDocumentAttachment) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
...
func (m AdminReviewSupportDocumentAttachment) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeAdminReviewSupportDocumentAttachment AdminReviewSupportDocumentAttachment
	s := struct {
		DiscriminatorParam string `json:"attachmentType"`
		MarshalTypeAdminReviewSupportDocumentAttachment
	}{
		"REVIEW_SUPPORT_DOCUMENT",
		(MarshalTypeAdminReviewSupportDocumentAttachment)(m),
	}

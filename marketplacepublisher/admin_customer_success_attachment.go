...
// AdminCustomerSuccessAttachment Customer success attachment for the listing revision.
type AdminCustomerSuccessAttachment struct {
...
// GetId returns Id
func (m AdminCustomerSuccessAttachment) GetId() *string {
	return m.Id
}

// GetCompartmentId returns CompartmentId
func (m AdminCustomerSuccessAttachment) GetCompartmentId() *string {
	return m.CompartmentId
}

// GetListingRevisionId returns ListingRevisionId
func (m AdminCustomerSuccessAttachment) GetListingRevisionId() *string {
	return m.ListingRevisionId
}

// GetDisplayName returns DisplayName
func (m AdminCustomerSuccessAttachment) GetDisplayName() *string {
	return m.DisplayName
}

// GetDescription returns Description
func (m AdminCustomerSuccessAttachment) GetDescription() *string {
	return m.Description
}

// GetSourceType returns SourceType
func (m AdminCustomerSuccessAttachment) GetSourceType() ListingRevisionAttachmentSourceTypeEnum {
	return m.SourceType
}

// GetLifecycleState returns LifecycleState
func (m AdminCustomerSuccessAttachment) GetLifecycleState() ListingRevisionAttachmentLifecycleStateEnum {
	return m.LifecycleState
}

// GetTimeCreated returns TimeCreated
func (m AdminCustomerSuccessAttachment) GetTimeCreated() *common.SDKTime {
	return m.TimeCreated
}

// GetTimeUpdated returns TimeUpdated
func (m AdminCustomerSuccessAttachment) GetTimeUpdated() *common.SDKTime {
	return m.TimeUpdated
}

// GetFreeformTags returns FreeformTags
func (m AdminCustomerSuccessAttachment) GetFreeformTags() map[string]string {
	return m.FreeformTags
}

// GetDefinedTags returns DefinedTags
func (m AdminCustomerSuccessAttachment) GetDefinedTags() map[string]map[string]interface{} {
	return m.DefinedTags
}

// GetSystemTags returns SystemTags
func (m AdminCustomerSuccessAttachment) GetSystemTags() map[string]map[string]interface{} {
	return m.SystemTags
}

func (m AdminCustomerSuccessAttachment) String() string {
...
func (m AdminCustomerSuccessAttachment) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
...
func (m AdminCustomerSuccessAttachment) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeAdminCustomerSuccessAttachment AdminCustomerSuccessAttachment
	s := struct {
		DiscriminatorParam string `json:"attachmentType"`
		MarshalTypeAdminCustomerSuccessAttachment
	}{
		"CUSTOMER_SUCCESS",
		(MarshalTypeAdminCustomerSuccessAttachment)(m),
	}

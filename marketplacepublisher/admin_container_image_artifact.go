...
// AdminContainerImageArtifact Container Image artifact details.
type AdminContainerImageArtifact struct {
...
// GetId returns Id
func (m AdminContainerImageArtifact) GetId() *string {
	return m.Id
}

// GetLegacyId returns LegacyId
func (m AdminContainerImageArtifact) GetLegacyId() *string {
	return m.LegacyId
}

// GetDisplayName returns DisplayName
func (m AdminContainerImageArtifact) GetDisplayName() *string {
	return m.DisplayName
}

// GetStatus returns Status
func (m AdminContainerImageArtifact) GetStatus() ArtifactStatusEnum {
	return m.Status
}

// GetStatusNotes returns StatusNotes
func (m AdminContainerImageArtifact) GetStatusNotes() *string {
	return m.StatusNotes
}

// GetLifecycleState returns LifecycleState
func (m AdminContainerImageArtifact) GetLifecycleState() ArtifactLifecycleStateEnum {
	return m.LifecycleState
}

// GetTimeCreated returns TimeCreated
func (m AdminContainerImageArtifact) GetTimeCreated() *common.SDKTime {
	return m.TimeCreated
}

// GetCompartmentId returns CompartmentId
func (m AdminContainerImageArtifact) GetCompartmentId() *string {
	return m.CompartmentId
}

// GetPublisherId returns PublisherId
func (m AdminContainerImageArtifact) GetPublisherId() *string {
	return m.PublisherId
}

// GetTimeUpdated returns TimeUpdated
func (m AdminContainerImageArtifact) GetTimeUpdated() *common.SDKTime {
	return m.TimeUpdated
}

// GetFreeformTags returns FreeformTags
func (m AdminContainerImageArtifact) GetFreeformTags() map[string]string {
	return m.FreeformTags
}

// GetDefinedTags returns DefinedTags
func (m AdminContainerImageArtifact) GetDefinedTags() map[string]map[string]interface{} {
	return m.DefinedTags
}

// GetSystemTags returns SystemTags
func (m AdminContainerImageArtifact) GetSystemTags() map[string]map[string]interface{} {
	return m.SystemTags
}

func (m AdminContainerImageArtifact) String() string {
...
func (m AdminContainerImageArtifact) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
...
func (m AdminContainerImageArtifact) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeAdminContainerImageArtifact AdminContainerImageArtifact
	s := struct {
		DiscriminatorParam string `json:"artifactType"`
		MarshalTypeAdminContainerImageArtifact
	}{
		"CONTAINER_IMAGE",
		(MarshalTypeAdminContainerImageArtifact)(m),
	}

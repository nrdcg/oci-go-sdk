...
// AdminTermSummary The model for the term summary.
type AdminTermSummary struct {
...
func (m AdminTermSummary) String() string {
...
func (m AdminTermSummary) ValidateEnumValue() (bool, error) {
	errMessage := []string{}

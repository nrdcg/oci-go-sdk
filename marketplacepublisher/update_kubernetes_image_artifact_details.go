...
func (m UpdateKubernetesImageArtifactDetails) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeUpdateKubernetesImageArtifactDetails UpdateKubernetesImageArtifactDetails
	s := struct {
		DiscriminatorParam string `json:"artifactType"`
		MarshalTypeUpdateKubernetesImageArtifactDetails
	}{
		"HELM_CHART",
		(MarshalTypeUpdateKubernetesImageArtifactDetails)(m),
	}

...
// AdminScreenShotAttachment Screenshot attachment for the listing revision.
type AdminScreenShotAttachment struct {
...
// GetId returns Id
func (m AdminScreenShotAttachment) GetId() *string {
	return m.Id
}

// GetCompartmentId returns CompartmentId
func (m AdminScreenShotAttachment) GetCompartmentId() *string {
	return m.CompartmentId
}

// GetListingRevisionId returns ListingRevisionId
func (m AdminScreenShotAttachment) GetListingRevisionId() *string {
	return m.ListingRevisionId
}

// GetDisplayName returns DisplayName
func (m AdminScreenShotAttachment) GetDisplayName() *string {
	return m.DisplayName
}

// GetDescription returns Description
func (m AdminScreenShotAttachment) GetDescription() *string {
	return m.Description
}

// GetSourceType returns SourceType
func (m AdminScreenShotAttachment) GetSourceType() ListingRevisionAttachmentSourceTypeEnum {
	return m.SourceType
}

// GetLifecycleState returns LifecycleState
func (m AdminScreenShotAttachment) GetLifecycleState() ListingRevisionAttachmentLifecycleStateEnum {
	return m.LifecycleState
}

// GetTimeCreated returns TimeCreated
func (m AdminScreenShotAttachment) GetTimeCreated() *common.SDKTime {
	return m.TimeCreated
}

// GetTimeUpdated returns TimeUpdated
func (m AdminScreenShotAttachment) GetTimeUpdated() *common.SDKTime {
	return m.TimeUpdated
}

// GetFreeformTags returns FreeformTags
func (m AdminScreenShotAttachment) GetFreeformTags() map[string]string {
	return m.FreeformTags
}

// GetDefinedTags returns DefinedTags
func (m AdminScreenShotAttachment) GetDefinedTags() map[string]map[string]interface{} {
	return m.DefinedTags
}

// GetSystemTags returns SystemTags
func (m AdminScreenShotAttachment) GetSystemTags() map[string]map[string]interface{} {
	return m.SystemTags
}

func (m AdminScreenShotAttachment) String() string {
...
func (m AdminScreenShotAttachment) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
...
func (m AdminScreenShotAttachment) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeAdminScreenShotAttachment AdminScreenShotAttachment
	s := struct {
		DiscriminatorParam string `json:"attachmentType"`
		MarshalTypeAdminScreenShotAttachment
	}{
		"SCREENSHOT",
		(MarshalTypeAdminScreenShotAttachment)(m),
	}

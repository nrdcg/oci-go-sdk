...
// AdminContainerPackage A package for container image listings.
type AdminContainerPackage struct {
...
// GetId returns Id
func (m AdminContainerPackage) GetId() *string {
	return m.Id
}

// GetLegacyId returns LegacyId
func (m AdminContainerPackage) GetLegacyId() *string {
	return m.LegacyId
}

// GetDisplayName returns DisplayName
func (m AdminContainerPackage) GetDisplayName() *string {
	return m.DisplayName
}

// GetDescription returns Description
func (m AdminContainerPackage) GetDescription() *string {
	return m.Description
}

// GetListingRevisionId returns ListingRevisionId
func (m AdminContainerPackage) GetListingRevisionId() *string {
	return m.ListingRevisionId
}

// GetCompartmentId returns CompartmentId
func (m AdminContainerPackage) GetCompartmentId() *string {
	return m.CompartmentId
}

// GetArtifactId returns ArtifactId
func (m AdminContainerPackage) GetArtifactId() *string {
	return m.ArtifactId
}

// GetTermId returns TermId
func (m AdminContainerPackage) GetTermId() *string {
	return m.TermId
}

// GetPackageVersion returns PackageVersion
func (m AdminContainerPackage) GetPackageVersion() *string {
	return m.PackageVersion
}

// GetLifecycleState returns LifecycleState
func (m AdminContainerPackage) GetLifecycleState() ListingRevisionPackageLifecycleStateEnum {
	return m.LifecycleState
}

// GetStatus returns Status
func (m AdminContainerPackage) GetStatus() ListingRevisionPackageStatusEnum {
	return m.Status
}

// GetAreSecurityUpgradesProvided returns AreSecurityUpgradesProvided
func (m AdminContainerPackage) GetAreSecurityUpgradesProvided() *bool {
	return m.AreSecurityUpgradesProvided
}

// GetIsDefault returns IsDefault
func (m AdminContainerPackage) GetIsDefault() *bool {
	return m.IsDefault
}

// GetTimeCreated returns TimeCreated
func (m AdminContainerPackage) GetTimeCreated() *common.SDKTime {
	return m.TimeCreated
}

// GetTimeUpdated returns TimeUpdated
func (m AdminContainerPackage) GetTimeUpdated() *common.SDKTime {
	return m.TimeUpdated
}

// GetExtendedMetadata returns ExtendedMetadata
func (m AdminContainerPackage) GetExtendedMetadata() map[string]string {
	return m.ExtendedMetadata
}

// GetFreeformTags returns FreeformTags
func (m AdminContainerPackage) GetFreeformTags() map[string]string {
	return m.FreeformTags
}

// GetDefinedTags returns DefinedTags
func (m AdminContainerPackage) GetDefinedTags() map[string]map[string]interface{} {
	return m.DefinedTags
}

// GetSystemTags returns SystemTags
func (m AdminContainerPackage) GetSystemTags() map[string]map[string]interface{} {
	return m.SystemTags
}

func (m AdminContainerPackage) String() string {
...
func (m AdminContainerPackage) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
...
func (m AdminContainerPackage) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeAdminContainerPackage AdminContainerPackage
	s := struct {
		DiscriminatorParam string `json:"packageType"`
		MarshalTypeAdminContainerPackage
	}{
		"CONTAINER_IMAGE",
		(MarshalTypeAdminContainerPackage)(m),
	}

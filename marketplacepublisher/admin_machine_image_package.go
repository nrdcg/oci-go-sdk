...
// AdminMachineImagePackage A package for machine image listings.
type AdminMachineImagePackage struct {
	...
	MachineImageDetails *MachineImagePackageDetails `mandatory:"false" json:"machineImageDetails"`
...
// GetId returns Id
func (m AdminMachineImagePackage) GetId() *string {
	return m.Id
}

// GetLegacyId returns LegacyId
func (m AdminMachineImagePackage) GetLegacyId() *string {
	return m.LegacyId
}

// GetDisplayName returns DisplayName
func (m AdminMachineImagePackage) GetDisplayName() *string {
	return m.DisplayName
}

// GetDescription returns Description
func (m AdminMachineImagePackage) GetDescription() *string {
	return m.Description
}

// GetListingRevisionId returns ListingRevisionId
func (m AdminMachineImagePackage) GetListingRevisionId() *string {
	return m.ListingRevisionId
}

// GetCompartmentId returns CompartmentId
func (m AdminMachineImagePackage) GetCompartmentId() *string {
	return m.CompartmentId
}

// GetArtifactId returns ArtifactId
func (m AdminMachineImagePackage) GetArtifactId() *string {
	return m.ArtifactId
}

// GetTermId returns TermId
func (m AdminMachineImagePackage) GetTermId() *string {
	return m.TermId
}

// GetPackageVersion returns PackageVersion
func (m AdminMachineImagePackage) GetPackageVersion() *string {
	return m.PackageVersion
}

// GetLifecycleState returns LifecycleState
func (m AdminMachineImagePackage) GetLifecycleState() ListingRevisionPackageLifecycleStateEnum {
	return m.LifecycleState
}

// GetStatus returns Status
func (m AdminMachineImagePackage) GetStatus() ListingRevisionPackageStatusEnum {
	return m.Status
}

// GetAreSecurityUpgradesProvided returns AreSecurityUpgradesProvided
func (m AdminMachineImagePackage) GetAreSecurityUpgradesProvided() *bool {
	return m.AreSecurityUpgradesProvided
}

// GetIsDefault returns IsDefault
func (m AdminMachineImagePackage) GetIsDefault() *bool {
	return m.IsDefault
}

// GetTimeCreated returns TimeCreated
func (m AdminMachineImagePackage) GetTimeCreated() *common.SDKTime {
	return m.TimeCreated
}

// GetTimeUpdated returns TimeUpdated
func (m AdminMachineImagePackage) GetTimeUpdated() *common.SDKTime {
	return m.TimeUpdated
}

// GetExtendedMetadata returns ExtendedMetadata
func (m AdminMachineImagePackage) GetExtendedMetadata() map[string]string {
	return m.ExtendedMetadata
}

// GetFreeformTags returns FreeformTags
func (m AdminMachineImagePackage) GetFreeformTags() map[string]string {
	return m.FreeformTags
}

// GetDefinedTags returns DefinedTags
func (m AdminMachineImagePackage) GetDefinedTags() map[string]map[string]interface{} {
	return m.DefinedTags
}

// GetSystemTags returns SystemTags
func (m AdminMachineImagePackage) GetSystemTags() map[string]map[string]interface{} {
	return m.SystemTags
}

func (m AdminMachineImagePackage) String() string {
...
func (m AdminMachineImagePackage) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
...
func (m AdminMachineImagePackage) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeAdminMachineImagePackage AdminMachineImagePackage
	s := struct {
		DiscriminatorParam string `json:"packageType"`
		MarshalTypeAdminMachineImagePackage
	}{
		"MACHINE_IMAGE",
		(MarshalTypeAdminMachineImagePackage)(m),
	}

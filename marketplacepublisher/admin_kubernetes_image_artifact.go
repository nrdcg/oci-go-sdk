...
// AdminKubernetesImageArtifact Kubernetes HelmChart Image artifact details.
type AdminKubernetesImageArtifact struct {
...
// GetId returns Id
func (m AdminKubernetesImageArtifact) GetId() *string {
	return m.Id
}

// GetLegacyId returns LegacyId
func (m AdminKubernetesImageArtifact) GetLegacyId() *string {
	return m.LegacyId
}

// GetDisplayName returns DisplayName
func (m AdminKubernetesImageArtifact) GetDisplayName() *string {
	return m.DisplayName
}

// GetStatus returns Status
func (m AdminKubernetesImageArtifact) GetStatus() ArtifactStatusEnum {
	return m.Status
}

// GetStatusNotes returns StatusNotes
func (m AdminKubernetesImageArtifact) GetStatusNotes() *string {
	return m.StatusNotes
}

// GetLifecycleState returns LifecycleState
func (m AdminKubernetesImageArtifact) GetLifecycleState() ArtifactLifecycleStateEnum {
	return m.LifecycleState
}

// GetTimeCreated returns TimeCreated
func (m AdminKubernetesImageArtifact) GetTimeCreated() *common.SDKTime {
	return m.TimeCreated
}

// GetCompartmentId returns CompartmentId
func (m AdminKubernetesImageArtifact) GetCompartmentId() *string {
	return m.CompartmentId
}

// GetPublisherId returns PublisherId
func (m AdminKubernetesImageArtifact) GetPublisherId() *string {
	return m.PublisherId
}

// GetTimeUpdated returns TimeUpdated
func (m AdminKubernetesImageArtifact) GetTimeUpdated() *common.SDKTime {
	return m.TimeUpdated
}

// GetFreeformTags returns FreeformTags
func (m AdminKubernetesImageArtifact) GetFreeformTags() map[string]string {
	return m.FreeformTags
}

// GetDefinedTags returns DefinedTags
func (m AdminKubernetesImageArtifact) GetDefinedTags() map[string]map[string]interface{} {
	return m.DefinedTags
}

// GetSystemTags returns SystemTags
func (m AdminKubernetesImageArtifact) GetSystemTags() map[string]map[string]interface{} {
	return m.SystemTags
}

func (m AdminKubernetesImageArtifact) String() string {
...
func (m AdminKubernetesImageArtifact) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
...
func (m AdminKubernetesImageArtifact) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeAdminKubernetesImageArtifact AdminKubernetesImageArtifact
	s := struct {
		DiscriminatorParam string `json:"artifactType"`
		MarshalTypeAdminKubernetesImageArtifact
	}{
		"HELM_CHART",
		(MarshalTypeAdminKubernetesImageArtifact)(m),
	}

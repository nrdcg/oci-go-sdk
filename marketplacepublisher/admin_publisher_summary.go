...
// AdminPublisherSummary The model for a publisher.
type AdminPublisherSummary struct {
...
func (m AdminPublisherSummary) String() string {
...
func (m AdminPublisherSummary) ValidateEnumValue() (bool, error) {
	errMessage := []string{}

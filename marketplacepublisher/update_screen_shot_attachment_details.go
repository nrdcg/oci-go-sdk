...
func (m UpdateScreenShotAttachmentDetails) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeUpdateScreenShotAttachmentDetails UpdateScreenShotAttachmentDetails
	s := struct {
		DiscriminatorParam string `json:"attachmentType"`
		MarshalTypeUpdateScreenShotAttachmentDetails
	}{
		"SCREENSHOT",
		(MarshalTypeUpdateScreenShotAttachmentDetails)(m),
	}

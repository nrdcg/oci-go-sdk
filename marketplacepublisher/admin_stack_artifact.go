...
// AdminStackArtifact Stack artifact details.
type AdminStackArtifact struct {
	...
	Stack *StackArtifactDetails `mandatory:"true" json:"stack"`
...
// GetId returns Id
func (m AdminStackArtifact) GetId() *string {
	return m.Id
}

// GetLegacyId returns LegacyId
func (m AdminStackArtifact) GetLegacyId() *string {
	return m.LegacyId
}

// GetDisplayName returns DisplayName
func (m AdminStackArtifact) GetDisplayName() *string {
	return m.DisplayName
}

// GetStatus returns Status
func (m AdminStackArtifact) GetStatus() ArtifactStatusEnum {
	return m.Status
}

// GetStatusNotes returns StatusNotes
func (m AdminStackArtifact) GetStatusNotes() *string {
	return m.StatusNotes
}

// GetLifecycleState returns LifecycleState
func (m AdminStackArtifact) GetLifecycleState() ArtifactLifecycleStateEnum {
	return m.LifecycleState
}

// GetTimeCreated returns TimeCreated
func (m AdminStackArtifact) GetTimeCreated() *common.SDKTime {
	return m.TimeCreated
}

// GetCompartmentId returns CompartmentId
func (m AdminStackArtifact) GetCompartmentId() *string {
	return m.CompartmentId
}

// GetPublisherId returns PublisherId
func (m AdminStackArtifact) GetPublisherId() *string {
	return m.PublisherId
}

// GetTimeUpdated returns TimeUpdated
func (m AdminStackArtifact) GetTimeUpdated() *common.SDKTime {
	return m.TimeUpdated
}

// GetFreeformTags returns FreeformTags
func (m AdminStackArtifact) GetFreeformTags() map[string]string {
	return m.FreeformTags
}

// GetDefinedTags returns DefinedTags
func (m AdminStackArtifact) GetDefinedTags() map[string]map[string]interface{} {
	return m.DefinedTags
}

// GetSystemTags returns SystemTags
func (m AdminStackArtifact) GetSystemTags() map[string]map[string]interface{} {
	return m.SystemTags
}

func (m AdminStackArtifact) String() string {
...
func (m AdminStackArtifact) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
...
func (m AdminStackArtifact) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeAdminStackArtifact AdminStackArtifact
	s := struct {
		DiscriminatorParam string `json:"artifactType"`
		MarshalTypeAdminStackArtifact
	}{
		"STACK",
		(MarshalTypeAdminStackArtifact)(m),
	}

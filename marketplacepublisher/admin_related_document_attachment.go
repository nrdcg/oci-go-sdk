...
// AdminRelatedDocumentAttachment Related document attachment for the listing revision.
type AdminRelatedDocumentAttachment struct {
...
// GetId returns Id
func (m AdminRelatedDocumentAttachment) GetId() *string {
	return m.Id
}

// GetCompartmentId returns CompartmentId
func (m AdminRelatedDocumentAttachment) GetCompartmentId() *string {
	return m.CompartmentId
}

// GetListingRevisionId returns ListingRevisionId
func (m AdminRelatedDocumentAttachment) GetListingRevisionId() *string {
	return m.ListingRevisionId
}

// GetDisplayName returns DisplayName
func (m AdminRelatedDocumentAttachment) GetDisplayName() *string {
	return m.DisplayName
}

// GetDescription returns Description
func (m AdminRelatedDocumentAttachment) GetDescription() *string {
	return m.Description
}

// GetSourceType returns SourceType
func (m AdminRelatedDocumentAttachment) GetSourceType() ListingRevisionAttachmentSourceTypeEnum {
	return m.SourceType
}

// GetLifecycleState returns LifecycleState
func (m AdminRelatedDocumentAttachment) GetLifecycleState() ListingRevisionAttachmentLifecycleStateEnum {
	return m.LifecycleState
}

// GetTimeCreated returns TimeCreated
func (m AdminRelatedDocumentAttachment) GetTimeCreated() *common.SDKTime {
	return m.TimeCreated
}

// GetTimeUpdated returns TimeUpdated
func (m AdminRelatedDocumentAttachment) GetTimeUpdated() *common.SDKTime {
	return m.TimeUpdated
}

// GetFreeformTags returns FreeformTags
func (m AdminRelatedDocumentAttachment) GetFreeformTags() map[string]string {
	return m.FreeformTags
}

// GetDefinedTags returns DefinedTags
func (m AdminRelatedDocumentAttachment) GetDefinedTags() map[string]map[string]interface{} {
	return m.DefinedTags
}

// GetSystemTags returns SystemTags
func (m AdminRelatedDocumentAttachment) GetSystemTags() map[string]map[string]interface{} {
	return m.SystemTags
}

func (m AdminRelatedDocumentAttachment) String() string {
...
func (m AdminRelatedDocumentAttachment) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
...
func (m AdminRelatedDocumentAttachment) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeAdminRelatedDocumentAttachment AdminRelatedDocumentAttachment
	s := struct {
		DiscriminatorParam string `json:"attachmentType"`
		MarshalTypeAdminRelatedDocumentAttachment
	}{
		"RELATED_DOCUMENT",
		(MarshalTypeAdminRelatedDocumentAttachment)(m),
	}

...
// AdminMachineImageArtifact Machine Image artifact details.
type AdminMachineImageArtifact struct {
...
// GetId returns Id
func (m AdminMachineImageArtifact) GetId() *string {
	return m.Id
}

// GetLegacyId returns LegacyId
func (m AdminMachineImageArtifact) GetLegacyId() *string {
	return m.LegacyId
}

// GetDisplayName returns DisplayName
func (m AdminMachineImageArtifact) GetDisplayName() *string {
	return m.DisplayName
}

// GetStatus returns Status
func (m AdminMachineImageArtifact) GetStatus() ArtifactStatusEnum {
	return m.Status
}

// GetStatusNotes returns StatusNotes
func (m AdminMachineImageArtifact) GetStatusNotes() *string {
	return m.StatusNotes
}

// GetLifecycleState returns LifecycleState
func (m AdminMachineImageArtifact) GetLifecycleState() ArtifactLifecycleStateEnum {
	return m.LifecycleState
}

// GetTimeCreated returns TimeCreated
func (m AdminMachineImageArtifact) GetTimeCreated() *common.SDKTime {
	return m.TimeCreated
}

// GetCompartmentId returns CompartmentId
func (m AdminMachineImageArtifact) GetCompartmentId() *string {
	return m.CompartmentId
}

// GetPublisherId returns PublisherId
func (m AdminMachineImageArtifact) GetPublisherId() *string {
	return m.PublisherId
}

// GetTimeUpdated returns TimeUpdated
func (m AdminMachineImageArtifact) GetTimeUpdated() *common.SDKTime {
	return m.TimeUpdated
}

// GetFreeformTags returns FreeformTags
func (m AdminMachineImageArtifact) GetFreeformTags() map[string]string {
	return m.FreeformTags
}

// GetDefinedTags returns DefinedTags
func (m AdminMachineImageArtifact) GetDefinedTags() map[string]map[string]interface{} {
	return m.DefinedTags
}

// GetSystemTags returns SystemTags
func (m AdminMachineImageArtifact) GetSystemTags() map[string]map[string]interface{} {
	return m.SystemTags
}

func (m AdminMachineImageArtifact) String() string {
...
func (m AdminMachineImageArtifact) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
...
func (m AdminMachineImageArtifact) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeAdminMachineImageArtifact AdminMachineImageArtifact
	s := struct {
		DiscriminatorParam string `json:"artifactType"`
		MarshalTypeAdminMachineImageArtifact
	}{
		"MACHINE_IMAGE",
		(MarshalTypeAdminMachineImageArtifact)(m),
	}

...
func (m CreateScreenShotAttachmentDetails) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeCreateScreenShotAttachmentDetails CreateScreenShotAttachmentDetails
	s := struct {
		DiscriminatorParam string `json:"attachmentType"`
		MarshalTypeCreateScreenShotAttachmentDetails
	}{
		"SCREENSHOT",
		(MarshalTypeCreateScreenShotAttachmentDetails)(m),
	}

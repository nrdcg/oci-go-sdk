...
// AdminVideoAttachment Video attachment for the listing revision.
type AdminVideoAttachment struct {
...
// GetId returns Id
func (m AdminVideoAttachment) GetId() *string {
	return m.Id
}

// GetCompartmentId returns CompartmentId
func (m AdminVideoAttachment) GetCompartmentId() *string {
	return m.CompartmentId
}

// GetListingRevisionId returns ListingRevisionId
func (m AdminVideoAttachment) GetListingRevisionId() *string {
	return m.ListingRevisionId
}

// GetDisplayName returns DisplayName
func (m AdminVideoAttachment) GetDisplayName() *string {
	return m.DisplayName
}

// GetDescription returns Description
func (m AdminVideoAttachment) GetDescription() *string {
	return m.Description
}

// GetSourceType returns SourceType
func (m AdminVideoAttachment) GetSourceType() ListingRevisionAttachmentSourceTypeEnum {
	return m.SourceType
}

// GetLifecycleState returns LifecycleState
func (m AdminVideoAttachment) GetLifecycleState() ListingRevisionAttachmentLifecycleStateEnum {
	return m.LifecycleState
}

// GetTimeCreated returns TimeCreated
func (m AdminVideoAttachment) GetTimeCreated() *common.SDKTime {
	return m.TimeCreated
}

// GetTimeUpdated returns TimeUpdated
func (m AdminVideoAttachment) GetTimeUpdated() *common.SDKTime {
	return m.TimeUpdated
}

// GetFreeformTags returns FreeformTags
func (m AdminVideoAttachment) GetFreeformTags() map[string]string {
	return m.FreeformTags
}

// GetDefinedTags returns DefinedTags
func (m AdminVideoAttachment) GetDefinedTags() map[string]map[string]interface{} {
	return m.DefinedTags
}

// GetSystemTags returns SystemTags
func (m AdminVideoAttachment) GetSystemTags() map[string]map[string]interface{} {
	return m.SystemTags
}

func (m AdminVideoAttachment) String() string {
...
func (m AdminVideoAttachment) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
...
func (m AdminVideoAttachment) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeAdminVideoAttachment AdminVideoAttachment
	s := struct {
		DiscriminatorParam string `json:"attachmentType"`
		MarshalTypeAdminVideoAttachment
	}{
		"VIDEO",
		(MarshalTypeAdminVideoAttachment)(m),
	}

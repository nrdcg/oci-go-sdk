...
// AdminArtifactSummary The model for the admin artifact summary.
type AdminArtifactSummary struct {
...
func (m AdminArtifactSummary) String() string {
...
func (m AdminArtifactSummary) ValidateEnumValue() (bool, error) {
	errMessage := []string{}

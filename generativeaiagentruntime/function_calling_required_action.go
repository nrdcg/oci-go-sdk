...
func (m FunctionCallingRequiredAction) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeFunctionCallingRequiredAction FunctionCallingRequiredAction
	s := struct {
		DiscriminatorParam string `json:"requiredActionType"`
		MarshalTypeFunctionCallingRequiredAction
	}{
		"FUNCTION_CALLING_REQUIRED_ACTION",
		(MarshalTypeFunctionCallingRequiredAction)(m),
	}

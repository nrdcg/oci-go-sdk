...
func (m OciObjectStorageSourceLocation) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeOciObjectStorageSourceLocation OciObjectStorageSourceLocation
	s := struct {
		DiscriminatorParam string `json:"sourceLocationType"`
		MarshalTypeOciObjectStorageSourceLocation
	}{
		"OCI_OBJECT_STORAGE",
		(MarshalTypeOciObjectStorageSourceLocation)(m),
	}

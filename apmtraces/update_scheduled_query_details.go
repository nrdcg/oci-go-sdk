...
type UpdateScheduledQueryDetails struct {
...
func (m UpdateScheduledQueryDetails) String() string {
...
func (m UpdateScheduledQueryDetails) ValidateEnumValue() (bool, error) {
	errMessage := []string{}

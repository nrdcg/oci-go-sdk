...
type ObjectListInputJobDetails struct {
...
func (m ObjectListInputJobDetails) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeObjectListInputJobDetails ObjectListInputJobDetails
	s := struct {
		DiscriminatorParam string `json:"inputType"`
		MarshalTypeObjectListInputJobDetails
	}{
		"OBJECT_LIST",
		(MarshalTypeObjectListInputJobDetails)(m),
	}

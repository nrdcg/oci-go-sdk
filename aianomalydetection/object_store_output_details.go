...
type ObjectStoreOutputDetails struct {
...
func (m ObjectStoreOutputDetails) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeObjectStoreOutputDetails ObjectStoreOutputDetails
	s := struct {
		DiscriminatorParam string `json:"outputType"`
		MarshalTypeObjectStoreOutputDetails
	}{
		"OBJECT_STORAGE",
		(MarshalTypeObjectStoreOutputDetails)(m),
	}

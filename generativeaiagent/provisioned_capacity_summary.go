...
// ProvisionedCapacitySummary Summary information about a provisioned capacity.
type ProvisionedCapacitySummary struct {
...
func (m ProvisionedCapacitySummary) String() string {
...
func (m ProvisionedCapacitySummary) ValidateEnumValue() (bool, error) {
	errMessage := []string{}

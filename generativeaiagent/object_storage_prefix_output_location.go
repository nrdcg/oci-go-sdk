...
func (m ObjectStoragePrefixOutputLocation) String() string {
...
func (m ObjectStoragePrefixOutputLocation) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeObjectStoragePrefixOutputLocation ObjectStoragePrefixOutputLocation
	s := struct {
		DiscriminatorParam string `json:"outputLocationType"`
		MarshalTypeObjectStoragePrefixOutputLocation
	}{
		"OBJECT_STORAGE_PREFIX",
		(MarshalTypeObjectStoragePrefixOutputLocation)(m),
	}

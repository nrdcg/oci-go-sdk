...
// CreateProvisionedCapacityDetails The data to create a provisioned capacity.
type CreateProvisionedCapacityDetails struct {
...
func (m CreateProvisionedCapacityDetails) String() string {
...
func (m CreateProvisionedCapacityDetails) ValidateEnumValue() (bool, error) {
	errMessage := []string{}

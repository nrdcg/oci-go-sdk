...
func (m ObjectStorageInputLocation) String() string {
...
func (m ObjectStorageInputLocation) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeObjectStorageInputLocation ObjectStorageInputLocation
	s := struct {
		DiscriminatorParam string `json:"inputLocationType"`
		MarshalTypeObjectStorageInputLocation
	}{
		"OBJECT_STORAGE_PREFIX",
		(MarshalTypeObjectStorageInputLocation)(m),
	}

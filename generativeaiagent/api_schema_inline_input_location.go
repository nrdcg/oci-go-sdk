...
func (m ApiSchemaInlineInputLocation) String() string {
...
func (m ApiSchemaInlineInputLocation) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeApiSchemaInlineInputLocation ApiSchemaInlineInputLocation
	s := struct {
		DiscriminatorParam string `json:"apiSchemaInputLocationType"`
		MarshalTypeApiSchemaInlineInputLocation
	}{
		"INLINE",
		(MarshalTypeApiSchemaInlineInputLocation)(m),
	}

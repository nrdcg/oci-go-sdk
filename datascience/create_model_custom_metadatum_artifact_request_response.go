...
// CreateModelCustomMetadatumArtifactRequest wrapper for the CreateModelCustomMetadatumArtifact operation
//
// # See also
//
// Click https://docs.oracle.com/en-us/iaas/tools/go-sdk-examples/latest/datascience/CreateModelCustomMetadatumArtifact.go.html to see an example of how to use CreateModelCustomMetadatumArtifactRequest.
type CreateModelCustomMetadatumArtifactRequest struct {
...
func (request CreateModelCustomMetadatumArtifactRequest) String() string {
	return common.PointerString(request)
}

// HTTPRequest implements the OCIRequest interface
func (request CreateModelCustomMetadatumArtifactRequest) HTTPRequest(method, path string, binaryRequestBody *common.OCIReadSeekCloser, extraHeaders map[string]string) (http.Request, error) {
...
func (request CreateModelCustomMetadatumArtifactRequest) BinaryRequestBody() (*common.OCIReadSeekCloser, bool) {
...
func (request CreateModelCustomMetadatumArtifactRequest) RetryPolicy() *common.RetryPolicy {
...
func (request CreateModelCustomMetadatumArtifactRequest) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
	if len(errMessage) > 0 {
...
// CreateModelCustomMetadatumArtifactResponse wrapper for the CreateModelCustomMetadatumArtifact operation
type CreateModelCustomMetadatumArtifactResponse struct {
...
func (response CreateModelCustomMetadatumArtifactResponse) String() string {
	return common.PointerString(response)
}

// HTTPResponse implements the OCIResponse interface
func (response CreateModelCustomMetadatumArtifactResponse) HTTPResponse() *http.Response {

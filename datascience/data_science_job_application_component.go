...
// DataScienceJobApplicationComponent Data Science Job application component
...
func (m DataScienceJobApplicationComponent) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
...
func (m DataScienceJobApplicationComponent) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeDataScienceJobApplicationComponent DataScienceJobApplicationComponent
	s := struct {
		DiscriminatorParam string `json:"type"`
		MarshalTypeDataScienceJobApplicationComponent
	}{
		"DATA_SCIENCE_JOB",
		(MarshalTypeDataScienceJobApplicationComponent)(m),
	}

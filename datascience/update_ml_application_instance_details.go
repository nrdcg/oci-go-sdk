...
// UpdateMlApplicationInstanceDetails The information to be updated.
type UpdateMlApplicationInstanceDetails struct {
...
func (m UpdateMlApplicationInstanceDetails) String() string {
...
func (m UpdateMlApplicationInstanceDetails) ValidateEnumValue() (bool, error) {
	errMessage := []string{}

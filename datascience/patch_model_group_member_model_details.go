...
func (m PatchModelGroupMemberModelDetails) String() string {
...
func (m PatchModelGroupMemberModelDetails) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
...
func (m *PatchModelGroupMemberModelDetails) UnmarshalJSON(data []byte) (e error) {
	model := struct {

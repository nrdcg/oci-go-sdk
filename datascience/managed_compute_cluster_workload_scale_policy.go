...
// ManagedComputeClusterWorkloadScalePolicy Workload scaling policy configuration for workloads on managed compute cluster type compute target
type ManagedComputeClusterWorkloadScalePolicy struct {
...
func (m ManagedComputeClusterWorkloadScalePolicy) String() string {
...
func (m ManagedComputeClusterWorkloadScalePolicy) ValidateEnumValue() (bool, error) {
	errMessage := []string{}

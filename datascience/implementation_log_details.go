...
// ImplementationLogDetails Log configuration details for particular areas of ML Application Implementation.
type ImplementationLogDetails struct {
...
func (m ImplementationLogDetails) String() string {
...
func (m ImplementationLogDetails) ValidateEnumValue() (bool, error) {
	errMessage := []string{}

...
// ManagedComputeClusterCustomExpressionQueryScalingConfiguration The scaling configuration for the custom metric expression rule.
type ManagedComputeClusterCustomExpressionQueryScalingConfiguration struct {
...
func (m ManagedComputeClusterCustomExpressionQueryScalingConfiguration) GetPendingDuration() *string {
	return m.PendingDuration
}

// GetInstanceCountAdjustment returns InstanceCountAdjustment
func (m ManagedComputeClusterCustomExpressionQueryScalingConfiguration) GetInstanceCountAdjustment() *int {
	return m.InstanceCountAdjustment
}

func (m ManagedComputeClusterCustomExpressionQueryScalingConfiguration) String() string {
...
func (m ManagedComputeClusterCustomExpressionQueryScalingConfiguration) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
...
func (m ManagedComputeClusterCustomExpressionQueryScalingConfiguration) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeManagedComputeClusterCustomExpressionQueryScalingConfiguration ManagedComputeClusterCustomExpressionQueryScalingConfiguration
	s := struct {
		DiscriminatorParam string `json:"scalingConfigurationType"`
		MarshalTypeManagedComputeClusterCustomExpressionQueryScalingConfiguration
	}{
		"QUERY",
		(MarshalTypeManagedComputeClusterCustomExpressionQueryScalingConfiguration)(m),
	}

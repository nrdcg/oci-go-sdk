...
// GetModelGroupArtifactContentRequest wrapper for the GetModelGroupArtifactContent operation
//
// # See also
//
// Click https://docs.oracle.com/en-us/iaas/tools/go-sdk-examples/latest/datascience/GetModelGroupArtifactContent.go.html to see an example of how to use GetModelGroupArtifactContentRequest.
type GetModelGroupArtifactContentRequest struct {
...
func (request GetModelGroupArtifactContentRequest) String() string {
	return common.PointerString(request)
}

// HTTPRequest implements the OCIRequest interface
func (request GetModelGroupArtifactContentRequest) HTTPRequest(method, path string, binaryRequestBody *common.OCIReadSeekCloser, extraHeaders map[string]string) (http.Request, error) {
...
func (request GetModelGroupArtifactContentRequest) BinaryRequestBody() (*common.OCIReadSeekCloser, bool) {
...
func (request GetModelGroupArtifactContentRequest) RetryPolicy() *common.RetryPolicy {
...
func (request GetModelGroupArtifactContentRequest) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
	if len(errMessage) > 0 {
...
// GetModelGroupArtifactContentResponse wrapper for the GetModelGroupArtifactContent operation
type GetModelGroupArtifactContentResponse struct {
...
func (response GetModelGroupArtifactContentResponse) String() string {
	return common.PointerString(response)
}

// HTTPResponse implements the OCIResponse interface
func (response GetModelGroupArtifactContentResponse) HTTPResponse() *http.Response {

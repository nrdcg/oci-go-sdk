...
// UpdateMlApplicationImplementationDetails The information to be updated.
...
func (m UpdateMlApplicationImplementationDetails) String() string {
...
func (m UpdateMlApplicationImplementationDetails) ValidateEnumValue() (bool, error) {
	errMessage := []string{}

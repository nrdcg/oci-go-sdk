...
// # See also
//
// Click https://docs.oracle.com/en-us/iaas/tools/go-sdk-examples/latest/datascience/HeadModelDefinedMetadatumArtifact.go.html to see an example of how to use HeadModelDefinedMetadatumArtifactRequest.
...
func (request HeadModelDefinedMetadatumArtifactRequest) String() string {
	return common.PointerString(request)
}

// HTTPRequest implements the OCIRequest interface
func (request HeadModelDefinedMetadatumArtifactRequest) HTTPRequest(method, path string, binaryRequestBody *common.OCIReadSeekCloser, extraHeaders map[string]string) (http.Request, error) {
...
func (request HeadModelDefinedMetadatumArtifactRequest) BinaryRequestBody() (*common.OCIReadSeekCloser, bool) {
...
func (request HeadModelDefinedMetadatumArtifactRequest) RetryPolicy() *common.RetryPolicy {
...
func (request HeadModelDefinedMetadatumArtifactRequest) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
	if len(errMessage) > 0 {
...
// HeadModelDefinedMetadatumArtifactResponse wrapper for the HeadModelDefinedMetadatumArtifact operation
type HeadModelDefinedMetadatumArtifactResponse struct {
...
func (response HeadModelDefinedMetadatumArtifactResponse) String() string {
	return common.PointerString(response)
}

// HTTPResponse implements the OCIResponse interface
func (response HeadModelDefinedMetadatumArtifactResponse) HTTPResponse() *http.Response {

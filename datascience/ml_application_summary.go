...
// MlApplicationSummary Summary of the MlApplication.
type MlApplicationSummary struct {
...
func (m MlApplicationSummary) String() string {
...
func (m MlApplicationSummary) ValidateEnumValue() (bool, error) {
	errMessage := []string{}

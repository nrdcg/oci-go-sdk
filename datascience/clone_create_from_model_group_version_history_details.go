...
func (m CloneCreateFromModelGroupVersionHistoryDetails) String() string {
...
func (m CloneCreateFromModelGroupVersionHistoryDetails) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
...
func (m CloneCreateFromModelGroupVersionHistoryDetails) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeCloneCreateFromModelGroupVersionHistoryDetails CloneCreateFromModelGroupVersionHistoryDetails
	s := struct {
		DiscriminatorParam string `json:"modelGroupCloneSourceType"`
		MarshalTypeCloneCreateFromModelGroupVersionHistoryDetails
	}{
		"MODEL_GROUP_VERSION_HISTORY",
		(MarshalTypeCloneCreateFromModelGroupVersionHistoryDetails)(m),
	}

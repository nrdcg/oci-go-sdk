...
// TriggerMlApplicationInstanceViewFlowDetails Payload for trigger request endpoint
type TriggerMlApplicationInstanceViewFlowDetails struct {
...
func (m TriggerMlApplicationInstanceViewFlowDetails) ValidateEnumValue() (bool, error) {
	errMessage := []string{}

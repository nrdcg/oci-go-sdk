...
// GetModelDefinedMetadatumArtifactContentRequest wrapper for the GetModelDefinedMetadatumArtifactContent operation
//
// # See also
//
// Click https://docs.oracle.com/en-us/iaas/tools/go-sdk-examples/latest/datascience/GetModelDefinedMetadatumArtifactContent.go.html to see an example of how to use GetModelDefinedMetadatumArtifactContentRequest.
type GetModelDefinedMetadatumArtifactContentRequest struct {
...
func (request GetModelDefinedMetadatumArtifactContentRequest) String() string {
	return common.PointerString(request)
}

// HTTPRequest implements the OCIRequest interface
func (request GetModelDefinedMetadatumArtifactContentRequest) HTTPRequest(method, path string, binaryRequestBody *common.OCIReadSeekCloser, extraHeaders map[string]string) (http.Request, error) {
...
func (request GetModelDefinedMetadatumArtifactContentRequest) BinaryRequestBody() (*common.OCIReadSeekCloser, bool) {
...
func (request GetModelDefinedMetadatumArtifactContentRequest) RetryPolicy() *common.RetryPolicy {
...
func (request GetModelDefinedMetadatumArtifactContentRequest) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
	if len(errMessage) > 0 {
...
// GetModelDefinedMetadatumArtifactContentResponse wrapper for the GetModelDefinedMetadatumArtifactContent operation
type GetModelDefinedMetadatumArtifactContentResponse struct {
...
func (response GetModelDefinedMetadatumArtifactContentResponse) String() string {
	return common.PointerString(response)
}

// HTTPResponse implements the OCIResponse interface
func (response GetModelDefinedMetadatumArtifactContentResponse) HTTPResponse() *http.Response {

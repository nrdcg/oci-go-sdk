...
// CreateMlApplicationImplementationDetails The information about new MlApplicationImplementation.
type CreateMlApplicationImplementationDetails struct {
...
func (m CreateMlApplicationImplementationDetails) String() string {
...
func (m CreateMlApplicationImplementationDetails) ValidateEnumValue() (bool, error) {
	errMessage := []string{}

...
func (m UpdateDefaultModelDeploymentEnvironmentConfigurationDetails) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeUpdateDefaultModelDeploymentEnvironmentConfigurationDetails UpdateDefaultModelDeploymentEnvironmentConfigurationDetails
	s := struct {
		DiscriminatorParam string `json:"environmentConfigurationType"`
		MarshalTypeUpdateDefaultModelDeploymentEnvironmentConfigurationDetails
	}{
		"DEFAULT",
		(MarshalTypeUpdateDefaultModelDeploymentEnvironmentConfigurationDetails)(m),
	}

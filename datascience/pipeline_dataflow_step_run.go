...
// PipelineDataflowStepRun Detail of each Dataflow Step Run.
type PipelineDataflowStepRun struct {
...
func (m PipelineDataflowStepRun) GetTimeStarted() *common.SDKTime {
	return m.TimeStarted
}

// GetTimeFinished returns TimeFinished
func (m PipelineDataflowStepRun) GetTimeFinished() *common.SDKTime {
	return m.TimeFinished
}

// GetStepName returns StepName
func (m PipelineDataflowStepRun) GetStepName() *string {
	return m.StepName
}

// GetLifecycleState returns LifecycleState
func (m PipelineDataflowStepRun) GetLifecycleState() PipelineStepRunLifecycleStateEnum {
	return m.LifecycleState
}

// GetLifecycleDetails returns LifecycleDetails
func (m PipelineDataflowStepRun) GetLifecycleDetails() *string {
	return m.LifecycleDetails
}

func (m PipelineDataflowStepRun) String() string {
...
func (m PipelineDataflowStepRun) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
...
func (m PipelineDataflowStepRun) MarshalJSON() (buff []byte, e error) {
	type MarshalTypePipelineDataflowStepRun PipelineDataflowStepRun
	s := struct {
		DiscriminatorParam string `json:"stepType"`
		MarshalTypePipelineDataflowStepRun
	}{
		"DATAFLOW",
		(MarshalTypePipelineDataflowStepRun)(m),
	}

...
// CreateVbsInstanceDetails The information about new VbsInstance.
type CreateVbsInstanceDetails struct {
...
func (m CreateVbsInstanceDetails) String() string {
...
func (m CreateVbsInstanceDetails) ValidateEnumValue() (bool, error) {
	errMessage := []string{}

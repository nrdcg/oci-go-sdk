...
// PrivateEndpointMetadata The private endpoint metadata for the connector's source or target.
type PrivateEndpointMetadata struct {
	...
	RceTrafficIpAddress *string `mandatory:"false" json:"rceTrafficIpAddress"`

	// The reverse connection endpoint (RCE) IP address for DNS lookups.
	RceDnsProxyIpAddress *string `mandatory:"false" json:"rceDnsProxyIpAddress"`
}

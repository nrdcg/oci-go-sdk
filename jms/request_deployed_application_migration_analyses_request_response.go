...
// # See also
//
// Click https://docs.oracle.com/en-us/iaas/tools/go-sdk-examples/latest/jms/RequestDeployedApplicationMigrationAnalyses.go.html to see an example of how to use RequestDeployedApplicationMigrationAnalysesRequest.
type RequestDeployedApplicationMigrationAnalysesRequest struct {

	// The OCID (https://docs.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the Fleet.
	FleetId *string `mandatory:"true" contributesTo:"path" name:"fleetId"`

	// Detail information that starts the deployed Java migration analyses
	RequestDeployedApplicationMigrationAnalysesDetails `contributesTo:"body"`
...
type RequestDeployedApplicationMigrationAnalysesResponse struct {

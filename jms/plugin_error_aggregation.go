...
// PluginErrorAggregation Aggregation of PluginErrors
type PluginErrorAggregation struct {
...
func (m PluginErrorAggregation) String() string {
...
func (m PluginErrorAggregation) ValidateEnumValue() (bool, error) {
	errMessage := []string{}

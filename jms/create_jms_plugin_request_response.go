...
// # See also
//
// Click https://docs.oracle.com/en-us/iaas/tools/go-sdk-examples/latest/jms/CreateJmsPlugin.go.html to see an example of how to use CreateJmsPluginRequest.
type CreateJmsPluginRequest struct {

	// Details for the new JmsPlugin.
	CreateJmsPluginDetails `contributesTo:"body"`
...
type CreateJmsPluginResponse struct {

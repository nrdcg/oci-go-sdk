...
// TaskSchedule The properties of a task schedule.
...
func (m *TaskSchedule) UnmarshalJSON(data []byte) (e error) {
	model := struct {
...
// TaskScheduleLifecycleStateEnum Enum with underlying type: string
type TaskScheduleLifecycleStateEnum string

// Set of constants representing the allowable values for TaskScheduleLifecycleStateEnum
const (
	TaskScheduleLifecycleStateActive   TaskScheduleLifecycleStateEnum = "ACTIVE"
	TaskScheduleLifecycleStateInactive TaskScheduleLifecycleStateEnum = "INACTIVE"
)

var mappingTaskScheduleLifecycleStateEnum = map[string]TaskScheduleLifecycleStateEnum{
	"ACTIVE":   TaskScheduleLifecycleStateActive,
	"INACTIVE": TaskScheduleLifecycleStateInactive,
}

var mappingTaskScheduleLifecycleStateEnumLowerCase = map[string]TaskScheduleLifecycleStateEnum{
	"active":   TaskScheduleLifecycleStateActive,
	"inactive": TaskScheduleLifecycleStateInactive,
}

// GetTaskScheduleLifecycleStateEnumValues Enumerates the set of values for TaskScheduleLifecycleStateEnum
func GetTaskScheduleLifecycleStateEnumValues() []TaskScheduleLifecycleStateEnum {
	values := make([]TaskScheduleLifecycleStateEnum, 0)
	for _, v := range mappingTaskScheduleLifecycleStateEnum {
		values = append(values, v)
	}
	return values
}

// GetTaskScheduleLifecycleStateEnumStringValues Enumerates the set of values in String for TaskScheduleLifecycleStateEnum
func GetTaskScheduleLifecycleStateEnumStringValues() []string {
	return []string{
		"ACTIVE",
		"INACTIVE",
	}
...
// GetMappingTaskScheduleLifecycleStateEnum performs case Insensitive comparison on enum value and return the desired enum
func GetMappingTaskScheduleLifecycleStateEnum(val string) (TaskScheduleLifecycleStateEnum, bool) {
	enum, ok := mappingTaskScheduleLifecycleStateEnumLowerCase[strings.ToLower(val)]
	return enum, ok
}

...
// FileFamily File Storage resources used to validate networkConfig.fileStorageMounts for an IoT flow runtime.
type FileFamily struct {
}

func (m FileFamily) String() string {
...
func (m FileFamily) ValidateEnumValue() (bool, error) {
	errMessage := []string{}

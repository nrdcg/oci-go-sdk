...
// LogConfigDetails Logging configuration for an IoT flow runtime.
...
func (m LogConfigDetails) String() string {
...
func (m LogConfigDetails) ValidateEnumValue() (bool, error) {
	errMessage := []string{}

...
// ChangeIotFlowRuntimeCompartmentDetails Details for moving an IoT flow runtime to a different compartment.
type ChangeIotFlowRuntimeCompartmentDetails struct {
...
func (m ChangeIotFlowRuntimeCompartmentDetails) String() string {
...
func (m ChangeIotFlowRuntimeCompartmentDetails) ValidateEnumValue() (bool, error) {
	errMessage := []string{}

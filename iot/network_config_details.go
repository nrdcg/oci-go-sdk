...
// NetworkConfigDetails Network access configuration for an IoT flow runtime.
type NetworkConfigDetails struct {
	...
	FileStorageMounts []FileStorageMountDetails `mandatory:"false" json:"fileStorageMounts"`
}

func (m NetworkConfigDetails) String() string {
...
func (m NetworkConfigDetails) ValidateEnumValue() (bool, error) {
	errMessage := []string{}

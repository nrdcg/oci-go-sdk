...
// ExadbStackCollection Details of 'EXADB_STACK' type Exadata Fleet Update Collection.
...
type ExadbStackCollection struct {
	...
	Components []SoftwareComponentDetails `mandatory:"true" json:"components"`
...
// GetId returns Id
func (m ExadbStackCollection) GetId() *string {
	return m.Id
}

// GetDisplayName returns DisplayName
func (m ExadbStackCollection) GetDisplayName() *string {
	return m.DisplayName
}

// GetServiceType returns ServiceType
func (m ExadbStackCollection) GetServiceType() CollectionServiceTypesEnum {
	return m.ServiceType
}

// GetCompartmentId returns CompartmentId
func (m ExadbStackCollection) GetCompartmentId() *string {
	return m.CompartmentId
}

// GetActiveFsuCycle returns ActiveFsuCycle
func (m ExadbStackCollection) GetActiveFsuCycle() *ActiveCycleDetails {
	return m.ActiveFsuCycle
}

// GetTargetCount returns TargetCount
func (m ExadbStackCollection) GetTargetCount() *int {
	return m.TargetCount
}

// GetTimeCreated returns TimeCreated
func (m ExadbStackCollection) GetTimeCreated() *common.SDKTime {
	return m.TimeCreated
}

// GetTimeUpdated returns TimeUpdated
func (m ExadbStackCollection) GetTimeUpdated() *common.SDKTime {
	return m.TimeUpdated
}

// GetLifecycleState returns LifecycleState
func (m ExadbStackCollection) GetLifecycleState() CollectionLifecycleStatesEnum {
	return m.LifecycleState
}

// GetLifecycleDetails returns LifecycleDetails
func (m ExadbStackCollection) GetLifecycleDetails() *string {
	return m.LifecycleDetails
}

// GetLastCompletedFsuCycleId returns LastCompletedFsuCycleId
func (m ExadbStackCollection) GetLastCompletedFsuCycleId() *string {
	return m.LastCompletedFsuCycleId
}

// GetFreeformTags returns FreeformTags
func (m ExadbStackCollection) GetFreeformTags() map[string]string {
	return m.FreeformTags
}

// GetDefinedTags returns DefinedTags
func (m ExadbStackCollection) GetDefinedTags() map[string]map[string]interface{} {
	return m.DefinedTags
}

// GetSystemTags returns SystemTags
func (m ExadbStackCollection) GetSystemTags() map[string]map[string]interface{} {
	return m.SystemTags
}

func (m ExadbStackCollection) String() string {
...
func (m ExadbStackCollection) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
...
func (m ExadbStackCollection) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeExadbStackCollection ExadbStackCollection
	s := struct {
		DiscriminatorParam string `json:"type"`
		MarshalTypeExadbStackCollection
	}{
		"EXADB_STACK",
		(MarshalTypeExadbStackCollection)(m),
	}
...
func (m *ExadbStackCollection) UnmarshalJSON(data []byte) (e error) {
	model := struct {
		...
		Components              []softwarecomponentdetails        `json:"components"`
	}{}
	...
	m.Components = make([]SoftwareComponentDetails, len(model.Components))
	for i, n := range model.Components {
		...
		if nn != nil {
			m.Components[i] = nn.(SoftwareComponentDetails)
		} else {
			m.Components[i] = nil
		}
	}

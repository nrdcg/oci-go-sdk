...
func (m CreateNonRollingBatchingStrategyDetails) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeCreateNonRollingBatchingStrategyDetails CreateNonRollingBatchingStrategyDetails
	s := struct {
		DiscriminatorParam string `json:"type"`
		MarshalTypeCreateNonRollingBatchingStrategyDetails
	}{
		"NON_ROLLING",
		(MarshalTypeCreateNonRollingBatchingStrategyDetails)(m),
	}

...
func (m UpdateStartTimeScheduleDetails) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeUpdateStartTimeScheduleDetails UpdateStartTimeScheduleDetails
	s := struct {
		DiscriminatorParam string `json:"type"`
		MarshalTypeUpdateStartTimeScheduleDetails
	}{
		"START_TIME",
		(MarshalTypeUpdateStartTimeScheduleDetails)(m),
	}

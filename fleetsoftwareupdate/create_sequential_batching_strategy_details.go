...
func (m CreateSequentialBatchingStrategyDetails) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeCreateSequentialBatchingStrategyDetails CreateSequentialBatchingStrategyDetails
	s := struct {
		DiscriminatorParam string `json:"type"`
		MarshalTypeCreateSequentialBatchingStrategyDetails
	}{
		"SEQUENTIAL",
		(MarshalTypeCreateSequentialBatchingStrategyDetails)(m),
	}

...
func (m NonRollingBatchingStrategyDetails) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeNonRollingBatchingStrategyDetails NonRollingBatchingStrategyDetails
	s := struct {
		DiscriminatorParam string `json:"type"`
		MarshalTypeNonRollingBatchingStrategyDetails
	}{
		"NON_ROLLING",
		(MarshalTypeNonRollingBatchingStrategyDetails)(m),
	}

...
func (m UpdateSequentialBatchingStrategyDetails) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeUpdateSequentialBatchingStrategyDetails UpdateSequentialBatchingStrategyDetails
	s := struct {
		DiscriminatorParam string `json:"type"`
		MarshalTypeUpdateSequentialBatchingStrategyDetails
	}{
		"SEQUENTIAL",
		(MarshalTypeUpdateSequentialBatchingStrategyDetails)(m),
	}

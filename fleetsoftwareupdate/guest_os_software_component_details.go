...
// GuestOsSoftwareComponentDetails Details of 'GUEST_OS' component in an Exadata software stack.
type GuestOsSoftwareComponentDetails struct {
...
func (m GuestOsSoftwareComponentDetails) String() string {
...
func (m GuestOsSoftwareComponentDetails) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
...
func (m GuestOsSoftwareComponentDetails) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeGuestOsSoftwareComponentDetails GuestOsSoftwareComponentDetails
	s := struct {
		DiscriminatorParam string `json:"componentType"`
		MarshalTypeGuestOsSoftwareComponentDetails
	}{
		"GUEST_OS",
		(MarshalTypeGuestOsSoftwareComponentDetails)(m),
	}
...
func (m *GuestOsSoftwareComponentDetails) UnmarshalJSON(data []byte) (e error) {
	model := struct {

...
func (m UpdateNonRollingBatchingStrategyDetails) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeUpdateNonRollingBatchingStrategyDetails UpdateNonRollingBatchingStrategyDetails
	s := struct {
		DiscriminatorParam string `json:"type"`
		MarshalTypeUpdateNonRollingBatchingStrategyDetails
	}{
		"NON_ROLLING",
		(MarshalTypeUpdateNonRollingBatchingStrategyDetails)(m),
	}

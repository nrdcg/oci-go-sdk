...
// StartTimeScheduleDetails Start time details for the Exadata Fleet Update Action.
...
func (m StartTimeScheduleDetails) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeStartTimeScheduleDetails StartTimeScheduleDetails
	s := struct {
		DiscriminatorParam string `json:"type"`
		MarshalTypeStartTimeScheduleDetails
	}{
		"START_TIME",
		(MarshalTypeStartTimeScheduleDetails)(m),
	}

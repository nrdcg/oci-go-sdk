...
// PatchingIssueEntry Patching issue found during an Exadata Fleet Update Readiness Check run.
type PatchingIssueEntry struct {
	...
	ImpactedResourceId *string `mandatory:"true" json:"impactedResourceId"`
...
func (m PatchingIssueEntry) String() string {
...
func (m PatchingIssueEntry) ValidateEnumValue() (bool, error) {
	errMessage := []string{}

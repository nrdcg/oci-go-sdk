...
// ListOfTargetsRollbackDetails LIST_OF_TARGETS strategy rollback details.
...
func (m ListOfTargetsRollbackDetails) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeListOfTargetsRollbackDetails ListOfTargetsRollbackDetails
	s := struct {
		DiscriminatorParam string `json:"strategy"`
		MarshalTypeListOfTargetsRollbackDetails
	}{
		"LIST_OF_TARGETS",
		(MarshalTypeListOfTargetsRollbackDetails)(m),
	}

...
// RollbackAction Rollback Exadata Fleet Update Action details.
...
func (m RollbackAction) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeRollbackAction RollbackAction
	s := struct {
		DiscriminatorParam string `json:"type"`
		MarshalTypeRollbackAction
	}{
		"ROLLBACK_AND_REMOVE_TARGET",
		(MarshalTypeRollbackAction)(m),
	}

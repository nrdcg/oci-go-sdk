...
// GuestOsFreeformTagsFilter Free-form tags (https://docs.oracle.com/iaas/Content/Tagging/Concepts/understandingfreeformtags.htm) to include when discovering Exadata VM Cluster targets for a 'GUEST_OS' collection.
type GuestOsFreeformTagsFilter struct {
...
func (m GuestOsFreeformTagsFilter) GetMode() GuestOsFleetDiscoveryFilterModeEnum {
	return m.Mode
}

func (m GuestOsFreeformTagsFilter) String() string {
...
func (m GuestOsFreeformTagsFilter) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
...
func (m GuestOsFreeformTagsFilter) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeGuestOsFreeformTagsFilter GuestOsFreeformTagsFilter
	s := struct {
		DiscriminatorParam string `json:"type"`
		MarshalTypeGuestOsFreeformTagsFilter
	}{
		"FREEFORM_TAG",
		(MarshalTypeGuestOsFreeformTagsFilter)(m),
	}

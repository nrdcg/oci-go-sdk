...
// CreateGiSoftwareComponentDetails Details to create 'GI' component in an Exadata software stack.
type CreateGiSoftwareComponentDetails struct {
...
func (m CreateGiSoftwareComponentDetails) String() string {
...
func (m CreateGiSoftwareComponentDetails) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
...
func (m CreateGiSoftwareComponentDetails) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeCreateGiSoftwareComponentDetails CreateGiSoftwareComponentDetails
	s := struct {
		DiscriminatorParam string `json:"componentType"`
		MarshalTypeCreateGiSoftwareComponentDetails
	}{
		"GI",
		(MarshalTypeCreateGiSoftwareComponentDetails)(m),
	}
...
func (m *CreateGiSoftwareComponentDetails) UnmarshalJSON(data []byte) (e error) {
	model := struct {

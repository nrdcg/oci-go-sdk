...
// GiSoftwareComponentDiscoveryDetails Discovery filter details of 'GI' component in an Exadata software stack.
type GiSoftwareComponentDiscoveryDetails struct {
...
func (m GiSoftwareComponentDiscoveryDetails) String() string {
...
func (m GiSoftwareComponentDiscoveryDetails) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
...
func (m GiSoftwareComponentDiscoveryDetails) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeGiSoftwareComponentDiscoveryDetails GiSoftwareComponentDiscoveryDetails
	s := struct {
		DiscriminatorParam string `json:"componentType"`
		MarshalTypeGiSoftwareComponentDiscoveryDetails
	}{
		"GI",
		(MarshalTypeGiSoftwareComponentDiscoveryDetails)(m),
	}
...
func (m *GiSoftwareComponentDiscoveryDetails) UnmarshalJSON(data []byte) (e error) {
	model := struct {

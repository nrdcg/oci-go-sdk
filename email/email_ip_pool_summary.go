...
// EmailIpPoolSummary The properties that define an IpPool.
type EmailIpPoolSummary struct {
...
func (m EmailIpPoolSummary) String() string {
...
func (m EmailIpPoolSummary) ValidateEnumValue() (bool, error) {
	errMessage := []string{}

...
// ImageVariableDependsOn Depends On object.
type ImageVariableDependsOn struct {
...
func (m ImageVariableDependsOn) String() string {
...
func (m ImageVariableDependsOn) ValidateEnumValue() (bool, error) {
	errMessage := []string{}

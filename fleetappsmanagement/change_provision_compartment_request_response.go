...
type ChangeProvisionCompartmentRequest struct {

	// The OCID (https://docs.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the FamProvision.
	ProvisionId *string `mandatory:"true" contributesTo:"path" name:"provisionId"`

	// Details of the target compartment.
	ChangeProvisionCompartmentDetails `contributesTo:"body"`
...
type ChangeProvisionCompartmentResponse struct {

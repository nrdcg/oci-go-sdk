...
func (request ListSchedulerDefinitionsRequest) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
	if _, ok := GetMappingSchedulerDefinitionLifecycleStateEnum(string(request.LifecycleState)); !ok && request.LifecycleState != "" {
		errMessage = append(errMessage, fmt.Sprintf("unsupported enum value for LifecycleState: %s. Supported values are: %s.", request.LifecycleState, strings.Join(GetSchedulerDefinitionLifecycleStateEnumStringValues(), ",")))
	}
	if _, ok := GetMappingListSchedulerDefinitionsSortOrderEnum(string(request.SortOrder)); !ok && request.SortOrder != "" {
		errMessage = append(errMessage, fmt.Sprintf("unsupported enum value for SortOrder: %s. Supported values are: %s.", request.SortOrder, strings.Join(GetListSchedulerDefinitionsSortOrderEnumStringValues(), ",")))
	}
	if _, ok := GetMappingListSchedulerDefinitionsSortByEnum(string(request.SortBy)); !ok && request.SortBy != "" {
		errMessage = append(errMessage, fmt.Sprintf("unsupported enum value for SortBy: %s. Supported values are: %s.", request.SortBy, strings.Join(GetListSchedulerDefinitionsSortByEnumStringValues(), ",")))
	}
	if len(errMessage) > 0 {
...
var mappingListSchedulerDefinitionsSortOrderEnum = map[string]ListSchedulerDefinitionsSortOrderEnum{
	"ASC":  ListSchedulerDefinitionsSortOrderAsc,
	"DESC": ListSchedulerDefinitionsSortOrderDesc,
}

var mappingListSchedulerDefinitionsSortOrderEnumLowerCase = map[string]ListSchedulerDefinitionsSortOrderEnum{
	"asc":  ListSchedulerDefinitionsSortOrderAsc,
	"desc": ListSchedulerDefinitionsSortOrderDesc,
}
...
func GetListSchedulerDefinitionsSortOrderEnumValues() []ListSchedulerDefinitionsSortOrderEnum {
	values := make([]ListSchedulerDefinitionsSortOrderEnum, 0)
	for _, v := range mappingListSchedulerDefinitionsSortOrderEnum {
...
func GetMappingListSchedulerDefinitionsSortOrderEnum(val string) (ListSchedulerDefinitionsSortOrderEnum, bool) {
	enum, ok := mappingListSchedulerDefinitionsSortOrderEnumLowerCase[strings.ToLower(val)]
	return enum, ok
}
...
var mappingListSchedulerDefinitionsSortByEnum = map[string]ListSchedulerDefinitionsSortByEnum{
	"timeCreated":   ListSchedulerDefinitionsSortByTimecreated,
	"displayName":   ListSchedulerDefinitionsSortByDisplayname,
	"timeOfNextRun": ListSchedulerDefinitionsSortByTimeofnextrun,
}

var mappingListSchedulerDefinitionsSortByEnumLowerCase = map[string]ListSchedulerDefinitionsSortByEnum{
	"timecreated":   ListSchedulerDefinitionsSortByTimecreated,
	"displayname":   ListSchedulerDefinitionsSortByDisplayname,
	"timeofnextrun": ListSchedulerDefinitionsSortByTimeofnextrun,
}
...
func GetListSchedulerDefinitionsSortByEnumValues() []ListSchedulerDefinitionsSortByEnum {
	values := make([]ListSchedulerDefinitionsSortByEnum, 0)
	for _, v := range mappingListSchedulerDefinitionsSortByEnum {
		values = append(values, v)
	}
	return values
}
...
func GetMappingListSchedulerDefinitionsSortByEnum(val string) (ListSchedulerDefinitionsSortByEnum, bool) {
	enum, ok := mappingListSchedulerDefinitionsSortByEnumLowerCase[strings.ToLower(val)]
	return enum, ok
}

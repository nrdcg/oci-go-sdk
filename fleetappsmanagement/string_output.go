...
func (m StringOutput) GetTitle() *string {
	return m.Title
}

// GetDescription returns Description
func (m StringOutput) GetDescription() *string {
	return m.Description
}

// GetIsSensitive returns IsSensitive
func (m StringOutput) GetIsSensitive() *bool {
	return m.IsSensitive
}

// GetFormat returns Format
func (m StringOutput) GetFormat() *string {
	return m.Format
}

// GetVisible returns Visible
func (m StringOutput) GetVisible() *string {
	return m.Visible
}

func (m StringOutput) String() string {
...
func (m StringOutput) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
...
func (m StringOutput) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeStringOutput StringOutput
	s := struct {
		DiscriminatorParam string `json:"type"`
		MarshalTypeStringOutput
	}{
		"STRING",
		(MarshalTypeStringOutput)(m),
	}

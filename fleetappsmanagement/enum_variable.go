...
type EnumVariable struct {
	...
	EnumValue []string `mandatory:"false" json:"enumValue"`
	...
	CanAllowMultiple *bool `mandatory:"false" json:"canAllowMultiple"`
}

// GetTitle returns Title
func (m EnumVariable) GetTitle() *string {
	return m.Title
}

// GetDescription returns Description
func (m EnumVariable) GetDescription() *string {
	return m.Description
}

// GetIsRequired returns IsRequired
func (m EnumVariable) GetIsRequired() *bool {
	return m.IsRequired
}

// GetVisible returns Visible
func (m EnumVariable) GetVisible() *string {
	return m.Visible
}

func (m EnumVariable) String() string {
...
func (m EnumVariable) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
...
func (m EnumVariable) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeEnumVariable EnumVariable
	s := struct {
		DiscriminatorParam string `json:"type"`
		MarshalTypeEnumVariable
	}{
		"ENUM",
		(MarshalTypeEnumVariable)(m),
	}

...
// RunbookExportStatusSummary Summary of the Runbook export status.
type RunbookExportStatusSummary struct {
...
func (m RunbookExportStatusSummary) String() string {
...
func (m RunbookExportStatusSummary) ValidateEnumValue() (bool, error) {
	errMessage := []string{}

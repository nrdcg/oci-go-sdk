...
func (m FileVariable) GetTitle() *string {
	return m.Title
}

// GetDescription returns Description
func (m FileVariable) GetDescription() *string {
	return m.Description
}

// GetIsRequired returns IsRequired
func (m FileVariable) GetIsRequired() *bool {
	return m.IsRequired
}

// GetVisible returns Visible
func (m FileVariable) GetVisible() *string {
	return m.Visible
}

func (m FileVariable) String() string {
...
func (m FileVariable) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
...
func (m FileVariable) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeFileVariable FileVariable
	s := struct {
		DiscriminatorParam string `json:"type"`
		MarshalTypeFileVariable
	}{
		"FILE",
		(MarshalTypeFileVariable)(m),
	}

...
// RunbookImportRequiredValue Runbook import required value.
type RunbookImportRequiredValue struct {
...
func (m RunbookImportRequiredValue) String() string {
...
func (m RunbookImportRequiredValue) ValidateEnumValue() (bool, error) {
	errMessage := []string{}

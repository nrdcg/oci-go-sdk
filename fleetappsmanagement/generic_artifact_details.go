...
type GenericArtifactDetails struct {
	Artifact *GenericArtifact `mandatory:"true" json:"artifact"`
}
...
func (m GenericArtifactDetails) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeGenericArtifactDetails GenericArtifactDetails
	s := struct {
		DiscriminatorParam string `json:"category"`
		MarshalTypeGenericArtifactDetails
	}{
		"GENERIC",
		(MarshalTypeGenericArtifactDetails)(m),
	}

...
func (m ProductStackGenericSubCategoryDetails) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeProductStackGenericSubCategoryDetails ProductStackGenericSubCategoryDetails
	s := struct {
		DiscriminatorParam string `json:"subCategory"`
		MarshalTypeProductStackGenericSubCategoryDetails
	}{
		"PRODUCT_STACK_GENERIC",
		(MarshalTypeProductStackGenericSubCategoryDetails)(m),
	}

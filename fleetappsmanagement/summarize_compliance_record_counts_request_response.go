...
type SummarizeComplianceRecordCountsRequest struct {
	...
	SortOrder SummarizeComplianceRecordCountsSortOrderEnum `mandatory:"false" contributesTo:"query" name:"sortOrder" omitEmpty:"true"`
...
func (request SummarizeComplianceRecordCountsRequest) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
	if _, ok := GetMappingSummarizeComplianceRecordCountsSortOrderEnum(string(request.SortOrder)); !ok && request.SortOrder != "" {
		errMessage = append(errMessage, fmt.Sprintf("unsupported enum value for SortOrder: %s. Supported values are: %s.", request.SortOrder, strings.Join(GetSummarizeComplianceRecordCountsSortOrderEnumStringValues(), ",")))
	}
	if len(errMessage) > 0 {
...
type SummarizeComplianceRecordCountsResponse struct {

	// The underlying http response
	RawResponse *http.Response

	// A list of ComplianceRecordAggregationCollection instances
	ComplianceRecordAggregationCollection `presentIn:"body"`
...
const (
	SummarizeComplianceRecordCountsSortOrderAsc  SummarizeComplianceRecordCountsSortOrderEnum = "ASC"
	SummarizeComplianceRecordCountsSortOrderDesc SummarizeComplianceRecordCountsSortOrderEnum = "DESC"
)

var mappingSummarizeComplianceRecordCountsSortOrderEnum = map[string]SummarizeComplianceRecordCountsSortOrderEnum{
	"ASC":  SummarizeComplianceRecordCountsSortOrderAsc,
	"DESC": SummarizeComplianceRecordCountsSortOrderDesc,
}

var mappingSummarizeComplianceRecordCountsSortOrderEnumLowerCase = map[string]SummarizeComplianceRecordCountsSortOrderEnum{
	"asc":  SummarizeComplianceRecordCountsSortOrderAsc,
	"desc": SummarizeComplianceRecordCountsSortOrderDesc,
}
...
func GetSummarizeComplianceRecordCountsSortOrderEnumValues() []SummarizeComplianceRecordCountsSortOrderEnum {
	values := make([]SummarizeComplianceRecordCountsSortOrderEnum, 0)
	for _, v := range mappingSummarizeComplianceRecordCountsSortOrderEnum {
...
func GetMappingSummarizeComplianceRecordCountsSortOrderEnum(val string) (SummarizeComplianceRecordCountsSortOrderEnum, bool) {
	enum, ok := mappingSummarizeComplianceRecordCountsSortOrderEnumLowerCase[strings.ToLower(val)]
	return enum, ok
}

...
// RunbookImportStatusSummary Summary of the Runbook import status.
type RunbookImportStatusSummary struct {
...
func (m RunbookImportStatusSummary) String() string {
...
func (m RunbookImportStatusSummary) ValidateEnumValue() (bool, error) {
	errMessage := []string{}

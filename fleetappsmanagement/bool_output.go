...
type BoolOutput struct {
	...
	Value *bool `mandatory:"false" json:"value"`
}

// GetTitle returns Title
func (m BoolOutput) GetTitle() *string {
	return m.Title
}

// GetDescription returns Description
func (m BoolOutput) GetDescription() *string {
	return m.Description
}

// GetIsSensitive returns IsSensitive
func (m BoolOutput) GetIsSensitive() *bool {
	return m.IsSensitive
}

// GetFormat returns Format
func (m BoolOutput) GetFormat() *string {
	return m.Format
}

// GetVisible returns Visible
func (m BoolOutput) GetVisible() *string {
	return m.Visible
}

func (m BoolOutput) String() string {
...
func (m BoolOutput) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
...
func (m BoolOutput) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeBoolOutput BoolOutput
	s := struct {
		DiscriminatorParam string `json:"type"`
		MarshalTypeBoolOutput
	}{
		"boolean",
		(MarshalTypeBoolOutput)(m),
	}

...
type ChangePlatformConfigurationCompartmentRequest struct {
	...
	ChangePlatformConfigurationCompartmentDetails `contributesTo:"body"`
...
type ChangePlatformConfigurationCompartmentResponse struct {

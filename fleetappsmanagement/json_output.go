...
func (m JsonOutput) GetTitle() *string {
	return m.Title
}

// GetDescription returns Description
func (m JsonOutput) GetDescription() *string {
	return m.Description
}

// GetIsSensitive returns IsSensitive
func (m JsonOutput) GetIsSensitive() *bool {
	return m.IsSensitive
}

// GetFormat returns Format
func (m JsonOutput) GetFormat() *string {
	return m.Format
}

// GetVisible returns Visible
func (m JsonOutput) GetVisible() *string {
	return m.Visible
}

func (m JsonOutput) String() string {
...
func (m JsonOutput) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
...
func (m JsonOutput) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeJsonOutput JsonOutput
	s := struct {
		DiscriminatorParam string `json:"type"`
		MarshalTypeJsonOutput
	}{
		"JSON",
		(MarshalTypeJsonOutput)(m),
	}

...
// CredentialConfigCategoryDetails Credential Config Category Details.
...
func (m CredentialConfigCategoryDetails) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeCredentialConfigCategoryDetails CredentialConfigCategoryDetails
	s := struct {
		DiscriminatorParam string `json:"configCategory"`
		MarshalTypeCredentialConfigCategoryDetails
	}{
		"CREDENTIAL",
		(MarshalTypeCredentialConfigCategoryDetails)(m),
	}

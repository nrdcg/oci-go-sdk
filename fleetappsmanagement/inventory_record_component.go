...
type InventoryRecordComponent struct {

	// Name of the target component
	ComponentName *string `mandatory:"true" json:"componentName"`

	// Version of the target component
	ComponentVersion *string `mandatory:"true" json:"componentVersion"`

	// Path of the component
	ComponentPath *string `mandatory:"true" json:"componentPath"`

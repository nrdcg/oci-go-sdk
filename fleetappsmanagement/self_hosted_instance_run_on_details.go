...
type SelfHostedInstanceRunOnDetails struct {
...
func (m SelfHostedInstanceRunOnDetails) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeSelfHostedInstanceRunOnDetails SelfHostedInstanceRunOnDetails
	s := struct {
		DiscriminatorParam string `json:"kind"`
		MarshalTypeSelfHostedInstanceRunOnDetails
	}{
		"SELF_HOSTED_INSTANCES",
		(MarshalTypeSelfHostedInstanceRunOnDetails)(m),
	}

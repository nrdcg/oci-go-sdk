...
// VariableGroup An organizational grouping of related variables within the schema.
...
func (m VariableGroup) ValidateEnumValue() (bool, error) {
	errMessage := []string{}

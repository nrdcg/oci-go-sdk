...
type TerraformBasedExecutionDetails struct {
...
func (m TerraformBasedExecutionDetails) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeTerraformBasedExecutionDetails TerraformBasedExecutionDetails
	s := struct {
		DiscriminatorParam string `json:"executionType"`
		MarshalTypeTerraformBasedExecutionDetails
	}{
		"TERRAFORM",
		(MarshalTypeTerraformBasedExecutionDetails)(m),
	}

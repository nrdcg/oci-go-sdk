...
type CatalogContentDetails struct {
...
func (m CatalogContentDetails) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeCatalogContentDetails CatalogContentDetails
	s := struct {
		DiscriminatorParam string `json:"sourceType"`
		MarshalTypeCatalogContentDetails
	}{
		"CATALOG",
		(MarshalTypeCatalogContentDetails)(m),
	}

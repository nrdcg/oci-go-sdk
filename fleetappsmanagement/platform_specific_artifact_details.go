...
type PlatformSpecificArtifactDetails struct {
	...
	// Artifacts.
	Artifacts []PlatformSpecificArtifact `mandatory:"true" json:"artifacts"`
}
...
func (m PlatformSpecificArtifactDetails) MarshalJSON() (buff []byte, e error) {
	type MarshalTypePlatformSpecificArtifactDetails PlatformSpecificArtifactDetails
	s := struct {
		DiscriminatorParam string `json:"category"`
		MarshalTypePlatformSpecificArtifactDetails
	}{
		"PLATFORM_SPECIFIC",
		(MarshalTypePlatformSpecificArtifactDetails)(m),
	}

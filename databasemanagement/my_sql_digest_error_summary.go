...
type MySqlDigestErrorSummary struct {
	...
	OccurrenceCount *int `mandatory:"true" json:"occurrenceCount"`
}

func (m MySqlDigestErrorSummary) String() string {
...
func (m MySqlDigestErrorSummary) ValidateEnumValue() (bool, error) {
	errMessage := []string{}

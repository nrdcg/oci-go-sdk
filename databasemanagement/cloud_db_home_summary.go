...
// CloudDbHomeSummary The summary of a cloud database home.
type CloudDbHomeSummary struct {
...
func (m CloudDbHomeSummary) String() string {
...
func (m CloudDbHomeSummary) ValidateEnumValue() (bool, error) {
	errMessage := []string{}

...
// CloudClusterInstanceSummary The summary of a cloud cluster instance.
type CloudClusterInstanceSummary struct {
...
func (m CloudClusterInstanceSummary) String() string {
...
func (m CloudClusterInstanceSummary) ValidateEnumValue() (bool, error) {
	errMessage := []string{}

...
// MySqlDataSummary The SQL performance data record for a specific SQL query. MySQL support within OCI Database Management service has been deprecated as of January 29, 2026.

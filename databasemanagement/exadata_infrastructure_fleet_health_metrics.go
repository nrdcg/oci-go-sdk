...
// ExadataInfrastructureFleetHealthMetrics The details of the fleet health metrics.
type ExadataInfrastructureFleetHealthMetrics struct {
	...
	FleetExadataInfrastructures []ExadataInfrastructureUsageMetrics `mandatory:"true" json:"fleetExadataInfrastructures"`

	// The time window used for metrics comparison.
	CompareType CompareTypeEnum `mandatory:"false" json:"compareType,omitempty"`

	ExadataInfrastructureFleetSummary *ExadataInfrastructureFleetSummary `mandatory:"false" json:"exadataInfrastructureFleetSummary"`
}

func (m ExadataInfrastructureFleetHealthMetrics) String() string {
...
func (m ExadataInfrastructureFleetHealthMetrics) ValidateEnumValue() (bool, error) {
	errMessage := []string{}

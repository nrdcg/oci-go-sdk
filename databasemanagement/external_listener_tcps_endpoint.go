...
func (m ExternalListenerTcpsEndpoint) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeExternalListenerTcpsEndpoint ExternalListenerTcpsEndpoint
	s := struct {
		DiscriminatorParam string `json:"protocol"`
		MarshalTypeExternalListenerTcpsEndpoint
	}{
		"TCPS",
		(MarshalTypeExternalListenerTcpsEndpoint)(m),
	}

...
func (m ManagedMySqlDatabaseOutboundReplicationCollection) String() string {
...
func (m ManagedMySqlDatabaseOutboundReplicationCollection) ValidateEnumValue() (bool, error) {
	errMessage := []string{}

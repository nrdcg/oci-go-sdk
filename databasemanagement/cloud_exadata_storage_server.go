...
// CloudExadataStorageServer The details of the Exadata storage server.
type CloudExadataStorageServer struct {
	...
	Connector *CloudExadataStorageConnectorSummary `mandatory:"false" json:"connector"`
...
// GetId returns Id
func (m CloudExadataStorageServer) GetId() *string {
	return m.Id
}

// GetDisplayName returns DisplayName
func (m CloudExadataStorageServer) GetDisplayName() *string {
	return m.DisplayName
}

// GetVersion returns Version
func (m CloudExadataStorageServer) GetVersion() *string {
	return m.Version
}

// GetInternalId returns InternalId
func (m CloudExadataStorageServer) GetInternalId() *string {
	return m.InternalId
}

// GetStatus returns Status
func (m CloudExadataStorageServer) GetStatus() *string {
	return m.Status
}

// GetLifecycleState returns LifecycleState
func (m CloudExadataStorageServer) GetLifecycleState() DbmResourceLifecycleStateEnum {
	return m.LifecycleState
}

// GetTimeCreated returns TimeCreated
func (m CloudExadataStorageServer) GetTimeCreated() *common.SDKTime {
	return m.TimeCreated
}

// GetTimeUpdated returns TimeUpdated
func (m CloudExadataStorageServer) GetTimeUpdated() *common.SDKTime {
	return m.TimeUpdated
}

// GetLifecycleDetails returns LifecycleDetails
func (m CloudExadataStorageServer) GetLifecycleDetails() *string {
	return m.LifecycleDetails
}

// GetAdditionalDetails returns AdditionalDetails
func (m CloudExadataStorageServer) GetAdditionalDetails() map[string]string {
	return m.AdditionalDetails
}

func (m CloudExadataStorageServer) String() string {
...
func (m CloudExadataStorageServer) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
...
func (m CloudExadataStorageServer) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeCloudExadataStorageServer CloudExadataStorageServer
	s := struct {
		DiscriminatorParam string `json:"resourceType"`
		MarshalTypeCloudExadataStorageServer
	}{
		"CLOUD_STORAGE_SERVER",
		(MarshalTypeCloudExadataStorageServer)(m),
	}

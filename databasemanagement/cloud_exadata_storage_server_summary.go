...
// CloudExadataStorageServerSummary The Exadata storage server of the Exadata infrastructure.
type CloudExadataStorageServerSummary struct {
...
// GetId returns Id
func (m CloudExadataStorageServerSummary) GetId() *string {
	return m.Id
}

// GetDisplayName returns DisplayName
func (m CloudExadataStorageServerSummary) GetDisplayName() *string {
	return m.DisplayName
}

// GetVersion returns Version
func (m CloudExadataStorageServerSummary) GetVersion() *string {
	return m.Version
}

// GetInternalId returns InternalId
func (m CloudExadataStorageServerSummary) GetInternalId() *string {
	return m.InternalId
}

// GetStatus returns Status
func (m CloudExadataStorageServerSummary) GetStatus() *string {
	return m.Status
}

// GetLifecycleState returns LifecycleState
func (m CloudExadataStorageServerSummary) GetLifecycleState() DbmResourceLifecycleStateEnum {
	return m.LifecycleState
}

// GetTimeCreated returns TimeCreated
func (m CloudExadataStorageServerSummary) GetTimeCreated() *common.SDKTime {
	return m.TimeCreated
}

// GetTimeUpdated returns TimeUpdated
func (m CloudExadataStorageServerSummary) GetTimeUpdated() *common.SDKTime {
	return m.TimeUpdated
}

// GetLifecycleDetails returns LifecycleDetails
func (m CloudExadataStorageServerSummary) GetLifecycleDetails() *string {
	return m.LifecycleDetails
}

// GetAdditionalDetails returns AdditionalDetails
func (m CloudExadataStorageServerSummary) GetAdditionalDetails() map[string]string {
	return m.AdditionalDetails
}

func (m CloudExadataStorageServerSummary) String() string {
...
func (m CloudExadataStorageServerSummary) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
...
func (m CloudExadataStorageServerSummary) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeCloudExadataStorageServerSummary CloudExadataStorageServerSummary
	s := struct {
		DiscriminatorParam string `json:"resourceType"`
		MarshalTypeCloudExadataStorageServerSummary
	}{
		"CLOUD_STORAGE_SERVER_SUMMARY",
		(MarshalTypeCloudExadataStorageServerSummary)(m),
	}

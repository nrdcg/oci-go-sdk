...
// StorageGridDiscoverySummary The summary of the Exadata storage server grid discovery.
type StorageGridDiscoverySummary struct {
...
// GetId returns Id
func (m StorageGridDiscoverySummary) GetId() *string {
	return m.Id
}

// GetAgentId returns AgentId
func (m StorageGridDiscoverySummary) GetAgentId() *string {
	return m.AgentId
}

// GetConnectorId returns ConnectorId
func (m StorageGridDiscoverySummary) GetConnectorId() *string {
	return m.ConnectorId
}

// GetDisplayName returns DisplayName
func (m StorageGridDiscoverySummary) GetDisplayName() *string {
	return m.DisplayName
}

// GetVersion returns Version
func (m StorageGridDiscoverySummary) GetVersion() *string {
	return m.Version
}

// GetInternalId returns InternalId
func (m StorageGridDiscoverySummary) GetInternalId() *string {
	return m.InternalId
}

// GetStatus returns Status
func (m StorageGridDiscoverySummary) GetStatus() *string {
	return m.Status
}

// GetDiscoverStatus returns DiscoverStatus
func (m StorageGridDiscoverySummary) GetDiscoverStatus() EntityDiscoveredDiscoverStatusEnum {
	return m.DiscoverStatus
}

// GetDiscoverErrorCode returns DiscoverErrorCode
func (m StorageGridDiscoverySummary) GetDiscoverErrorCode() *string {
	return m.DiscoverErrorCode
}

// GetDiscoverErrorMsg returns DiscoverErrorMsg
func (m StorageGridDiscoverySummary) GetDiscoverErrorMsg() *string {
	return m.DiscoverErrorMsg
}

func (m StorageGridDiscoverySummary) String() string {
...
func (m StorageGridDiscoverySummary) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
...
func (m StorageGridDiscoverySummary) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeStorageGridDiscoverySummary StorageGridDiscoverySummary
	s := struct {
		DiscriminatorParam string `json:"entityType"`
		MarshalTypeStorageGridDiscoverySummary
	}{
		"MANAGED_STORAGE_GRID_DISCOVER_SUMMARY",
		(MarshalTypeStorageGridDiscoverySummary)(m),
	}

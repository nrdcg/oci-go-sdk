...
func (m ExternalPluggableDatabaseDiagnosticsAndManagementFeatureDetails) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeExternalPluggableDatabaseDiagnosticsAndManagementFeatureDetails ExternalPluggableDatabaseDiagnosticsAndManagementFeatureDetails
	s := struct {
		DiscriminatorParam string `json:"feature"`
		MarshalTypeExternalPluggableDatabaseDiagnosticsAndManagementFeatureDetails
	}{
		"DIAGNOSTICS_AND_MANAGEMENT",
		(MarshalTypeExternalPluggableDatabaseDiagnosticsAndManagementFeatureDetails)(m),
	}

...
// ExternalMySqlDatabaseConnector Details of external database connector. MySQL support within OCI Database Management service has been deprecated as of January 29, 2026.

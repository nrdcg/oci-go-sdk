...
type GetDatabaseHaBackupDetailsRequest struct {
...
type GetDatabaseHaBackupDetailsResponse struct {

	// The underlying http response
	RawResponse *http.Response

	// The DatabaseHaBackupDetails instance
	DatabaseHaBackupDetails `presentIn:"body"`

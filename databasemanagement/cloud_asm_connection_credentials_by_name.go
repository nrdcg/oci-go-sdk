...
// CloudAsmConnectionCredentialsByName The existing named credential used to connect to the ASM instance.
type CloudAsmConnectionCredentialsByName struct {
...
func (m CloudAsmConnectionCredentialsByName) String() string {
...
func (m CloudAsmConnectionCredentialsByName) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
...
func (m CloudAsmConnectionCredentialsByName) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeCloudAsmConnectionCredentialsByName CloudAsmConnectionCredentialsByName
	s := struct {
		DiscriminatorParam string `json:"credentialType"`
		MarshalTypeCloudAsmConnectionCredentialsByName
	}{
		"NAME_REFERENCE",
		(MarshalTypeCloudAsmConnectionCredentialsByName)(m),
	}

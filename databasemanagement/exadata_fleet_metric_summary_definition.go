...
// ExadataFleetMetricSummaryDefinition A summary of the fleet metrics, which provides the metric aggregated value of the Exadata infrastructures in the fleet.
type ExadataFleetMetricSummaryDefinition struct {
...
func (m ExadataFleetMetricSummaryDefinition) String() string {
...
func (m ExadataFleetMetricSummaryDefinition) ValidateEnumValue() (bool, error) {
	errMessage := []string{}

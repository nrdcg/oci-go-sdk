...
type DisableExternalMysqlAssociatedServiceRequest struct {
	...
	DisableExternalMysqlAssociatedServiceDetails `contributesTo:"body"`
...
type DisableExternalMysqlAssociatedServiceResponse struct {

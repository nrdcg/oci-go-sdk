...
// CreateCloudDbSystemDetails The details required to create a cloud DB system.
type CreateCloudDbSystemDetails struct {
...
func (m CreateCloudDbSystemDetails) String() string {
...
func (m CreateCloudDbSystemDetails) ValidateEnumValue() (bool, error) {
	errMessage := []string{}

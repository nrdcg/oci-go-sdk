...
// CloudDbSystemDiscoverySummary The summary of a cloud DB system.
type CloudDbSystemDiscoverySummary struct {
...
func (m CloudDbSystemDiscoverySummary) String() string {
...
func (m CloudDbSystemDiscoverySummary) ValidateEnumValue() (bool, error) {
	errMessage := []string{}

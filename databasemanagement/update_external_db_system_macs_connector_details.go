...
func (m UpdateExternalDbSystemMacsConnectorDetails) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeUpdateExternalDbSystemMacsConnectorDetails UpdateExternalDbSystemMacsConnectorDetails
	s := struct {
		DiscriminatorParam string `json:"connectorType"`
		MarshalTypeUpdateExternalDbSystemMacsConnectorDetails
	}{
		"MACS",
		(MarshalTypeUpdateExternalDbSystemMacsConnectorDetails)(m),
	}

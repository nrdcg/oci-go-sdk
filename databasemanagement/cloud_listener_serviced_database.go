...
// CloudListenerServicedDatabase The details of a database serviced by a cloud listener.
type CloudListenerServicedDatabase struct {
...
func (m CloudListenerServicedDatabase) String() string {
...
func (m CloudListenerServicedDatabase) ValidateEnumValue() (bool, error) {
	errMessage := []string{}

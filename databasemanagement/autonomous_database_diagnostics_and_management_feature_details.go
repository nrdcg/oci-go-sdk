...
func (m AutonomousDatabaseDiagnosticsAndManagementFeatureDetails) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeAutonomousDatabaseDiagnosticsAndManagementFeatureDetails AutonomousDatabaseDiagnosticsAndManagementFeatureDetails
	s := struct {
		DiscriminatorParam string `json:"feature"`
		MarshalTypeAutonomousDatabaseDiagnosticsAndManagementFeatureDetails
	}{
		"DIAGNOSTICS_AND_MANAGEMENT",
		(MarshalTypeAutonomousDatabaseDiagnosticsAndManagementFeatureDetails)(m),
	}

...
// DiscoveredCloudAsmInstance The details of an ASM instance discovered in a cloud DB system discovery run.
type DiscoveredCloudAsmInstance struct {
...
func (m DiscoveredCloudAsmInstance) GetComponentId() *string {
	return m.ComponentId
}

// GetDisplayName returns DisplayName
func (m DiscoveredCloudAsmInstance) GetDisplayName() *string {
	return m.DisplayName
}

// GetComponentName returns ComponentName
func (m DiscoveredCloudAsmInstance) GetComponentName() *string {
	return m.ComponentName
}

// GetResourceId returns ResourceId
func (m DiscoveredCloudAsmInstance) GetResourceId() *string {
	return m.ResourceId
}

// GetDbaasId returns DbaasId
func (m DiscoveredCloudAsmInstance) GetDbaasId() *string {
	return m.DbaasId
}

// GetIsSelectedForMonitoring returns IsSelectedForMonitoring
func (m DiscoveredCloudAsmInstance) GetIsSelectedForMonitoring() *bool {
	return m.IsSelectedForMonitoring
}

// GetStatus returns Status
func (m DiscoveredCloudAsmInstance) GetStatus() DiscoveredCloudDbSystemComponentStatusEnum {
	return m.Status
}

// GetAssociatedComponents returns AssociatedComponents
func (m DiscoveredCloudAsmInstance) GetAssociatedComponents() []AssociatedCloudComponent {
	return m.AssociatedComponents
}

func (m DiscoveredCloudAsmInstance) String() string {
...
func (m DiscoveredCloudAsmInstance) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
...
func (m DiscoveredCloudAsmInstance) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeDiscoveredCloudAsmInstance DiscoveredCloudAsmInstance
	s := struct {
		DiscriminatorParam string `json:"componentType"`
		MarshalTypeDiscoveredCloudAsmInstance
	}{
		"ASM_INSTANCE",
		(MarshalTypeDiscoveredCloudAsmInstance)(m),
	}

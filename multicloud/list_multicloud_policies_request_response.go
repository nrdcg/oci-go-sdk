...
func (request ListMulticloudPoliciesRequest) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
	if _, ok := GetMappingListMulticloudPoliciesSortByEnum(string(request.SortBy)); !ok && request.SortBy != "" {
		errMessage = append(errMessage, fmt.Sprintf("unsupported enum value for SortBy: %s. Supported values are: %s.", request.SortBy, strings.Join(GetListMulticloudPoliciesSortByEnumStringValues(), ",")))
	}
	if _, ok := GetMappingListMulticloudPoliciesSortOrderEnum(string(request.SortOrder)); !ok && request.SortOrder != "" {
		errMessage = append(errMessage, fmt.Sprintf("unsupported enum value for SortOrder: %s. Supported values are: %s.", request.SortOrder, strings.Join(GetListMulticloudPoliciesSortOrderEnumStringValues(), ",")))
	}
	if len(errMessage) > 0 {
...
var mappingListMulticloudPoliciesSortByEnum = map[string]ListMulticloudPoliciesSortByEnum{
	"timeCreated": ListMulticloudPoliciesSortByTimecreated,
	"displayName": ListMulticloudPoliciesSortByDisplayname,
}

var mappingListMulticloudPoliciesSortByEnumLowerCase = map[string]ListMulticloudPoliciesSortByEnum{
	"timecreated": ListMulticloudPoliciesSortByTimecreated,
	"displayname": ListMulticloudPoliciesSortByDisplayname,
}
...
func GetListMulticloudPoliciesSortByEnumValues() []ListMulticloudPoliciesSortByEnum {
	values := make([]ListMulticloudPoliciesSortByEnum, 0)
	for _, v := range mappingListMulticloudPoliciesSortByEnum {
...
func GetMappingListMulticloudPoliciesSortByEnum(val string) (ListMulticloudPoliciesSortByEnum, bool) {
	enum, ok := mappingListMulticloudPoliciesSortByEnumLowerCase[strings.ToLower(val)]
	return enum, ok
}
...
var mappingListMulticloudPoliciesSortOrderEnum = map[string]ListMulticloudPoliciesSortOrderEnum{
	"ASC":  ListMulticloudPoliciesSortOrderAsc,
	"DESC": ListMulticloudPoliciesSortOrderDesc,
}

var mappingListMulticloudPoliciesSortOrderEnumLowerCase = map[string]ListMulticloudPoliciesSortOrderEnum{
	"asc":  ListMulticloudPoliciesSortOrderAsc,
	"desc": ListMulticloudPoliciesSortOrderDesc,
}
...
func GetListMulticloudPoliciesSortOrderEnumValues() []ListMulticloudPoliciesSortOrderEnum {
	values := make([]ListMulticloudPoliciesSortOrderEnum, 0)
	for _, v := range mappingListMulticloudPoliciesSortOrderEnum {
		values = append(values, v)
	}
	return values
}
...
func GetMappingListMulticloudPoliciesSortOrderEnum(val string) (ListMulticloudPoliciesSortOrderEnum, bool) {
	enum, ok := mappingListMulticloudPoliciesSortOrderEnumLowerCase[strings.ToLower(val)]
	return enum, ok
}

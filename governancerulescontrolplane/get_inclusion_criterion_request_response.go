...
type GetInclusionCriterionRequest struct {
	...
	InclusionCriterionId *string `mandatory:"true" contributesTo:"path" name:"inclusionCriterionId"`
...
type GetInclusionCriterionResponse struct {

	// The underlying http response
	RawResponse *http.Response

	// The InclusionCriterion instance
	InclusionCriterion `presentIn:"body"`

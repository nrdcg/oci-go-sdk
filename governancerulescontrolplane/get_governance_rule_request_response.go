...
type GetGovernanceRuleRequest struct {
	...
	GovernanceRuleId *string `mandatory:"true" contributesTo:"path" name:"governanceRuleId"`
...
type GetGovernanceRuleResponse struct {

	// The underlying http response
	RawResponse *http.Response

	// The GovernanceRule instance
	GovernanceRule `presentIn:"body"`

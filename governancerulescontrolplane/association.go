...
func (m *association) UnmarshalJSON(data []byte) error {
	m.JsonData = data
	type Unmarshalerassociation association
	s := struct {
		Model Unmarshalerassociation
	}{}
...
func (m *association) UnmarshalPolymorphicJSON(data []byte) (interface{}, error) {

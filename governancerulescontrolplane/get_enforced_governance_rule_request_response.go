...
type GetEnforcedGovernanceRuleRequest struct {
	...
	EnforcedGovernanceRuleId *string `mandatory:"true" contributesTo:"path" name:"enforcedGovernanceRuleId"`
...
type GetEnforcedGovernanceRuleResponse struct {

	// The underlying http response
	RawResponse *http.Response

	// The EnforcedGovernanceRule instance
	EnforcedGovernanceRule `presentIn:"body"`

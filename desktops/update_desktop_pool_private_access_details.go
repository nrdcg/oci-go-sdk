...
// UpdateDesktopPoolPrivateAccessDetails The details of the desktop's private access network connectivity to be set up for the desktop pool.
type UpdateDesktopPoolPrivateAccessDetails struct {
...
func (m UpdateDesktopPoolPrivateAccessDetails) String() string {
...
func (m UpdateDesktopPoolPrivateAccessDetails) ValidateEnumValue() (bool, error) {
	errMessage := []string{}

...
type UpdateDesktopPoolDetails struct {
	...
	NetworkConfiguration *UpdateDesktopNetworkConfiguration `mandatory:"false" json:"networkConfiguration"`

	PrivateAccessDetails *UpdateDesktopPoolPrivateAccessDetails `mandatory:"false" json:"privateAccessDetails"`

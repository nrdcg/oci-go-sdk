...
// GroundingWebChunk object containing the web source.
type GroundingWebChunk struct {
...
func (m GroundingWebChunk) String() string {
...
func (m GroundingWebChunk) ValidateEnumValue() (bool, error) {
	errMessage := []string{}

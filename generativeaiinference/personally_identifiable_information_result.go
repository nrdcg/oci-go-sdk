...
// PersonallyIdentifiableInformationResult An item of personally identifiable information.
type PersonallyIdentifiableInformationResult struct {
...
func (m PersonallyIdentifiableInformationResult) String() string {
...
func (m PersonallyIdentifiableInformationResult) ValidateEnumValue() (bool, error) {
	errMessage := []string{}

...
type AssistantMessage struct {
	...
	Refusal *string `mandatory:"false" json:"refusal"`
	...
	Annotations []Annotation `mandatory:"false" json:"annotations"`

	// Internal reasoning trace generated during response computation.
	ReasoningContent *string `mandatory:"false" json:"reasoningContent"`
}
...
func (m *AssistantMessage) UnmarshalJSON(data []byte) (e error) {
	...
	m.Annotations = make([]Annotation, len(model.Annotations))
	copy(m.Annotations, model.Annotations)
	m.ReasoningContent = model.ReasoningContent

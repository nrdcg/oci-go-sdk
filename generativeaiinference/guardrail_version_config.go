...
// GuardrailVersionConfig The version of the guardrail to use. If not specified, the default version will be used.
...
func (m GuardrailVersionConfig) String() string {
...
func (m GuardrailVersionConfig) ValidateEnumValue() (bool, error) {
	errMessage := []string{}

...
// ApproximateLocation To refine search results based on geography, you can specify an approximate user location using any of the following:
...
func (m ApproximateLocation) String() string {
...
func (m ApproximateLocation) ValidateEnumValue() (bool, error) {
	errMessage := []string{}

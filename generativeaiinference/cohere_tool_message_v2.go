...
// CohereToolMessageV2 A message that represents a single chat dialog as TOOL role.
type CohereToolMessageV2 struct {
	...
	ToolCallId *string `mandatory:"true" json:"toolCallId"`
}

// GetContent returns Content
func (m CohereToolMessageV2) GetContent() []CohereContentV2 {
	return m.Content
}

func (m CohereToolMessageV2) String() string {
...
func (m CohereToolMessageV2) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
...
func (m CohereToolMessageV2) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeCohereToolMessageV2 CohereToolMessageV2
	s := struct {
		DiscriminatorParam string `json:"role"`
		MarshalTypeCohereToolMessageV2
	}{
		"TOOL",
		(MarshalTypeCohereToolMessageV2)(m),
	}
...
func (m *CohereToolMessageV2) UnmarshalJSON(data []byte) (e error) {
	model := struct {

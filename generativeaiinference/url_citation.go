...
// UrlCitation Contains metadata for a cited URL included in the assistant’s response.
...
func (m UrlCitation) String() string {
...
func (m UrlCitation) ValidateEnumValue() (bool, error) {
	errMessage := []string{}

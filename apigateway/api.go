...
// Api An API is simple container for an API Specification. For more information, see API Gateway Concepts (https://docs.oracle.com/iaas/Content/APIGateway/Concepts/apigatewayconcepts.htm).
type Api struct {

...
func (m ValidationBlockClientAppDetails) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeValidationBlockClientAppDetails ValidationBlockClientAppDetails
	s := struct {
		DiscriminatorParam string `json:"type"`
		MarshalTypeValidationBlockClientAppDetails
	}{
		"VALIDATION_BLOCK",
		(MarshalTypeValidationBlockClientAppDetails)(m),
	}

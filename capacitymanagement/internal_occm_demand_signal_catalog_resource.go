...
var mappingInternalOccmDemandSignalCatalogResourceLifecycleStateEnum = map[string]InternalOccmDemandSignalCatalogResourceLifecycleStateEnum{
	"CREATING": InternalOccmDemandSignalCatalogResourceLifecycleStateCreating,
	"ACTIVE":   InternalOccmDemandSignalCatalogResourceLifecycleStateActive,
	"UPDATING": InternalOccmDemandSignalCatalogResourceLifecycleStateUpdating,
	"DELETED":  InternalOccmDemandSignalCatalogResourceLifecycleStateDeleted,
	"DELETING": InternalOccmDemandSignalCatalogResourceLifecycleStateDeleting,
	"FAILED":   InternalOccmDemandSignalCatalogResourceLifecycleStateFailed,
}

var mappingInternalOccmDemandSignalCatalogResourceLifecycleStateEnumLowerCase = map[string]InternalOccmDemandSignalCatalogResourceLifecycleStateEnum{
	"creating": InternalOccmDemandSignalCatalogResourceLifecycleStateCreating,
	"active":   InternalOccmDemandSignalCatalogResourceLifecycleStateActive,
	"updating": InternalOccmDemandSignalCatalogResourceLifecycleStateUpdating,
	"deleted":  InternalOccmDemandSignalCatalogResourceLifecycleStateDeleted,
...
func GetInternalOccmDemandSignalCatalogResourceLifecycleStateEnumValues() []InternalOccmDemandSignalCatalogResourceLifecycleStateEnum {
	values := make([]InternalOccmDemandSignalCatalogResourceLifecycleStateEnum, 0)
	for _, v := range mappingInternalOccmDemandSignalCatalogResourceLifecycleStateEnum {
...
func GetMappingInternalOccmDemandSignalCatalogResourceLifecycleStateEnum(val string) (InternalOccmDemandSignalCatalogResourceLifecycleStateEnum, bool) {
	enum, ok := mappingInternalOccmDemandSignalCatalogResourceLifecycleStateEnumLowerCase[strings.ToLower(val)]
	return enum, ok
}

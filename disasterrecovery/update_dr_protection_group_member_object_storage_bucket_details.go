...
func (m UpdateDrProtectionGroupMemberObjectStorageBucketDetails) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeUpdateDrProtectionGroupMemberObjectStorageBucketDetails UpdateDrProtectionGroupMemberObjectStorageBucketDetails
	s := struct {
		DiscriminatorParam string `json:"memberType"`
		MarshalTypeUpdateDrProtectionGroupMemberObjectStorageBucketDetails
	}{
		"OBJECT_STORAGE_BUCKET",
		(MarshalTypeUpdateDrProtectionGroupMemberObjectStorageBucketDetails)(m),
	}

...
func (m StopDrillPrecheckExecutionOptions) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeStopDrillPrecheckExecutionOptions StopDrillPrecheckExecutionOptions
	s := struct {
		DiscriminatorParam string `json:"planExecutionType"`
		MarshalTypeStopDrillPrecheckExecutionOptions
	}{
		"STOP_DRILL_PRECHECK",
		(MarshalTypeStopDrillPrecheckExecutionOptions)(m),
	}

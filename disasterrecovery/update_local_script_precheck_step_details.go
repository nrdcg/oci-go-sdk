...
func (m UpdateLocalScriptPrecheckStepDetails) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeUpdateLocalScriptPrecheckStepDetails UpdateLocalScriptPrecheckStepDetails
	s := struct {
		DiscriminatorParam string `json:"stepType"`
		MarshalTypeUpdateLocalScriptPrecheckStepDetails
	}{
		"RUN_LOCAL_SCRIPT_PRECHECK",
		(MarshalTypeUpdateLocalScriptPrecheckStepDetails)(m),
	}

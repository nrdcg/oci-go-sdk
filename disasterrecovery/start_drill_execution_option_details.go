...
func (m StartDrillExecutionOptionDetails) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeStartDrillExecutionOptionDetails StartDrillExecutionOptionDetails
	s := struct {
		DiscriminatorParam string `json:"planExecutionType"`
		MarshalTypeStartDrillExecutionOptionDetails
	}{
		"START_DRILL",
		(MarshalTypeStartDrillExecutionOptionDetails)(m),
	}

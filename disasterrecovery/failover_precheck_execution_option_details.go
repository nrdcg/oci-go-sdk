...
func (m FailoverPrecheckExecutionOptionDetails) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeFailoverPrecheckExecutionOptionDetails FailoverPrecheckExecutionOptionDetails
	s := struct {
		DiscriminatorParam string `json:"planExecutionType"`
		MarshalTypeFailoverPrecheckExecutionOptionDetails
	}{
		"FAILOVER_PRECHECK",
		(MarshalTypeFailoverPrecheckExecutionOptionDetails)(m),
	}

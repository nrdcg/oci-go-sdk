...
func (m SwitchoverPrecheckExecutionOptions) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeSwitchoverPrecheckExecutionOptions SwitchoverPrecheckExecutionOptions
	s := struct {
		DiscriminatorParam string `json:"planExecutionType"`
		MarshalTypeSwitchoverPrecheckExecutionOptions
	}{
		"SWITCHOVER_PRECHECK",
		(MarshalTypeSwitchoverPrecheckExecutionOptions)(m),
	}

...
func (m CreateDrProtectionGroupMemberVolumeGroupDetails) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeCreateDrProtectionGroupMemberVolumeGroupDetails CreateDrProtectionGroupMemberVolumeGroupDetails
	s := struct {
		DiscriminatorParam string `json:"memberType"`
		MarshalTypeCreateDrProtectionGroupMemberVolumeGroupDetails
	}{
		"VOLUME_GROUP",
		(MarshalTypeCreateDrProtectionGroupMemberVolumeGroupDetails)(m),
	}

...
func (m UpdateInvokeFunctionPrecheckStepDetails) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeUpdateInvokeFunctionPrecheckStepDetails UpdateInvokeFunctionPrecheckStepDetails
	s := struct {
		DiscriminatorParam string `json:"stepType"`
		MarshalTypeUpdateInvokeFunctionPrecheckStepDetails
	}{
		"INVOKE_FUNCTION_PRECHECK",
		(MarshalTypeUpdateInvokeFunctionPrecheckStepDetails)(m),
	}

...
func (m UpdateDrProtectionGroupMemberLoadBalancerDetails) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeUpdateDrProtectionGroupMemberLoadBalancerDetails UpdateDrProtectionGroupMemberLoadBalancerDetails
	s := struct {
		DiscriminatorParam string `json:"memberType"`
		MarshalTypeUpdateDrProtectionGroupMemberLoadBalancerDetails
	}{
		"LOAD_BALANCER",
		(MarshalTypeUpdateDrProtectionGroupMemberLoadBalancerDetails)(m),
	}

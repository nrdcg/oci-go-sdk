...
func (m UpdateDrProtectionGroupMemberAutonomousContainerDatabaseDetails) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeUpdateDrProtectionGroupMemberAutonomousContainerDatabaseDetails UpdateDrProtectionGroupMemberAutonomousContainerDatabaseDetails
	s := struct {
		DiscriminatorParam string `json:"memberType"`
		MarshalTypeUpdateDrProtectionGroupMemberAutonomousContainerDatabaseDetails
	}{
		"AUTONOMOUS_CONTAINER_DATABASE",
		(MarshalTypeUpdateDrProtectionGroupMemberAutonomousContainerDatabaseDetails)(m),
	}

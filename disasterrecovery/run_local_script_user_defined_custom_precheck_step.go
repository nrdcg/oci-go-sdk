...
// RunLocalScriptUserDefinedCustomPrecheckStep Run Local Script User Defined custom precheck step details.
type RunLocalScriptUserDefinedCustomPrecheckStep struct {
...
func (m RunLocalScriptUserDefinedCustomPrecheckStep) String() string {
...
func (m RunLocalScriptUserDefinedCustomPrecheckStep) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
...
func (m RunLocalScriptUserDefinedCustomPrecheckStep) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeRunLocalScriptUserDefinedCustomPrecheckStep RunLocalScriptUserDefinedCustomPrecheckStep
	s := struct {
		DiscriminatorParam string `json:"stepType"`
		MarshalTypeRunLocalScriptUserDefinedCustomPrecheckStep
	}{
		"RUN_LOCAL_SCRIPT_USER_DEFINED_CUSTOM_PRECHECK",
		(MarshalTypeRunLocalScriptUserDefinedCustomPrecheckStep)(m),
	}

...
func (m CreateDrProtectionGroupMemberNetworkLoadBalancerDetails) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeCreateDrProtectionGroupMemberNetworkLoadBalancerDetails CreateDrProtectionGroupMemberNetworkLoadBalancerDetails
	s := struct {
		DiscriminatorParam string `json:"memberType"`
		MarshalTypeCreateDrProtectionGroupMemberNetworkLoadBalancerDetails
	}{
		"NETWORK_LOAD_BALANCER",
		(MarshalTypeCreateDrProtectionGroupMemberNetworkLoadBalancerDetails)(m),
	}

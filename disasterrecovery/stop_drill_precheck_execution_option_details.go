...
func (m StopDrillPrecheckExecutionOptionDetails) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeStopDrillPrecheckExecutionOptionDetails StopDrillPrecheckExecutionOptionDetails
	s := struct {
		DiscriminatorParam string `json:"planExecutionType"`
		MarshalTypeStopDrillPrecheckExecutionOptionDetails
	}{
		"STOP_DRILL_PRECHECK",
		(MarshalTypeStopDrillPrecheckExecutionOptionDetails)(m),
	}

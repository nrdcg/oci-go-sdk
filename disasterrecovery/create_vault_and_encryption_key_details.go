...
// CreateVaultAndEncryptionKeyDetails Create properties for a customer-managed vault and encryption key in the destination region.
...
type CreateVaultAndEncryptionKeyDetails struct {
...
func (m CreateVaultAndEncryptionKeyDetails) String() string {
...
func (m CreateVaultAndEncryptionKeyDetails) ValidateEnumValue() (bool, error) {
	errMessage := []string{}

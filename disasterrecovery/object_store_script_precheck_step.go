...
func (m ObjectStoreScriptPrecheckStep) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeObjectStoreScriptPrecheckStep ObjectStoreScriptPrecheckStep
	s := struct {
		DiscriminatorParam string `json:"stepType"`
		MarshalTypeObjectStoreScriptPrecheckStep
	}{
		"RUN_OBJECTSTORE_SCRIPT_PRECHECK",
		(MarshalTypeObjectStoreScriptPrecheckStep)(m),
	}

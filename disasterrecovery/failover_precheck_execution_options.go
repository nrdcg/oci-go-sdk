...
func (m FailoverPrecheckExecutionOptions) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeFailoverPrecheckExecutionOptions FailoverPrecheckExecutionOptions
	s := struct {
		DiscriminatorParam string `json:"planExecutionType"`
		MarshalTypeFailoverPrecheckExecutionOptions
	}{
		"FAILOVER_PRECHECK",
		(MarshalTypeFailoverPrecheckExecutionOptions)(m),
	}

...
func (m DrProtectionGroupMemberAutonomousContainerDatabase) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeDrProtectionGroupMemberAutonomousContainerDatabase DrProtectionGroupMemberAutonomousContainerDatabase
	s := struct {
		DiscriminatorParam string `json:"memberType"`
		MarshalTypeDrProtectionGroupMemberAutonomousContainerDatabase
	}{
		"AUTONOMOUS_CONTAINER_DATABASE",
		(MarshalTypeDrProtectionGroupMemberAutonomousContainerDatabase)(m),
	}

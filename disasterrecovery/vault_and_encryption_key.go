...
// VaultAndEncryptionKey The OCID of a vault and customer-managed encryption key in the destination region.
...
type VaultAndEncryptionKey struct {
...
func (m VaultAndEncryptionKey) String() string {
...
func (m VaultAndEncryptionKey) ValidateEnumValue() (bool, error) {
	errMessage := []string{}

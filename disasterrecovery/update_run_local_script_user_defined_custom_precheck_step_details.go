...
// UpdateRunLocalScriptUserDefinedCustomPrecheckStepDetails The details for updating a Run Local Script Precheck step.
type UpdateRunLocalScriptUserDefinedCustomPrecheckStepDetails struct {
...
func (m UpdateRunLocalScriptUserDefinedCustomPrecheckStepDetails) String() string {
...
func (m UpdateRunLocalScriptUserDefinedCustomPrecheckStepDetails) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
...
func (m UpdateRunLocalScriptUserDefinedCustomPrecheckStepDetails) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeUpdateRunLocalScriptUserDefinedCustomPrecheckStepDetails UpdateRunLocalScriptUserDefinedCustomPrecheckStepDetails
	s := struct {
		...
		(MarshalTypeUpdateRunLocalScriptUserDefinedCustomPrecheckStepDetails)(m),
	}

...
func (m OneTimeMaintenanceWindowSchedule) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeOneTimeMaintenanceWindowSchedule OneTimeMaintenanceWindowSchedule
	s := struct {
		DiscriminatorParam string `json:"scheduleType"`
		MarshalTypeOneTimeMaintenanceWindowSchedule
	}{
		"ONE_TIME",
		(MarshalTypeOneTimeMaintenanceWindowSchedule)(m),
	}

...
// VmwareBinary A third party VMware Binary file.
type VmwareBinary struct {
...
func (m VmwareBinary) String() string {
...
func (m VmwareBinary) ValidateEnumValue() (bool, error) {
	errMessage := []string{}

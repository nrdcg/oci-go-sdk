...
// CreateDatastoreDetails Details of the Datastore
type CreateDatastoreDetails struct {
...
func (m CreateDatastoreDetails) String() string {
...
func (m CreateDatastoreDetails) ValidateEnumValue() (bool, error) {
	errMessage := []string{}

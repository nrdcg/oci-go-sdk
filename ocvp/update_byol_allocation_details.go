...
type UpdateByolAllocationDetails struct {
	...
	AllocatedUnits *int `mandatory:"false" json:"allocatedUnits"`
...
func (m UpdateByolAllocationDetails) String() string {
...
func (m UpdateByolAllocationDetails) ValidateEnumValue() (bool, error) {
	errMessage := []string{}

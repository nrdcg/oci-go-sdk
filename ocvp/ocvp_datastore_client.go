...
// # See also
//
// Click https://docs.oracle.com/en-us/iaas/tools/go-sdk-examples/latest/ocvp/AddBlockVolumeToDatastore.go.html to see an example of how to use AddBlockVolumeToDatastore API.
...
// # See also
//
// Click https://docs.oracle.com/en-us/iaas/tools/go-sdk-examples/latest/ocvp/ChangeDatastoreCompartment.go.html to see an example of how to use ChangeDatastoreCompartment API.
...
// # See also
//
// Click https://docs.oracle.com/en-us/iaas/tools/go-sdk-examples/latest/ocvp/CreateDatastore.go.html to see an example of how to use CreateDatastore API.
...
// # See also
//
// Click https://docs.oracle.com/en-us/iaas/tools/go-sdk-examples/latest/ocvp/DeleteDatastore.go.html to see an example of how to use DeleteDatastore API.
...
// # See also
//
// Click https://docs.oracle.com/en-us/iaas/tools/go-sdk-examples/latest/ocvp/GetDatastore.go.html to see an example of how to use GetDatastore API.
...
// # See also
//
// Click https://docs.oracle.com/en-us/iaas/tools/go-sdk-examples/latest/ocvp/ListDatastores.go.html to see an example of how to use ListDatastores API.
...
// # See also
//
// Click https://docs.oracle.com/en-us/iaas/tools/go-sdk-examples/latest/ocvp/UpdateDatastore.go.html to see an example of how to use UpdateDatastore API.

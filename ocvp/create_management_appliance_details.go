...
// CreateManagementApplianceDetails Information about management appliance to be created.
type CreateManagementApplianceDetails struct {
...
func (m CreateManagementApplianceDetails) String() string {
...
func (m CreateManagementApplianceDetails) ValidateEnumValue() (bool, error) {
	errMessage := []string{}

...
// CreateByolAllocationDetails The details to create a BYOL.
type CreateByolAllocationDetails struct {
...
func (m CreateByolAllocationDetails) String() string {
...
func (m CreateByolAllocationDetails) ValidateEnumValue() (bool, error) {
	errMessage := []string{}

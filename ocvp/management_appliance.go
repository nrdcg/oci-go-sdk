...
// ManagementAppliance Information about management appliance.
...
func (m ManagementAppliance) String() string {
...
func (m ManagementAppliance) ValidateEnumValue() (bool, error) {
	errMessage := []string{}

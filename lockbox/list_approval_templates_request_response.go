...
func (request ListApprovalTemplatesRequest) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
	if _, ok := GetMappingApprovalTemplateLifecycleStateEnum(string(request.LifecycleState)); !ok && request.LifecycleState != "" {
		errMessage = append(errMessage, fmt.Sprintf("unsupported enum value for LifecycleState: %s. Supported values are: %s.", request.LifecycleState, strings.Join(GetApprovalTemplateLifecycleStateEnumStringValues(), ",")))
	}
	if _, ok := GetMappingListApprovalTemplatesSortOrderEnum(string(request.SortOrder)); !ok && request.SortOrder != "" {
		errMessage = append(errMessage, fmt.Sprintf("unsupported enum value for SortOrder: %s. Supported values are: %s.", request.SortOrder, strings.Join(GetListApprovalTemplatesSortOrderEnumStringValues(), ",")))
	}
	if _, ok := GetMappingListApprovalTemplatesSortByEnum(string(request.SortBy)); !ok && request.SortBy != "" {
		errMessage = append(errMessage, fmt.Sprintf("unsupported enum value for SortBy: %s. Supported values are: %s.", request.SortBy, strings.Join(GetListApprovalTemplatesSortByEnumStringValues(), ",")))
	}
	if len(errMessage) > 0 {
...
var mappingListApprovalTemplatesSortOrderEnum = map[string]ListApprovalTemplatesSortOrderEnum{
	"ASC":  ListApprovalTemplatesSortOrderAsc,
	"DESC": ListApprovalTemplatesSortOrderDesc,
}

var mappingListApprovalTemplatesSortOrderEnumLowerCase = map[string]ListApprovalTemplatesSortOrderEnum{
	"asc":  ListApprovalTemplatesSortOrderAsc,
	"desc": ListApprovalTemplatesSortOrderDesc,
}
...
func GetListApprovalTemplatesSortOrderEnumValues() []ListApprovalTemplatesSortOrderEnum {
	values := make([]ListApprovalTemplatesSortOrderEnum, 0)
	for _, v := range mappingListApprovalTemplatesSortOrderEnum {
...
func GetMappingListApprovalTemplatesSortOrderEnum(val string) (ListApprovalTemplatesSortOrderEnum, bool) {
	enum, ok := mappingListApprovalTemplatesSortOrderEnumLowerCase[strings.ToLower(val)]
	return enum, ok
}
...
var mappingListApprovalTemplatesSortByEnum = map[string]ListApprovalTemplatesSortByEnum{
	"timeCreated": ListApprovalTemplatesSortByTimecreated,
	"displayName": ListApprovalTemplatesSortByDisplayname,
	"id":          ListApprovalTemplatesSortById,
}

var mappingListApprovalTemplatesSortByEnumLowerCase = map[string]ListApprovalTemplatesSortByEnum{
	"timecreated": ListApprovalTemplatesSortByTimecreated,
	"displayname": ListApprovalTemplatesSortByDisplayname,
	"id":          ListApprovalTemplatesSortById,
}
...
func GetListApprovalTemplatesSortByEnumValues() []ListApprovalTemplatesSortByEnum {
	values := make([]ListApprovalTemplatesSortByEnum, 0)
	for _, v := range mappingListApprovalTemplatesSortByEnum {
		values = append(values, v)
	}
	return values
}
...
func GetMappingListApprovalTemplatesSortByEnum(val string) (ListApprovalTemplatesSortByEnum, bool) {
	enum, ok := mappingListApprovalTemplatesSortByEnumLowerCase[strings.ToLower(val)]
	return enum, ok
}

...
// ImportOciCacheFromObjectStorageObject An object to import from the specified bucket.
type ImportOciCacheFromObjectStorageObject struct {

	// The name of the object in the bucket (for example, 'customerA/exports/backup_ocid/dump.rdb').
	ObjectName *string `mandatory:"true" json:"objectName"`
}

func (m ImportOciCacheFromObjectStorageObject) String() string {
...
func (m ImportOciCacheFromObjectStorageObject) ValidateEnumValue() (bool, error) {
	errMessage := []string{}

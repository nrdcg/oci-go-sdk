...
// ImportOciCacheFromObjectStorageDetails Details for importing OCI Cache data from Object Storage RDB file(s) during cluster creation.
type ImportOciCacheFromObjectStorageDetails struct {
...
func (m ImportOciCacheFromObjectStorageDetails) String() string {
...
func (m ImportOciCacheFromObjectStorageDetails) ValidateEnumValue() (bool, error) {
	errMessage := []string{}

...
func (m *updateconfigurationsourceproviderdetails) UnmarshalPolymorphicJSON(data []byte) (interface{}, error) {
	...
	case "BITBUCKET_CLOUD_ACCESS_TOKEN":
		mm := UpdateBitbucketCloudEmailApiTokenConfigurationSourceProviderDetails{}
		err = json.Unmarshal(data, &mm)
		return mm, err
	case "GITHUB_ACCESS_TOKEN":
		...
		return mm, err
	default:
		common.Logf("Received unsupported enum value for UpdateConfigurationSourceProviderDetails: %s.", m.ConfigSourceProviderType)
		return *m, nil
	}
}

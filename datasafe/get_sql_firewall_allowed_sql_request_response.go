...
type GetSqlFirewallAllowedSqlRequest struct {

	// The OCID of the sqlFirewallAllowedSql resource.
	SqlFirewallAllowedSqlId *string `mandatory:"true" contributesTo:"path" name:"sqlFirewallAllowedSqlId"`
...
type GetSqlFirewallAllowedSqlResponse struct {

	// The underlying http response
	RawResponse *http.Response

	// The SqlFirewallAllowedSql instance
	SqlFirewallAllowedSql `presentIn:"body"`

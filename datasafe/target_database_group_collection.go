...
type TargetDatabaseGroupCollection struct {
	...
	Items []TargetDatabaseGroupSummary `mandatory:"true" json:"items"`
}

func (m TargetDatabaseGroupCollection) String() string {
...
func (m TargetDatabaseGroupCollection) ValidateEnumValue() (bool, error) {
	errMessage := []string{}

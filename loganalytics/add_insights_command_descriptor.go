...
func (m AddInsightsCommandDescriptor) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeAddInsightsCommandDescriptor AddInsightsCommandDescriptor
	s := struct {
		DiscriminatorParam string `json:"name"`
		MarshalTypeAddInsightsCommandDescriptor
	}{
		"ADD_INSIGHTS",
		(MarshalTypeAddInsightsCommandDescriptor)(m),
	}

...
func NewDistributedAutonomousDbServiceClientWithConfigurationProvider(configProvider common.ConfigurationProvider) (client DistributedAutonomousDbServiceClient, err error) {
	if enabled := common.CheckForEnabledServices("distributeddatabasev26"); !enabled {
...
func (client *DistributedAutonomousDbServiceClient) SetRegion(region string) {
	client.Host = common.StringToRegion(region).EndpointForTemplate("distributeddatabasev26", "https://globaldb.{region}.oci.{secondLevelDomain}")
}
...
// # See also
//
// Click https://docs.oracle.com/en-us/iaas/tools/go-sdk-examples/latest/distributeddatabasev26/AddDistributedAutonomousDatabaseGdsControlNode.go.html to see an example of how to use AddDistributedAutonomousDatabaseGdsControlNode API.
...
// # See also
//
// Click https://docs.oracle.com/en-us/iaas/tools/go-sdk-examples/latest/distributeddatabasev26/ChangeDistributedAutonomousDatabaseCompartment.go.html to see an example of how to use ChangeDistributedAutonomousDatabaseCompartment API.
...
// # See also
//
// Click https://docs.oracle.com/en-us/iaas/tools/go-sdk-examples/latest/distributeddatabasev26/ChangeDistributedAutonomousDbBackupConfig.go.html to see an example of how to use ChangeDistributedAutonomousDbBackupConfig API.
...
// ConfigureDistributedAutonomousDatabaseAutoResourceManagement Configure autoResourceManagement options for the Globally distributed autonomous database.
//
// # See also
//
// Click https://docs.oracle.com/en-us/iaas/tools/go-sdk-examples/latest/distributeddatabasev26/ConfigureDistributedAutonomousDatabaseAutoResourceManagement.go.html to see an example of how to use ConfigureDistributedAutonomousDatabaseAutoResourceManagement API.
// A default retry strategy applies to this operation ConfigureDistributedAutonomousDatabaseAutoResourceManagement()
func (client DistributedAutonomousDbServiceClient) ConfigureDistributedAutonomousDatabaseAutoResourceManagement(ctx context.Context, request ConfigureDistributedAutonomousDatabaseAutoResourceManagementRequest) (response ConfigureDistributedAutonomousDatabaseAutoResourceManagementResponse, err error) {
	var ociResponse common.OCIResponse
	policy := common.DefaultRetryPolicy()
	if client.RetryPolicy() != nil {
		policy = *client.RetryPolicy()
	...
	ociResponse, err = common.Retry(ctx, request, client.configureDistributedAutonomousDatabaseAutoResourceManagement, policy)
	if err != nil {
		if ociResponse != nil {
			if httpResponse := ociResponse.HTTPResponse(); httpResponse != nil {
				opcRequestId := httpResponse.Header.Get("opc-request-id")
				response = ConfigureDistributedAutonomousDatabaseAutoResourceManagementResponse{RawResponse: httpResponse, OpcRequestId: &opcRequestId}
			} else {
				response = ConfigureDistributedAutonomousDatabaseAutoResourceManagementResponse{}
			}
		}
		return
	}
	if convertedResponse, ok := ociResponse.(ConfigureDistributedAutonomousDatabaseAutoResourceManagementResponse); ok {
		response = convertedResponse
	} else {
		err = fmt.Errorf("failed to convert OCIResponse into ConfigureDistributedAutonomousDatabaseAutoResourceManagementResponse")
	}
	return
}

// configureDistributedAutonomousDatabaseAutoResourceManagement implements the OCIOperation interface (enables retrying operations)
func (client DistributedAutonomousDbServiceClient) configureDistributedAutonomousDatabaseAutoResourceManagement(ctx context.Context, request common.OCIRequest, binaryReqBody *common.OCIReadSeekCloser, extraHeaders map[string]string) (common.OCIResponse, error) {

	httpRequest, err := request.HTTPRequest(http.MethodPost, "/distributedAutonomousDatabases/{distributedAutonomousDatabaseId}/actions/configureAutoResourceManagement", binaryReqBody, extraHeaders)
	if err != nil {
		return nil, err
	}

	var response ConfigureDistributedAutonomousDatabaseAutoResourceManagementResponse
	var httpResponse *http.Response
	httpResponse, err = client.CallWithServiceAndOperationName(ctx, &httpRequest, "distributedAutonomousDbService", "ConfigureDistributedAutonomousDatabaseAutoResourceManagement")
	defer common.CloseBodyIfValid(httpResponse)
	response.RawResponse = httpResponse
	if err != nil {
		...
		err = common.PostProcessServiceError(err, "DistributedAutonomousDbService", "ConfigureDistributedAutonomousDatabaseAutoResourceManagement", apiReferenceLink)
		return response, err
	}
...
// # See also
//
// Click https://docs.oracle.com/en-us/iaas/tools/go-sdk-examples/latest/distributeddatabasev26/ConfigureDistributedAutonomousDatabaseGsmWallet.go.html to see an example of how to use ConfigureDistributedAutonomousDatabaseGsmWallet API.
...
// # See also
//
// Click https://docs.oracle.com/en-us/iaas/tools/go-sdk-examples/latest/distributeddatabasev26/ConfigureDistributedAutonomousDatabaseGsms.go.html to see an example of how to use ConfigureDistributedAutonomousDatabaseGsms API.
...
// # See also
//
// Click https://docs.oracle.com/en-us/iaas/tools/go-sdk-examples/latest/distributeddatabasev26/ConfigureDistributedAutonomousDatabaseSharding.go.html to see an example of how to use ConfigureDistributedAutonomousDatabaseSharding API.
...
// # See also
//
// Click https://docs.oracle.com/en-us/iaas/tools/go-sdk-examples/latest/distributeddatabasev26/CreateDistributedAutonomousDatabase.go.html to see an example of how to use CreateDistributedAutonomousDatabase API.
...
// # See also
//
// Click https://docs.oracle.com/en-us/iaas/tools/go-sdk-examples/latest/distributeddatabasev26/DeleteDistributedAutonomousDatabase.go.html to see an example of how to use DeleteDistributedAutonomousDatabase API.
...
// # See also
//
// Click https://docs.oracle.com/en-us/iaas/tools/go-sdk-examples/latest/distributeddatabasev26/GenerateDistributedAutonomousDatabaseWallet.go.html to see an example of how to use GenerateDistributedAutonomousDatabaseWallet API.
...
// # See also
//
// Click https://docs.oracle.com/en-us/iaas/tools/go-sdk-examples/latest/distributeddatabasev26/GetDistributedAutonomousDatabase.go.html to see an example of how to use GetDistributedAutonomousDatabase API.
...
// # See also
//
// Click https://docs.oracle.com/en-us/iaas/tools/go-sdk-examples/latest/distributeddatabasev26/GetDistributedAutonomousDatabaseRaftMetric.go.html to see an example of how to use GetDistributedAutonomousDatabaseRaftMetric API.
...
// GetDistributedAutonomousDatabaseRuChangeLog Operation to retrieve move RU invocation history and status for the Globally distributed autonomous database.
// Results are ordered by created timestamp in descending order.
//
// # See also
//
// Click https://docs.oracle.com/en-us/iaas/tools/go-sdk-examples/latest/distributeddatabasev26/GetDistributedAutonomousDatabaseRuChangeLog.go.html to see an example of how to use GetDistributedAutonomousDatabaseRuChangeLog API.
// A default retry strategy applies to this operation GetDistributedAutonomousDatabaseRuChangeLog()
func (client DistributedAutonomousDbServiceClient) GetDistributedAutonomousDatabaseRuChangeLog(ctx context.Context, request GetDistributedAutonomousDatabaseRuChangeLogRequest) (response GetDistributedAutonomousDatabaseRuChangeLogResponse, err error) {
	var ociResponse common.OCIResponse
	policy := common.DefaultRetryPolicy()
	if client.RetryPolicy() != nil {
		policy = *client.RetryPolicy()
	...
	ociResponse, err = common.Retry(ctx, request, client.getDistributedAutonomousDatabaseRuChangeLog, policy)
	if err != nil {
		if ociResponse != nil {
			if httpResponse := ociResponse.HTTPResponse(); httpResponse != nil {
				opcRequestId := httpResponse.Header.Get("opc-request-id")
				response = GetDistributedAutonomousDatabaseRuChangeLogResponse{RawResponse: httpResponse, OpcRequestId: &opcRequestId}
			} else {
				response = GetDistributedAutonomousDatabaseRuChangeLogResponse{}
			}
		}
		return
	}
	if convertedResponse, ok := ociResponse.(GetDistributedAutonomousDatabaseRuChangeLogResponse); ok {
		response = convertedResponse
	} else {
		err = fmt.Errorf("failed to convert OCIResponse into GetDistributedAutonomousDatabaseRuChangeLogResponse")
	}
	return
}

// getDistributedAutonomousDatabaseRuChangeLog implements the OCIOperation interface (enables retrying operations)
func (client DistributedAutonomousDbServiceClient) getDistributedAutonomousDatabaseRuChangeLog(ctx context.Context, request common.OCIRequest, binaryReqBody *common.OCIReadSeekCloser, extraHeaders map[string]string) (common.OCIResponse, error) {

	httpRequest, err := request.HTTPRequest(http.MethodGet, "/distributedAutonomousDatabases/{distributedAutonomousDatabaseId}/ruChangeLog", binaryReqBody, extraHeaders)
	if err != nil {
		return nil, err
	}

	var response GetDistributedAutonomousDatabaseRuChangeLogResponse
	var httpResponse *http.Response
	httpResponse, err = client.CallWithServiceAndOperationName(ctx, &httpRequest, "distributedAutonomousDbService", "GetDistributedAutonomousDatabaseRuChangeLog")
	defer common.CloseBodyIfValid(httpResponse)
	response.RawResponse = httpResponse
	if err != nil {
		...
		err = common.PostProcessServiceError(err, "DistributedAutonomousDbService", "GetDistributedAutonomousDatabaseRuChangeLog", apiReferenceLink)
		return response, err
	}
...
// # See also
//
// Click https://docs.oracle.com/en-us/iaas/tools/go-sdk-examples/latest/distributeddatabasev26/ListDistributedAutonomousDatabases.go.html to see an example of how to use ListDistributedAutonomousDatabases API.
...
// # See also
//
// Click https://docs.oracle.com/en-us/iaas/tools/go-sdk-examples/latest/distributeddatabasev26/MoveDistributedAutonomousDatabaseReplicationUnit.go.html to see an example of how to use MoveDistributedAutonomousDatabaseReplicationUnit API.
...
// # See also
//
// Click https://docs.oracle.com/en-us/iaas/tools/go-sdk-examples/latest/distributeddatabasev26/PatchDistributedAutonomousDatabase.go.html to see an example of how to use PatchDistributedAutonomousDatabase API.
...
// # See also
//
// Click https://docs.oracle.com/en-us/iaas/tools/go-sdk-examples/latest/distributeddatabasev26/RecreateFailedDistributedAutonomousDatabaseResource.go.html to see an example of how to use RecreateFailedDistributedAutonomousDatabaseResource API.
...
// # See also
//
// Click https://docs.oracle.com/en-us/iaas/tools/go-sdk-examples/latest/distributeddatabasev26/RotateDistributedAutonomousDatabasePasswords.go.html to see an example of how to use RotateDistributedAutonomousDatabasePasswords API.
...
// ScaleDistributedAutonomousDatabaseGsms Scale global service manager(GSM aka shard director) instances for the Globally distributed autonomous database.
//
// # See also
//
// Click https://docs.oracle.com/en-us/iaas/tools/go-sdk-examples/latest/distributeddatabasev26/ScaleDistributedAutonomousDatabaseGsms.go.html to see an example of how to use ScaleDistributedAutonomousDatabaseGsms API.
// A default retry strategy applies to this operation ScaleDistributedAutonomousDatabaseGsms()
func (client DistributedAutonomousDbServiceClient) ScaleDistributedAutonomousDatabaseGsms(ctx context.Context, request ScaleDistributedAutonomousDatabaseGsmsRequest) (response ScaleDistributedAutonomousDatabaseGsmsResponse, err error) {
	var ociResponse common.OCIResponse
	policy := common.DefaultRetryPolicy()
	if client.RetryPolicy() != nil {
		policy = *client.RetryPolicy()
	...
	ociResponse, err = common.Retry(ctx, request, client.scaleDistributedAutonomousDatabaseGsms, policy)
	if err != nil {
		if ociResponse != nil {
			if httpResponse := ociResponse.HTTPResponse(); httpResponse != nil {
				opcRequestId := httpResponse.Header.Get("opc-request-id")
				response = ScaleDistributedAutonomousDatabaseGsmsResponse{RawResponse: httpResponse, OpcRequestId: &opcRequestId}
			} else {
				response = ScaleDistributedAutonomousDatabaseGsmsResponse{}
			}
		}
		return
	}
	if convertedResponse, ok := ociResponse.(ScaleDistributedAutonomousDatabaseGsmsResponse); ok {
		response = convertedResponse
	} else {
		err = fmt.Errorf("failed to convert OCIResponse into ScaleDistributedAutonomousDatabaseGsmsResponse")
	}
	return
}

// scaleDistributedAutonomousDatabaseGsms implements the OCIOperation interface (enables retrying operations)
func (client DistributedAutonomousDbServiceClient) scaleDistributedAutonomousDatabaseGsms(ctx context.Context, request common.OCIRequest, binaryReqBody *common.OCIReadSeekCloser, extraHeaders map[string]string) (common.OCIResponse, error) {

	httpRequest, err := request.HTTPRequest(http.MethodPost, "/distributedAutonomousDatabases/{distributedAutonomousDatabaseId}/actions/scaleGsms", binaryReqBody, extraHeaders)
	if err != nil {
		return nil, err
	}

	var response ScaleDistributedAutonomousDatabaseGsmsResponse
	var httpResponse *http.Response
	httpResponse, err = client.CallWithServiceAndOperationName(ctx, &httpRequest, "distributedAutonomousDbService", "ScaleDistributedAutonomousDatabaseGsms")
	defer common.CloseBodyIfValid(httpResponse)
	response.RawResponse = httpResponse
	if err != nil {
		...
		err = common.PostProcessServiceError(err, "DistributedAutonomousDbService", "ScaleDistributedAutonomousDatabaseGsms", apiReferenceLink)
		return response, err
	}
...
// StartDistributedAutonomousDatabase Start the shards, catalog, GSMs and GDSCTL instances of Globally distributed autonomous database.
//
// # See also
//
// Click https://docs.oracle.com/en-us/iaas/tools/go-sdk-examples/latest/distributeddatabasev26/StartDistributedAutonomousDatabase.go.html to see an example of how to use StartDistributedAutonomousDatabase API.
...
// StopDistributedAutonomousDatabase Stop the shards, catalog, GSMs and GDSCTL instances for the Globally distributed autonomous database.
//
// # See also
//
// Click https://docs.oracle.com/en-us/iaas/tools/go-sdk-examples/latest/distributeddatabasev26/StopDistributedAutonomousDatabase.go.html to see an example of how to use StopDistributedAutonomousDatabase API.
...
// # See also
//
// Click https://docs.oracle.com/en-us/iaas/tools/go-sdk-examples/latest/distributeddatabasev26/UpdateDistributedAutonomousDatabase.go.html to see an example of how to use UpdateDistributedAutonomousDatabase API.
...
// # See also
//
// Click https://docs.oracle.com/en-us/iaas/tools/go-sdk-examples/latest/distributeddatabasev26/ValidateDistributedAutonomousDatabaseCaBundle.go.html to see an example of how to use ValidateDistributedAutonomousDatabaseCaBundle API.
...
// # See also
//
// Click https://docs.oracle.com/en-us/iaas/tools/go-sdk-examples/latest/distributeddatabasev26/ValidateDistributedAutonomousDatabaseNetwork.go.html to see an example of how to use ValidateDistributedAutonomousDatabaseNetwork API.

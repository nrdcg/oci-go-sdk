...
// DistributedAutonomousDatabaseGdsControlNode Details of Global Database Services Control(GDS CTL) instances for the Globally distributed autonomous database.
type DistributedAutonomousDatabaseGdsControlNode struct {
	...
	GdsControlNodeImageDetails *DistributedAutonomousDatabaseGdsControlNodeImage `mandatory:"false" json:"gdsControlNodeImageDetails"`

	Metadata *DistributedAutonomousDbMetadata `mandatory:"false" json:"metadata"`
}

func (m DistributedAutonomousDatabaseGdsControlNode) String() string {
...
func (m DistributedAutonomousDatabaseGdsControlNode) ValidateEnumValue() (bool, error) {
	errMessage := []string{}

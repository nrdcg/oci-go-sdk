...
// CompositeDataGuardShardSpaceReplica Globally distributed database composite data guard replica details.
type CompositeDataGuardShardSpaceReplica struct {
...
func (m CompositeDataGuardShardSpaceReplica) String() string {
...
func (m CompositeDataGuardShardSpaceReplica) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
...
func (m *CompositeDataGuardShardSpaceReplica) UnmarshalJSON(data []byte) (e error) {
	model := struct {

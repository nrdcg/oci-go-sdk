...
// AutonomousSystemDataGuardReplica System data guard replica details.
type AutonomousSystemDataGuardReplica struct {
...
func (m AutonomousSystemDataGuardReplica) String() string {
...
func (m AutonomousSystemDataGuardReplica) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
...
func (m *AutonomousSystemDataGuardReplica) UnmarshalJSON(data []byte) (e error) {
	model := struct {

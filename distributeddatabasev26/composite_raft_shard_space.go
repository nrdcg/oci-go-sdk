...
// CompositeRaftShardSpace Globally distributed database composite raft shard space.
type CompositeRaftShardSpace struct {
	...
	RaftClusters []CompositeShardSpaceRaftCluster `mandatory:"true" json:"raftClusters"`
}

func (m CompositeRaftShardSpace) String() string {
...
func (m CompositeRaftShardSpace) ValidateEnumValue() (bool, error) {
	errMessage := []string{}

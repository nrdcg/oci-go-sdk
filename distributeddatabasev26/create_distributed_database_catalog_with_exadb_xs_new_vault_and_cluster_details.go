...
func (m CreateDistributedDatabaseCatalogWithExadbXsNewVaultAndClusterDetails) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeCreateDistributedDatabaseCatalogWithExadbXsNewVaultAndClusterDetails CreateDistributedDatabaseCatalogWithExadbXsNewVaultAndClusterDetails
	s := struct {

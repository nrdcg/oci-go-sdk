...
// SystemDataGuardReplica System data guard replica details.
type SystemDataGuardReplica struct {
...
func (m SystemDataGuardReplica) String() string {
...
func (m SystemDataGuardReplica) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
...
func (m *SystemDataGuardReplica) UnmarshalJSON(data []byte) (e error) {
	model := struct {

...
// CreateSystemDataGuardReplicaDetails Details required to create system data guard replica.
type CreateSystemDataGuardReplicaDetails struct {
...
func (m CreateSystemDataGuardReplicaDetails) String() string {
...
func (m CreateSystemDataGuardReplicaDetails) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
...
func (m *CreateSystemDataGuardReplicaDetails) UnmarshalJSON(data []byte) (e error) {
	model := struct {

...
// AutonomousCompositeDataGuardShardSpaceReplica Globally distributed database composite data guard replica details.
type AutonomousCompositeDataGuardShardSpaceReplica struct {
...
func (m AutonomousCompositeDataGuardShardSpaceReplica) String() string {
...
func (m AutonomousCompositeDataGuardShardSpaceReplica) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
...
func (m *AutonomousCompositeDataGuardShardSpaceReplica) UnmarshalJSON(data []byte) (e error) {
	model := struct {

...
// # See also
//
// Click https://docs.oracle.com/en-us/iaas/tools/go-sdk-examples/latest/distributeddatabasev26/PatchDistributedAutonomousDatabase.go.html to see an example of how to use PatchDistributedAutonomousDatabaseRequest.

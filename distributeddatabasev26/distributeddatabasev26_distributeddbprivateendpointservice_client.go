...
// # See also
//
// Click https://docs.oracle.com/en-us/iaas/tools/go-sdk-examples/latest/distributeddatabasev26/ChangeDistributedDatabasePrivateEndpointCompartment.go.html to see an example of how to use ChangeDistributedDatabasePrivateEndpointCompartment API.
...
// # See also
//
// Click https://docs.oracle.com/en-us/iaas/tools/go-sdk-examples/latest/distributeddatabasev26/CreateDistributedDatabasePrivateEndpoint.go.html to see an example of how to use CreateDistributedDatabasePrivateEndpoint API.
...
// # See also
//
// Click https://docs.oracle.com/en-us/iaas/tools/go-sdk-examples/latest/distributeddatabasev26/DeleteDistributedDatabasePrivateEndpoint.go.html to see an example of how to use DeleteDistributedDatabasePrivateEndpoint API.
...
// # See also
//
// Click https://docs.oracle.com/en-us/iaas/tools/go-sdk-examples/latest/distributeddatabasev26/GetDistributedDatabasePrivateEndpoint.go.html to see an example of how to use GetDistributedDatabasePrivateEndpoint API.
...
// # See also
//
// Click https://docs.oracle.com/en-us/iaas/tools/go-sdk-examples/latest/distributeddatabasev26/ListDistributedDatabasePrivateEndpoints.go.html to see an example of how to use ListDistributedDatabasePrivateEndpoints API.
...
// # See also
//
// Click https://docs.oracle.com/en-us/iaas/tools/go-sdk-examples/latest/distributeddatabasev26/PatchDistributedDatabasePrivateEndpoint.go.html to see an example of how to use PatchDistributedDatabasePrivateEndpoint API.
...
// # See also
//
// Click https://docs.oracle.com/en-us/iaas/tools/go-sdk-examples/latest/distributeddatabasev26/ReinstateProxyInstance.go.html to see an example of how to use ReinstateProxyInstance API.
...
// # See also
//
// Click https://docs.oracle.com/en-us/iaas/tools/go-sdk-examples/latest/distributeddatabasev26/UpdateDistributedDatabasePrivateEndpoint.go.html to see an example of how to use UpdateDistributedDatabasePrivateEndpoint API.

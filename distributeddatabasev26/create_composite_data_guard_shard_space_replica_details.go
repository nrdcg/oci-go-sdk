...
// CreateCompositeDataGuardShardSpaceReplicaDetails Globally distributed database composite data guard shard space replica creation details.
type CreateCompositeDataGuardShardSpaceReplicaDetails struct {
...
func (m CreateCompositeDataGuardShardSpaceReplicaDetails) String() string {
...
func (m CreateCompositeDataGuardShardSpaceReplicaDetails) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
...
func (m *CreateCompositeDataGuardShardSpaceReplicaDetails) UnmarshalJSON(data []byte) (e error) {
	model := struct {

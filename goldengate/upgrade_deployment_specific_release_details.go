...
func (m UpgradeDeploymentSpecificReleaseDetails) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeUpgradeDeploymentSpecificReleaseDetails UpgradeDeploymentSpecificReleaseDetails
	s := struct {
		DiscriminatorParam string `json:"type"`
		MarshalTypeUpgradeDeploymentSpecificReleaseDetails
	}{
		"SPECIFIC_RELEASE",
		(MarshalTypeUpgradeDeploymentSpecificReleaseDetails)(m),
	}

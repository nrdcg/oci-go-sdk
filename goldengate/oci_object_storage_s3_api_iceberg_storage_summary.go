...
// OciObjectStorageS3ApiIcebergStorageSummary Summary of the OCI Object Storage (S3 Compatibility API) configuration used by the
// Iceberg connection.
type OciObjectStorageS3ApiIcebergStorageSummary struct {
...
func (m OciObjectStorageS3ApiIcebergStorageSummary) String() string {
...
func (m OciObjectStorageS3ApiIcebergStorageSummary) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
...
func (m OciObjectStorageS3ApiIcebergStorageSummary) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeOciObjectStorageS3ApiIcebergStorageSummary OciObjectStorageS3ApiIcebergStorageSummary
	s := struct {
		DiscriminatorParam string `json:"storageType"`
		MarshalTypeOciObjectStorageS3ApiIcebergStorageSummary
	}{
		"OCI_OBJECT_STORAGE_S3_API",
		(MarshalTypeOciObjectStorageS3ApiIcebergStorageSummary)(m),
	}

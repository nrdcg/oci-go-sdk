...
func (m ElasticsearchConnectionSummary) GetSubscriptionId() *string {
	return m.SubscriptionId
}

// GetClusterPlacementGroupId returns ClusterPlacementGroupId
func (m ElasticsearchConnectionSummary) GetClusterPlacementGroupId() *string {
	return m.ClusterPlacementGroupId
}

// GetSecurityAttributes returns SecurityAttributes
func (m ElasticsearchConnectionSummary) GetSecurityAttributes() map[string]map[string]interface{} {

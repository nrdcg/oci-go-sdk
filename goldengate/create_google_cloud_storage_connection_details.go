...
func (m CreateGoogleCloudStorageConnectionDetails) GetClusterPlacementGroupId() *string {
	return m.ClusterPlacementGroupId
}

// GetSecurityAttributes returns SecurityAttributes
func (m CreateGoogleCloudStorageConnectionDetails) GetSecurityAttributes() map[string]map[string]interface{} {

...
type GooglePubSubConnectionSummary struct {
...
func (m GooglePubSubConnectionSummary) GetClusterPlacementGroupId() *string {
	return m.ClusterPlacementGroupId
}

// GetSecurityAttributes returns SecurityAttributes
func (m GooglePubSubConnectionSummary) GetSecurityAttributes() map[string]map[string]interface{} {
...
func (m GooglePubSubConnectionSummary) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeGooglePubSubConnectionSummary GooglePubSubConnectionSummary
	s := struct {
		DiscriminatorParam string `json:"connectionType"`
		MarshalTypeGooglePubSubConnectionSummary
	}{
		"GOOGLE_PUBSUB",
		(MarshalTypeGooglePubSubConnectionSummary)(m),
	}

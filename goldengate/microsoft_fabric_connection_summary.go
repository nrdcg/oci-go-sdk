...
func (m MicrosoftFabricConnectionSummary) GetSubscriptionId() *string {
	return m.SubscriptionId
}

// GetClusterPlacementGroupId returns ClusterPlacementGroupId
func (m MicrosoftFabricConnectionSummary) GetClusterPlacementGroupId() *string {
	return m.ClusterPlacementGroupId
}

// GetSecurityAttributes returns SecurityAttributes
func (m MicrosoftFabricConnectionSummary) GetSecurityAttributes() map[string]map[string]interface{} {

...
// CreatePolarisIcebergCatalogDetails The information about a new Polaris catalog used in the Iceberg connection.
type CreatePolarisIcebergCatalogDetails struct {
...
func (m CreatePolarisIcebergCatalogDetails) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
...
func (m CreatePolarisIcebergCatalogDetails) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeCreatePolarisIcebergCatalogDetails CreatePolarisIcebergCatalogDetails
	s := struct {
		DiscriminatorParam string `json:"catalogType"`
		MarshalTypeCreatePolarisIcebergCatalogDetails
	}{
		"POLARIS",
		(MarshalTypeCreatePolarisIcebergCatalogDetails)(m),
	}

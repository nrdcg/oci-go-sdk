...
func (m OciObjectStorageConnectionSummary) GetSubscriptionId() *string {
	return m.SubscriptionId
}

// GetClusterPlacementGroupId returns ClusterPlacementGroupId
func (m OciObjectStorageConnectionSummary) GetClusterPlacementGroupId() *string {
	return m.ClusterPlacementGroupId
}

// GetSecurityAttributes returns SecurityAttributes
func (m OciObjectStorageConnectionSummary) GetSecurityAttributes() map[string]map[string]interface{} {

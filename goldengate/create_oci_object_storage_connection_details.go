...
func (m CreateOciObjectStorageConnectionDetails) GetSubscriptionId() *string {
	return m.SubscriptionId
}

// GetClusterPlacementGroupId returns ClusterPlacementGroupId
func (m CreateOciObjectStorageConnectionDetails) GetClusterPlacementGroupId() *string {
	return m.ClusterPlacementGroupId
}

// GetSecurityAttributes returns SecurityAttributes
func (m CreateOciObjectStorageConnectionDetails) GetSecurityAttributes() map[string]map[string]interface{} {

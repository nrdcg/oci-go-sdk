...
func (m GoogleCloudStorageConnection) GetSubscriptionId() *string {
	return m.SubscriptionId
}

// GetClusterPlacementGroupId returns ClusterPlacementGroupId
func (m GoogleCloudStorageConnection) GetClusterPlacementGroupId() *string {
	return m.ClusterPlacementGroupId
}

// GetSecurityAttributes returns SecurityAttributes
func (m GoogleCloudStorageConnection) GetSecurityAttributes() map[string]map[string]interface{} {

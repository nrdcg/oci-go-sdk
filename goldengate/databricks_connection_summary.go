...
type DatabricksConnectionSummary struct {
...
func (m DatabricksConnectionSummary) GetClusterPlacementGroupId() *string {
	return m.ClusterPlacementGroupId
}

// GetSecurityAttributes returns SecurityAttributes
func (m DatabricksConnectionSummary) GetSecurityAttributes() map[string]map[string]interface{} {
...
func (m DatabricksConnectionSummary) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeDatabricksConnectionSummary DatabricksConnectionSummary
	s := struct {
		DiscriminatorParam string `json:"connectionType"`
		MarshalTypeDatabricksConnectionSummary
	}{
		"DATABRICKS",
		(MarshalTypeDatabricksConnectionSummary)(m),
	}

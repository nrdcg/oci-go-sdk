...
func (m AmazonS3ConnectionSummary) GetSubscriptionId() *string {
	return m.SubscriptionId
}

// GetClusterPlacementGroupId returns ClusterPlacementGroupId
func (m AmazonS3ConnectionSummary) GetClusterPlacementGroupId() *string {
	return m.ClusterPlacementGroupId
}

// GetSecurityAttributes returns SecurityAttributes
func (m AmazonS3ConnectionSummary) GetSecurityAttributes() map[string]map[string]interface{} {
...
func (m AmazonS3ConnectionSummary) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeAmazonS3ConnectionSummary AmazonS3ConnectionSummary
	s := struct {
		DiscriminatorParam string `json:"connectionType"`
		MarshalTypeAmazonS3ConnectionSummary
	}{
		"AMAZON_S3",
		(MarshalTypeAmazonS3ConnectionSummary)(m),
	}

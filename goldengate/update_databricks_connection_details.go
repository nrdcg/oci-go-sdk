...
type UpdateDatabricksConnectionDetails struct {
	...
	AuthenticationType DatabricksConnectionAuthenticationTypeEnum `mandatory:"false" json:"authenticationType,omitempty"`
}
...
func (m UpdateDatabricksConnectionDetails) GetSecurityAttributes() map[string]map[string]interface{} {
...
func (m UpdateDatabricksConnectionDetails) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeUpdateDatabricksConnectionDetails UpdateDatabricksConnectionDetails
	s := struct {
		DiscriminatorParam string `json:"connectionType"`
		MarshalTypeUpdateDatabricksConnectionDetails
	}{
		"DATABRICKS",
		(MarshalTypeUpdateDatabricksConnectionDetails)(m),
	}

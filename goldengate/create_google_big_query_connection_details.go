...
func (m CreateGoogleBigQueryConnectionDetails) GetSubscriptionId() *string {
	return m.SubscriptionId
}

// GetClusterPlacementGroupId returns ClusterPlacementGroupId
func (m CreateGoogleBigQueryConnectionDetails) GetClusterPlacementGroupId() *string {
	return m.ClusterPlacementGroupId
}

// GetSecurityAttributes returns SecurityAttributes
func (m CreateGoogleBigQueryConnectionDetails) GetSecurityAttributes() map[string]map[string]interface{} {

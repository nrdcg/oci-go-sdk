...
func (m UpdateHdfsConnectionDetails) GetSecurityAttributes() map[string]map[string]interface{} {
...
func (m UpdateHdfsConnectionDetails) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeUpdateHdfsConnectionDetails UpdateHdfsConnectionDetails
	s := struct {
		DiscriminatorParam string `json:"connectionType"`
		MarshalTypeUpdateHdfsConnectionDetails
	}{
		"HDFS",
		(MarshalTypeUpdateHdfsConnectionDetails)(m),
	}

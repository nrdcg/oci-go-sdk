...
func (m ElasticsearchConnection) GetSubscriptionId() *string {
	return m.SubscriptionId
}

// GetClusterPlacementGroupId returns ClusterPlacementGroupId
func (m ElasticsearchConnection) GetClusterPlacementGroupId() *string {
	return m.ClusterPlacementGroupId
}

// GetSecurityAttributes returns SecurityAttributes
func (m ElasticsearchConnection) GetSecurityAttributes() map[string]map[string]interface{} {

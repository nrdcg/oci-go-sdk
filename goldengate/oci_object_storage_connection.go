...
func (m OciObjectStorageConnection) GetSubscriptionId() *string {
	return m.SubscriptionId
}

// GetClusterPlacementGroupId returns ClusterPlacementGroupId
func (m OciObjectStorageConnection) GetClusterPlacementGroupId() *string {
	return m.ClusterPlacementGroupId
}

// GetSecurityAttributes returns SecurityAttributes
func (m OciObjectStorageConnection) GetSecurityAttributes() map[string]map[string]interface{} {

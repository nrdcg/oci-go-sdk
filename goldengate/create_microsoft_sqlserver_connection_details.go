...
func (m CreateMicrosoftSqlserverConnectionDetails) GetClusterPlacementGroupId() *string {
	return m.ClusterPlacementGroupId
}

// GetSecurityAttributes returns SecurityAttributes
func (m CreateMicrosoftSqlserverConnectionDetails) GetSecurityAttributes() map[string]map[string]interface{} {

...
func (m AmazonKinesisConnectionSummary) GetSubscriptionId() *string {
	return m.SubscriptionId
}

// GetClusterPlacementGroupId returns ClusterPlacementGroupId
func (m AmazonKinesisConnectionSummary) GetClusterPlacementGroupId() *string {
	return m.ClusterPlacementGroupId
}

// GetSecurityAttributes returns SecurityAttributes
func (m AmazonKinesisConnectionSummary) GetSecurityAttributes() map[string]map[string]interface{} {
...
func (m AmazonKinesisConnectionSummary) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeAmazonKinesisConnectionSummary AmazonKinesisConnectionSummary
	s := struct {
		DiscriminatorParam string `json:"connectionType"`
		MarshalTypeAmazonKinesisConnectionSummary
	}{
		"AMAZON_KINESIS",
		(MarshalTypeAmazonKinesisConnectionSummary)(m),
	}

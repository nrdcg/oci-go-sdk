...
func (m MicrosoftSqlserverConnection) GetClusterPlacementGroupId() *string {
	return m.ClusterPlacementGroupId
}

// GetSecurityAttributes returns SecurityAttributes
func (m MicrosoftSqlserverConnection) GetSecurityAttributes() map[string]map[string]interface{} {

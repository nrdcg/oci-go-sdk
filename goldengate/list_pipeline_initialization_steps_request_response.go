...
type ListPipelineInitializationStepsRequest struct {
...
type ListPipelineInitializationStepsResponse struct {

	// The underlying http response
	RawResponse *http.Response

	// The PipelineInitializationSteps instance
	PipelineInitializationSteps `presentIn:"body"`

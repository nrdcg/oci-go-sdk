...
// ApiKeyAiModelAuthDetails API key authentication details for an AI Model connection.
type ApiKeyAiModelAuthDetails struct {
...
func (m ApiKeyAiModelAuthDetails) String() string {
...
func (m ApiKeyAiModelAuthDetails) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
...
func (m ApiKeyAiModelAuthDetails) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeApiKeyAiModelAuthDetails ApiKeyAiModelAuthDetails
	s := struct {
		DiscriminatorParam string `json:"authType"`
		MarshalTypeApiKeyAiModelAuthDetails
	}{
		"API_KEY",
		(MarshalTypeApiKeyAiModelAuthDetails)(m),
	}

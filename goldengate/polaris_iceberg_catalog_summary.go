...
// PolarisIcebergCatalogSummary Summary of the Polaris catalog used in the Iceberg connection.
type PolarisIcebergCatalogSummary struct {
...
func (m PolarisIcebergCatalogSummary) String() string {
...
func (m PolarisIcebergCatalogSummary) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
...
func (m PolarisIcebergCatalogSummary) MarshalJSON() (buff []byte, e error) {
	type MarshalTypePolarisIcebergCatalogSummary PolarisIcebergCatalogSummary
	s := struct {
		DiscriminatorParam string `json:"catalogType"`
		MarshalTypePolarisIcebergCatalogSummary
	}{
		"POLARIS",
		(MarshalTypePolarisIcebergCatalogSummary)(m),
	}

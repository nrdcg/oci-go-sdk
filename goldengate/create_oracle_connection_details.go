...
func (m CreateOracleConnectionDetails) GetClusterPlacementGroupId() *string {
	return m.ClusterPlacementGroupId
}

// GetSecurityAttributes returns SecurityAttributes
func (m CreateOracleConnectionDetails) GetSecurityAttributes() map[string]map[string]interface{} {

...
func (m KafkaSchemaRegistryConnection) GetClusterPlacementGroupId() *string {
	return m.ClusterPlacementGroupId
}

// GetSecurityAttributes returns SecurityAttributes
func (m KafkaSchemaRegistryConnection) GetSecurityAttributes() map[string]map[string]interface{} {

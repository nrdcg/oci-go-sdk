...
func (m CreateJavaMessageServiceConnectionDetails) GetClusterPlacementGroupId() *string {
	return m.ClusterPlacementGroupId
}

// GetSecurityAttributes returns SecurityAttributes
func (m CreateJavaMessageServiceConnectionDetails) GetSecurityAttributes() map[string]map[string]interface{} {

...
// CreateOciObjectStorageS3ApiIcebergStorageDetails The information to create the OCI Object Storage (S3 Compatibility API) configuration used by the
// Iceberg connection.
type CreateOciObjectStorageS3ApiIcebergStorageDetails struct {
...
func (m CreateOciObjectStorageS3ApiIcebergStorageDetails) String() string {
...
func (m CreateOciObjectStorageS3ApiIcebergStorageDetails) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
...
func (m CreateOciObjectStorageS3ApiIcebergStorageDetails) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeCreateOciObjectStorageS3ApiIcebergStorageDetails CreateOciObjectStorageS3ApiIcebergStorageDetails
	s := struct {
		DiscriminatorParam string `json:"storageType"`
		MarshalTypeCreateOciObjectStorageS3ApiIcebergStorageDetails
	}{
		"OCI_OBJECT_STORAGE_S3_API",
		(MarshalTypeCreateOciObjectStorageS3ApiIcebergStorageDetails)(m),
	}

...
func (m OracleNosqlConnectionSummary) GetSubscriptionId() *string {
	return m.SubscriptionId
}

// GetClusterPlacementGroupId returns ClusterPlacementGroupId
func (m OracleNosqlConnectionSummary) GetClusterPlacementGroupId() *string {
	return m.ClusterPlacementGroupId
}

// GetSecurityAttributes returns SecurityAttributes
func (m OracleNosqlConnectionSummary) GetSecurityAttributes() map[string]map[string]interface{} {
...
func (m OracleNosqlConnectionSummary) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeOracleNosqlConnectionSummary OracleNosqlConnectionSummary
	s := struct {
		DiscriminatorParam string `json:"connectionType"`
		MarshalTypeOracleNosqlConnectionSummary
	}{
		"ORACLE_NOSQL",
		(MarshalTypeOracleNosqlConnectionSummary)(m),
	}

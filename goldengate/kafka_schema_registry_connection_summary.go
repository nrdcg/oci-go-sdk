...
func (m KafkaSchemaRegistryConnectionSummary) GetSubscriptionId() *string {
	return m.SubscriptionId
}

// GetClusterPlacementGroupId returns ClusterPlacementGroupId
func (m KafkaSchemaRegistryConnectionSummary) GetClusterPlacementGroupId() *string {
	return m.ClusterPlacementGroupId
}

// GetSecurityAttributes returns SecurityAttributes
func (m KafkaSchemaRegistryConnectionSummary) GetSecurityAttributes() map[string]map[string]interface{} {

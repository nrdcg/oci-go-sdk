...
func (m GoogleBigQueryConnectionSummary) GetSubscriptionId() *string {
	return m.SubscriptionId
}

// GetClusterPlacementGroupId returns ClusterPlacementGroupId
func (m GoogleBigQueryConnectionSummary) GetClusterPlacementGroupId() *string {
	return m.ClusterPlacementGroupId
}

// GetSecurityAttributes returns SecurityAttributes
func (m GoogleBigQueryConnectionSummary) GetSecurityAttributes() map[string]map[string]interface{} {

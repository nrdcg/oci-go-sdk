...
func (m RedisConnectionSummary) GetSubscriptionId() *string {
	return m.SubscriptionId
}

// GetClusterPlacementGroupId returns ClusterPlacementGroupId
func (m RedisConnectionSummary) GetClusterPlacementGroupId() *string {
	return m.ClusterPlacementGroupId
}

// GetSecurityAttributes returns SecurityAttributes
func (m RedisConnectionSummary) GetSecurityAttributes() map[string]map[string]interface{} {
...
func (m RedisConnectionSummary) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeRedisConnectionSummary RedisConnectionSummary
	s := struct {
		DiscriminatorParam string `json:"connectionType"`
		MarshalTypeRedisConnectionSummary
	}{
		"REDIS",
		(MarshalTypeRedisConnectionSummary)(m),
	}

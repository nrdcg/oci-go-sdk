...
func (m DefaultCancelDeploymentUpgradeDetails) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeDefaultCancelDeploymentUpgradeDetails DefaultCancelDeploymentUpgradeDetails
	s := struct {
		DiscriminatorParam string `json:"type"`
		MarshalTypeDefaultCancelDeploymentUpgradeDetails
	}{
		"DEFAULT",
		(MarshalTypeDefaultCancelDeploymentUpgradeDetails)(m),
	}

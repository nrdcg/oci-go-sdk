...
// GoogleCloudStorageIcebergStorage Represents a Google Cloud Storage storage used in the Iceberg connection.
...
func (m GoogleCloudStorageIcebergStorage) String() string {
...
func (m GoogleCloudStorageIcebergStorage) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
...
func (m GoogleCloudStorageIcebergStorage) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeGoogleCloudStorageIcebergStorage GoogleCloudStorageIcebergStorage
	s := struct {
		DiscriminatorParam string `json:"storageType"`
		MarshalTypeGoogleCloudStorageIcebergStorage
	}{
		"GOOGLE_CLOUD_STORAGE",
		(MarshalTypeGoogleCloudStorageIcebergStorage)(m),
	}

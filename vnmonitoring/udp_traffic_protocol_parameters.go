...
func (m UdpTrafficProtocolParameters) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeUdpTrafficProtocolParameters UdpTrafficProtocolParameters
	s := struct {
		DiscriminatorParam string `json:"type"`
		MarshalTypeUdpTrafficProtocolParameters
	}{
		"UDP",
		(MarshalTypeUdpTrafficProtocolParameters)(m),
	}

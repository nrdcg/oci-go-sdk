...
func (m NetworkLoadBalancerListenerEndpoint) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeNetworkLoadBalancerListenerEndpoint NetworkLoadBalancerListenerEndpoint
	s := struct {
		DiscriminatorParam string `json:"type"`
		MarshalTypeNetworkLoadBalancerListenerEndpoint
	}{
		"NETWORK_LOAD_BALANCER_LISTENER",
		(MarshalTypeNetworkLoadBalancerListenerEndpoint)(m),
	}

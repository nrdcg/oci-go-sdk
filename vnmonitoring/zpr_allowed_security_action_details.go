...
// ZprAllowedSecurityActionDetails Defines details for the security action taken on zpr allowed traffic.
type ZprAllowedSecurityActionDetails struct {
...
func (m ZprAllowedSecurityActionDetails) String() string {
...
func (m ZprAllowedSecurityActionDetails) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
...
func (m *ZprAllowedSecurityActionDetails) UnmarshalJSON(data []byte) (e error) {
	model := struct {

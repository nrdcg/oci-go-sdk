...
func (m ClassificationMultiClassModeDetails) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeClassificationMultiClassModeDetails ClassificationMultiClassModeDetails
	s := struct {
		DiscriminatorParam string `json:"classificationMode"`
		MarshalTypeClassificationMultiClassModeDetails
	}{
		"MULTI_CLASS",
		(MarshalTypeClassificationMultiClassModeDetails)(m),
	}

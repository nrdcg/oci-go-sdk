...
func (m PreTrainedHealthNluModelDetails) MarshalJSON() (buff []byte, e error) {
	type MarshalTypePreTrainedHealthNluModelDetails PreTrainedHealthNluModelDetails
	s := struct {
		DiscriminatorParam string `json:"modelType"`
		MarshalTypePreTrainedHealthNluModelDetails
	}{
		"PRE_TRAINED_HEALTH_NLU",
		(MarshalTypePreTrainedHealthNluModelDetails)(m),
	}

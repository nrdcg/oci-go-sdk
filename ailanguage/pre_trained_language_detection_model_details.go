...
func (m PreTrainedLanguageDetectionModelDetails) MarshalJSON() (buff []byte, e error) {
	type MarshalTypePreTrainedLanguageDetectionModelDetails PreTrainedLanguageDetectionModelDetails
	s := struct {
		DiscriminatorParam string `json:"modelType"`
		MarshalTypePreTrainedLanguageDetectionModelDetails
	}{
		"PRE_TRAINED_LANGUAGE_DETECTION",
		(MarshalTypePreTrainedLanguageDetectionModelDetails)(m),
	}

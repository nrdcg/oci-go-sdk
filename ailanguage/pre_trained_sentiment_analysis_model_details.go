...
func (m PreTrainedSentimentAnalysisModelDetails) MarshalJSON() (buff []byte, e error) {
	type MarshalTypePreTrainedSentimentAnalysisModelDetails PreTrainedSentimentAnalysisModelDetails
	s := struct {
		DiscriminatorParam string `json:"modelType"`
		MarshalTypePreTrainedSentimentAnalysisModelDetails
	}{
		"PRE_TRAINED_SENTIMENT_ANALYSIS",
		(MarshalTypePreTrainedSentimentAnalysisModelDetails)(m),
	}

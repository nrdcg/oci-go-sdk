...
func (m VirtualServiceTrafficRuleTarget) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeVirtualServiceTrafficRuleTarget VirtualServiceTrafficRuleTarget
	s := struct {
		DiscriminatorParam string `json:"type"`
		MarshalTypeVirtualServiceTrafficRuleTarget
	}{
		"VIRTUAL_SERVICE",
		(MarshalTypeVirtualServiceTrafficRuleTarget)(m),
	}

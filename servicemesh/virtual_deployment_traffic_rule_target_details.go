...
func (m VirtualDeploymentTrafficRuleTargetDetails) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeVirtualDeploymentTrafficRuleTargetDetails VirtualDeploymentTrafficRuleTargetDetails
	s := struct {
		DiscriminatorParam string `json:"type"`
		MarshalTypeVirtualDeploymentTrafficRuleTargetDetails
	}{
		"VIRTUAL_DEPLOYMENT",
		(MarshalTypeVirtualDeploymentTrafficRuleTargetDetails)(m),
	}

...
func (m TcpVirtualServiceTrafficRouteRule) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeTcpVirtualServiceTrafficRouteRule TcpVirtualServiceTrafficRouteRule
	s := struct {
		DiscriminatorParam string `json:"type"`
		MarshalTypeTcpVirtualServiceTrafficRouteRule
	}{
		"TCP",
		(MarshalTypeTcpVirtualServiceTrafficRouteRule)(m),
	}

...
func (m RealtimeMessageSendFinalResult) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeRealtimeMessageSendFinalResult RealtimeMessageSendFinalResult
	s := struct {
		DiscriminatorParam string `json:"event"`
		MarshalTypeRealtimeMessageSendFinalResult
	}{
		"SEND_FINAL_RESULT",
		(MarshalTypeRealtimeMessageSendFinalResult)(m),
	}

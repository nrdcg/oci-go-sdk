...
func (m RealtimeMessageAuthenticationToken) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeRealtimeMessageAuthenticationToken RealtimeMessageAuthenticationToken
	s := struct {
		DiscriminatorParam string `json:"authenticationType"`
		MarshalTypeRealtimeMessageAuthenticationToken
	}{
		"TOKEN",
		(MarshalTypeRealtimeMessageAuthenticationToken)(m),
	}

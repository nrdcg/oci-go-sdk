...
func (request ListTranscriptionJobsRequest) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
	if _, ok := GetMappingTranscriptionJobLifecycleStateEnum(string(request.LifecycleState)); !ok && request.LifecycleState != "" {
		errMessage = append(errMessage, fmt.Sprintf("unsupported enum value for LifecycleState: %s. Supported values are: %s.", request.LifecycleState, strings.Join(GetTranscriptionJobLifecycleStateEnumStringValues(), ",")))
	}
	if _, ok := GetMappingListTranscriptionJobsSortOrderEnum(string(request.SortOrder)); !ok && request.SortOrder != "" {
		errMessage = append(errMessage, fmt.Sprintf("unsupported enum value for SortOrder: %s. Supported values are: %s.", request.SortOrder, strings.Join(GetListTranscriptionJobsSortOrderEnumStringValues(), ",")))
	}
	if _, ok := GetMappingListTranscriptionJobsSortByEnum(string(request.SortBy)); !ok && request.SortBy != "" {
		errMessage = append(errMessage, fmt.Sprintf("unsupported enum value for SortBy: %s. Supported values are: %s.", request.SortBy, strings.Join(GetListTranscriptionJobsSortByEnumStringValues(), ",")))
	}
	if len(errMessage) > 0 {
...
var mappingListTranscriptionJobsSortOrderEnum = map[string]ListTranscriptionJobsSortOrderEnum{
	"ASC":  ListTranscriptionJobsSortOrderAsc,
	"DESC": ListTranscriptionJobsSortOrderDesc,
}

var mappingListTranscriptionJobsSortOrderEnumLowerCase = map[string]ListTranscriptionJobsSortOrderEnum{
	"asc":  ListTranscriptionJobsSortOrderAsc,
	"desc": ListTranscriptionJobsSortOrderDesc,
}
...
func GetListTranscriptionJobsSortOrderEnumValues() []ListTranscriptionJobsSortOrderEnum {
	values := make([]ListTranscriptionJobsSortOrderEnum, 0)
	for _, v := range mappingListTranscriptionJobsSortOrderEnum {
...
func GetMappingListTranscriptionJobsSortOrderEnum(val string) (ListTranscriptionJobsSortOrderEnum, bool) {
	enum, ok := mappingListTranscriptionJobsSortOrderEnumLowerCase[strings.ToLower(val)]
	return enum, ok
}
...
var mappingListTranscriptionJobsSortByEnum = map[string]ListTranscriptionJobsSortByEnum{
	"timeCreated": ListTranscriptionJobsSortByTimecreated,
	"displayName": ListTranscriptionJobsSortByDisplayname,
}

var mappingListTranscriptionJobsSortByEnumLowerCase = map[string]ListTranscriptionJobsSortByEnum{
	"timecreated": ListTranscriptionJobsSortByTimecreated,
	"displayname": ListTranscriptionJobsSortByDisplayname,
}
...
func GetListTranscriptionJobsSortByEnumValues() []ListTranscriptionJobsSortByEnum {
	values := make([]ListTranscriptionJobsSortByEnum, 0)
	for _, v := range mappingListTranscriptionJobsSortByEnum {
		values = append(values, v)
	}
	return values
}
...
func GetMappingListTranscriptionJobsSortByEnum(val string) (ListTranscriptionJobsSortByEnum, bool) {
	enum, ok := mappingListTranscriptionJobsSortByEnumLowerCase[strings.ToLower(val)]
	return enum, ok
}

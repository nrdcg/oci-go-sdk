...
// # See also
//
// Click https://docs.oracle.com/en-us/iaas/tools/go-sdk-examples/latest/emwarehouse/ListEmWarehouses.go.html to see an example of how to use ListEmWarehousesRequest.
...
func (request ListEmWarehousesRequest) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
	if _, ok := GetMappingEmWarehouseLifecycleStateEnum(string(request.LifecycleState)); !ok && request.LifecycleState != "" {
		errMessage = append(errMessage, fmt.Sprintf("unsupported enum value for LifecycleState: %s. Supported values are: %s.", request.LifecycleState, strings.Join(GetEmWarehouseLifecycleStateEnumStringValues(), ",")))
	}
	if _, ok := GetMappingListEmWarehousesSortOrderEnum(string(request.SortOrder)); !ok && request.SortOrder != "" {
		errMessage = append(errMessage, fmt.Sprintf("unsupported enum value for SortOrder: %s. Supported values are: %s.", request.SortOrder, strings.Join(GetListEmWarehousesSortOrderEnumStringValues(), ",")))
	}
	if _, ok := GetMappingListEmWarehousesSortByEnum(string(request.SortBy)); !ok && request.SortBy != "" {
		errMessage = append(errMessage, fmt.Sprintf("unsupported enum value for SortBy: %s. Supported values are: %s.", request.SortBy, strings.Join(GetListEmWarehousesSortByEnumStringValues(), ",")))
	}
	if len(errMessage) > 0 {
...
var mappingListEmWarehousesSortOrderEnum = map[string]ListEmWarehousesSortOrderEnum{
	"ASC":  ListEmWarehousesSortOrderAsc,
	"DESC": ListEmWarehousesSortOrderDesc,
}

var mappingListEmWarehousesSortOrderEnumLowerCase = map[string]ListEmWarehousesSortOrderEnum{
	"asc":  ListEmWarehousesSortOrderAsc,
	"desc": ListEmWarehousesSortOrderDesc,
}
...
func GetListEmWarehousesSortOrderEnumValues() []ListEmWarehousesSortOrderEnum {
	values := make([]ListEmWarehousesSortOrderEnum, 0)
	for _, v := range mappingListEmWarehousesSortOrderEnum {
...
func GetMappingListEmWarehousesSortOrderEnum(val string) (ListEmWarehousesSortOrderEnum, bool) {
	enum, ok := mappingListEmWarehousesSortOrderEnumLowerCase[strings.ToLower(val)]
	return enum, ok
}
...
var mappingListEmWarehousesSortByEnum = map[string]ListEmWarehousesSortByEnum{
	"timeCreated": ListEmWarehousesSortByTimecreated,
	"displayName": ListEmWarehousesSortByDisplayname,
}

var mappingListEmWarehousesSortByEnumLowerCase = map[string]ListEmWarehousesSortByEnum{
	"timecreated": ListEmWarehousesSortByTimecreated,
	"displayname": ListEmWarehousesSortByDisplayname,
}
...
func GetListEmWarehousesSortByEnumValues() []ListEmWarehousesSortByEnum {
	values := make([]ListEmWarehousesSortByEnum, 0)
	for _, v := range mappingListEmWarehousesSortByEnum {
		values = append(values, v)
	}
	return values
}
...
func GetMappingListEmWarehousesSortByEnum(val string) (ListEmWarehousesSortByEnum, bool) {
	enum, ok := mappingListEmWarehousesSortByEnumLowerCase[strings.ToLower(val)]
	return enum, ok
}

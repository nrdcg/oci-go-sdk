...
// # See also
//
// Click https://docs.oracle.com/en-us/iaas/tools/go-sdk-examples/latest/self/ListPartners.go.html to see an example of how to use ListPartners API.
...
// # See also
//
// Click https://docs.oracle.com/en-us/iaas/tools/go-sdk-examples/latest/self/SubmitSubscriptionUsageBatch.go.html to see an example of how to use SubmitSubscriptionUsageBatch API.
...
// # See also
//
// Click https://docs.oracle.com/en-us/iaas/tools/go-sdk-examples/latest/self/SubmitSubscriptionUsageRecords.go.html to see an example of how to use SubmitSubscriptionUsageRecords API.

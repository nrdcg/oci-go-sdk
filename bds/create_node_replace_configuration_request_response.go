...
type CreateNodeReplaceConfigurationRequest struct {
	...
	CreateNodeReplaceConfigurationDetails `contributesTo:"body"`
...
type CreateNodeReplaceConfigurationResponse struct {

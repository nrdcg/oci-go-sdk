...
// # See also
//
// Click https://docs.oracle.com/en-us/iaas/tools/go-sdk-examples/latest/bds/ListBdsCapacityReservationConfigurations.go.html to see an example of how to use ListBdsCapacityReservationConfigurationsRequest.

...
type RefreshConfidentialApplicationRequest struct {
	...
	RefreshConfidentialApplicationDetails `contributesTo:"body"`
...
type RefreshConfidentialApplicationResponse struct {

...
type CreateNodeBackupConfigurationRequest struct {
	...
	CreateNodeBackupConfigurationDetails `contributesTo:"body"`
...
type CreateNodeBackupConfigurationResponse struct {

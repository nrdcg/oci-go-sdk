...
// GenerateBdsCertificateDetails Request body for generating certificates.
type GenerateBdsCertificateDetails struct {
...
func (m GenerateBdsCertificateDetails) String() string {
...
func (m GenerateBdsCertificateDetails) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
...
func (m *GenerateBdsCertificateDetails) UnmarshalJSON(data []byte) (e error) {
	model := struct {

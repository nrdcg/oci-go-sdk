...
type GetNodeBackupRequest struct {
	...
	NodeBackupId *string `mandatory:"true" contributesTo:"path" name:"nodeBackupId"`
...
type GetNodeBackupResponse struct {

	// The underlying http response
	RawResponse *http.Response

	// The NodeBackup instance
	NodeBackup `presentIn:"body"`

...
type RemoveResourcePrincipalConfigurationRequest struct {
	...
	RemoveResourcePrincipalConfigurationDetails `contributesTo:"body"`
...
type RemoveResourcePrincipalConfigurationResponse struct {

...
type UpdateNodeBackupConfigurationRequest struct {
	...
	UpdateNodeBackupConfigurationDetails `contributesTo:"body"`
...
type UpdateNodeBackupConfigurationResponse struct {

...
type ActivateIamUserSyncConfigurationRequest struct {
	...
	ActivateIamUserSyncConfigurationDetails `contributesTo:"body"`
...
type ActivateIamUserSyncConfigurationResponse struct {

...
type GetResourcePrincipalConfigurationRequest struct {
...
type GetResourcePrincipalConfigurationResponse struct {

	// The underlying http response
	RawResponse *http.Response

	// The ResourcePrincipalConfiguration instance
	ResourcePrincipalConfiguration `presentIn:"body"`

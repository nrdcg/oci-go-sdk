...
type DeactivateIamUserSyncConfigurationRequest struct {
	...
	DeactivateIamUserSyncConfigurationDetails `contributesTo:"body"`
...
type DeactivateIamUserSyncConfigurationResponse struct {

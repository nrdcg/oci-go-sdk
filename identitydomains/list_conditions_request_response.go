...
func (request ListConditionsRequest) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
	if _, ok := GetMappingListConditionsSortOrderEnum(string(request.SortOrder)); !ok && request.SortOrder != "" {
		errMessage = append(errMessage, fmt.Sprintf("unsupported enum value for SortOrder: %s. Supported values are: %s.", request.SortOrder, strings.Join(GetListConditionsSortOrderEnumStringValues(), ",")))
	}
...
var mappingListConditionsSortOrderEnum = map[string]ListConditionsSortOrderEnum{
	"ASCENDING":  ListConditionsSortOrderAscending,
	"DESCENDING": ListConditionsSortOrderDescending,
}

var mappingListConditionsSortOrderEnumLowerCase = map[string]ListConditionsSortOrderEnum{
	"ascending":  ListConditionsSortOrderAscending,
	"descending": ListConditionsSortOrderDescending,
}
...
func GetListConditionsSortOrderEnumValues() []ListConditionsSortOrderEnum {
	values := make([]ListConditionsSortOrderEnum, 0)
	for _, v := range mappingListConditionsSortOrderEnum {
...
func GetMappingListConditionsSortOrderEnum(val string) (ListConditionsSortOrderEnum, bool) {
	enum, ok := mappingListConditionsSortOrderEnumLowerCase[strings.ToLower(val)]
	return enum, ok
}

...
// CreateIdentityProofingProviderRequest wrapper for the CreateIdentityProofingProvider operation
//
// # See also
//
// Click https://docs.oracle.com/en-us/iaas/tools/go-sdk-examples/latest/identitydomains/CreateIdentityProofingProvider.go.html to see an example of how to use CreateIdentityProofingProviderRequest.
type CreateIdentityProofingProviderRequest struct {
...
func (request CreateIdentityProofingProviderRequest) String() string {
	return common.PointerString(request)
}

// HTTPRequest implements the OCIRequest interface
func (request CreateIdentityProofingProviderRequest) HTTPRequest(method, path string, binaryRequestBody *common.OCIReadSeekCloser, extraHeaders map[string]string) (http.Request, error) {
...
func (request CreateIdentityProofingProviderRequest) BinaryRequestBody() (*common.OCIReadSeekCloser, bool) {
...
func (request CreateIdentityProofingProviderRequest) RetryPolicy() *common.RetryPolicy {
...
func (request CreateIdentityProofingProviderRequest) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
...
// CreateIdentityProofingProviderResponse wrapper for the CreateIdentityProofingProvider operation
type CreateIdentityProofingProviderResponse struct {
...
func (response CreateIdentityProofingProviderResponse) String() string {
	return common.PointerString(response)
}

// HTTPResponse implements the OCIResponse interface
func (response CreateIdentityProofingProviderResponse) HTTPResponse() *http.Response {

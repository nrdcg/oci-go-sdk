...
func (request ListOAuth2ClientCredentialsRequest) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
	if _, ok := GetMappingListOAuth2ClientCredentialsSortOrderEnum(string(request.SortOrder)); !ok && request.SortOrder != "" {
		errMessage = append(errMessage, fmt.Sprintf("unsupported enum value for SortOrder: %s. Supported values are: %s.", request.SortOrder, strings.Join(GetListOAuth2ClientCredentialsSortOrderEnumStringValues(), ",")))
	}
...
var mappingListOAuth2ClientCredentialsSortOrderEnum = map[string]ListOAuth2ClientCredentialsSortOrderEnum{
	"ASCENDING":  ListOAuth2ClientCredentialsSortOrderAscending,
	"DESCENDING": ListOAuth2ClientCredentialsSortOrderDescending,
}
...
func GetListOAuth2ClientCredentialsSortOrderEnumValues() []ListOAuth2ClientCredentialsSortOrderEnum {
	values := make([]ListOAuth2ClientCredentialsSortOrderEnum, 0)
	for _, v := range mappingListOAuth2ClientCredentialsSortOrderEnum {
...
func GetMappingListOAuth2ClientCredentialsSortOrderEnum(val string) (ListOAuth2ClientCredentialsSortOrderEnum, bool) {
	enum, ok := mappingListOAuth2ClientCredentialsSortOrderEnumLowerCase[strings.ToLower(val)]
	return enum, ok
}

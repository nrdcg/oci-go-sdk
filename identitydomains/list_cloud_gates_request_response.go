...
func (request ListCloudGatesRequest) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
	if _, ok := GetMappingListCloudGatesSortOrderEnum(string(request.SortOrder)); !ok && request.SortOrder != "" {
		errMessage = append(errMessage, fmt.Sprintf("unsupported enum value for SortOrder: %s. Supported values are: %s.", request.SortOrder, strings.Join(GetListCloudGatesSortOrderEnumStringValues(), ",")))
	}
...
var mappingListCloudGatesSortOrderEnum = map[string]ListCloudGatesSortOrderEnum{
	"ASCENDING":  ListCloudGatesSortOrderAscending,
	"DESCENDING": ListCloudGatesSortOrderDescending,
}

var mappingListCloudGatesSortOrderEnumLowerCase = map[string]ListCloudGatesSortOrderEnum{
	"ascending":  ListCloudGatesSortOrderAscending,
	"descending": ListCloudGatesSortOrderDescending,
}
...
func GetListCloudGatesSortOrderEnumValues() []ListCloudGatesSortOrderEnum {
	values := make([]ListCloudGatesSortOrderEnum, 0)
	for _, v := range mappingListCloudGatesSortOrderEnum {
...
func GetMappingListCloudGatesSortOrderEnum(val string) (ListCloudGatesSortOrderEnum, bool) {
	enum, ok := mappingListCloudGatesSortOrderEnumLowerCase[strings.ToLower(val)]
	return enum, ok
}

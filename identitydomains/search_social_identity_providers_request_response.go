...
type SearchSocialIdentityProvidersRequest struct {
	...
	SocialIdentityProviderSearchRequest `contributesTo:"body"`
...
type SearchSocialIdentityProvidersResponse struct {

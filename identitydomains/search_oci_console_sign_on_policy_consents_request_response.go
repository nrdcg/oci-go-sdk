...
type SearchOciConsoleSignOnPolicyConsentsRequest struct {
	...
	OciConsoleSignOnPolicyConsentSearchRequest `contributesTo:"body"`
...
type SearchOciConsoleSignOnPolicyConsentsResponse struct {

...
// MappedAttributes The SCIM protocol defines a standard set of query parameters that can be used to filter, sort, and paginate to return zero or more resources in a query response. Queries MAY be made against a single resource or a resource type endpoint (e.g., /Users), or the service provider Base URI.
type MappedAttributes struct {
	...
	Resources []MappedAttribute `mandatory:"true" json:"Resources"`
...
func (m MappedAttributes) String() string {
...
func (m MappedAttributes) ValidateEnumValue() (bool, error) {
	errMessage := []string{}

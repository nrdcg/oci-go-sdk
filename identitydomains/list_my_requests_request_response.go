...
func (request ListMyRequestsRequest) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
	if _, ok := GetMappingListMyRequestsSortOrderEnum(string(request.SortOrder)); !ok && request.SortOrder != "" {
		errMessage = append(errMessage, fmt.Sprintf("unsupported enum value for SortOrder: %s. Supported values are: %s.", request.SortOrder, strings.Join(GetListMyRequestsSortOrderEnumStringValues(), ",")))
	}
...
var mappingListMyRequestsSortOrderEnum = map[string]ListMyRequestsSortOrderEnum{
	"ASCENDING":  ListMyRequestsSortOrderAscending,
	"DESCENDING": ListMyRequestsSortOrderDescending,
}

var mappingListMyRequestsSortOrderEnumLowerCase = map[string]ListMyRequestsSortOrderEnum{
	"ascending":  ListMyRequestsSortOrderAscending,
	"descending": ListMyRequestsSortOrderDescending,
}
...
func GetListMyRequestsSortOrderEnumValues() []ListMyRequestsSortOrderEnum {
	values := make([]ListMyRequestsSortOrderEnum, 0)
	for _, v := range mappingListMyRequestsSortOrderEnum {
...
func GetMappingListMyRequestsSortOrderEnum(val string) (ListMyRequestsSortOrderEnum, bool) {
	enum, ok := mappingListMyRequestsSortOrderEnumLowerCase[strings.ToLower(val)]
	return enum, ok
}

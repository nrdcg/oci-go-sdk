...
func (request ListApprovalWorkflowAssignmentsRequest) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
	if _, ok := GetMappingListApprovalWorkflowAssignmentsSortOrderEnum(string(request.SortOrder)); !ok && request.SortOrder != "" {
		errMessage = append(errMessage, fmt.Sprintf("unsupported enum value for SortOrder: %s. Supported values are: %s.", request.SortOrder, strings.Join(GetListApprovalWorkflowAssignmentsSortOrderEnumStringValues(), ",")))
	}
...
var mappingListApprovalWorkflowAssignmentsSortOrderEnum = map[string]ListApprovalWorkflowAssignmentsSortOrderEnum{
	"ASCENDING":  ListApprovalWorkflowAssignmentsSortOrderAscending,
	"DESCENDING": ListApprovalWorkflowAssignmentsSortOrderDescending,
}

var mappingListApprovalWorkflowAssignmentsSortOrderEnumLowerCase = map[string]ListApprovalWorkflowAssignmentsSortOrderEnum{
	"ascending":  ListApprovalWorkflowAssignmentsSortOrderAscending,
	"descending": ListApprovalWorkflowAssignmentsSortOrderDescending,
}
...
func GetListApprovalWorkflowAssignmentsSortOrderEnumValues() []ListApprovalWorkflowAssignmentsSortOrderEnum {
	values := make([]ListApprovalWorkflowAssignmentsSortOrderEnum, 0)
	for _, v := range mappingListApprovalWorkflowAssignmentsSortOrderEnum {
...
func GetMappingListApprovalWorkflowAssignmentsSortOrderEnum(val string) (ListApprovalWorkflowAssignmentsSortOrderEnum, bool) {
	enum, ok := mappingListApprovalWorkflowAssignmentsSortOrderEnumLowerCase[strings.ToLower(val)]
	return enum, ok
}

...
// PatchIdentityProofingProviderTemplateRequest wrapper for the PatchIdentityProofingProviderTemplate operation
//
// # See also
//
// Click https://docs.oracle.com/en-us/iaas/tools/go-sdk-examples/latest/identitydomains/PatchIdentityProofingProviderTemplate.go.html to see an example of how to use PatchIdentityProofingProviderTemplateRequest.
type PatchIdentityProofingProviderTemplateRequest struct {
...
func (request PatchIdentityProofingProviderTemplateRequest) String() string {
	return common.PointerString(request)
}

// HTTPRequest implements the OCIRequest interface
func (request PatchIdentityProofingProviderTemplateRequest) HTTPRequest(method, path string, binaryRequestBody *common.OCIReadSeekCloser, extraHeaders map[string]string) (http.Request, error) {
...
func (request PatchIdentityProofingProviderTemplateRequest) BinaryRequestBody() (*common.OCIReadSeekCloser, bool) {
...
func (request PatchIdentityProofingProviderTemplateRequest) RetryPolicy() *common.RetryPolicy {
...
func (request PatchIdentityProofingProviderTemplateRequest) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
...
// PatchIdentityProofingProviderTemplateResponse wrapper for the PatchIdentityProofingProviderTemplate operation
type PatchIdentityProofingProviderTemplateResponse struct {
...
func (response PatchIdentityProofingProviderTemplateResponse) String() string {
	return common.PointerString(response)
}

// HTTPResponse implements the OCIResponse interface
func (response PatchIdentityProofingProviderTemplateResponse) HTTPResponse() *http.Response {

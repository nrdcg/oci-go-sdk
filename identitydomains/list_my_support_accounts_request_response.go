...
func (request ListMySupportAccountsRequest) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
	if _, ok := GetMappingListMySupportAccountsSortOrderEnum(string(request.SortOrder)); !ok && request.SortOrder != "" {
		errMessage = append(errMessage, fmt.Sprintf("unsupported enum value for SortOrder: %s. Supported values are: %s.", request.SortOrder, strings.Join(GetListMySupportAccountsSortOrderEnumStringValues(), ",")))
	}
	if len(errMessage) > 0 {
...
var mappingListMySupportAccountsSortOrderEnum = map[string]ListMySupportAccountsSortOrderEnum{
	"ASCENDING":  ListMySupportAccountsSortOrderAscending,
	"DESCENDING": ListMySupportAccountsSortOrderDescending,
}

var mappingListMySupportAccountsSortOrderEnumLowerCase = map[string]ListMySupportAccountsSortOrderEnum{
	"ascending":  ListMySupportAccountsSortOrderAscending,
	"descending": ListMySupportAccountsSortOrderDescending,
}
...
func GetListMySupportAccountsSortOrderEnumValues() []ListMySupportAccountsSortOrderEnum {
	values := make([]ListMySupportAccountsSortOrderEnum, 0)
	for _, v := range mappingListMySupportAccountsSortOrderEnum {
...
func GetMappingListMySupportAccountsSortOrderEnum(val string) (ListMySupportAccountsSortOrderEnum, bool) {
	enum, ok := mappingListMySupportAccountsSortOrderEnumLowerCase[strings.ToLower(val)]
	return enum, ok
}

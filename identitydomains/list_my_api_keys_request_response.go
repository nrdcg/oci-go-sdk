...
func (request ListMyApiKeysRequest) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
	if _, ok := GetMappingListMyApiKeysSortOrderEnum(string(request.SortOrder)); !ok && request.SortOrder != "" {
		errMessage = append(errMessage, fmt.Sprintf("unsupported enum value for SortOrder: %s. Supported values are: %s.", request.SortOrder, strings.Join(GetListMyApiKeysSortOrderEnumStringValues(), ",")))
	}
	if len(errMessage) > 0 {
...
var mappingListMyApiKeysSortOrderEnum = map[string]ListMyApiKeysSortOrderEnum{
	"ASCENDING":  ListMyApiKeysSortOrderAscending,
	"DESCENDING": ListMyApiKeysSortOrderDescending,
}

var mappingListMyApiKeysSortOrderEnumLowerCase = map[string]ListMyApiKeysSortOrderEnum{
	"ascending":  ListMyApiKeysSortOrderAscending,
	"descending": ListMyApiKeysSortOrderDescending,
}
...
func GetListMyApiKeysSortOrderEnumValues() []ListMyApiKeysSortOrderEnum {
	values := make([]ListMyApiKeysSortOrderEnum, 0)
	for _, v := range mappingListMyApiKeysSortOrderEnum {
...
func GetMappingListMyApiKeysSortOrderEnum(val string) (ListMyApiKeysSortOrderEnum, bool) {
	enum, ok := mappingListMyApiKeysSortOrderEnumLowerCase[strings.ToLower(val)]
	return enum, ok
}

...
func (request ListCustomerSecretKeysRequest) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
	if _, ok := GetMappingListCustomerSecretKeysSortOrderEnum(string(request.SortOrder)); !ok && request.SortOrder != "" {
		errMessage = append(errMessage, fmt.Sprintf("unsupported enum value for SortOrder: %s. Supported values are: %s.", request.SortOrder, strings.Join(GetListCustomerSecretKeysSortOrderEnumStringValues(), ",")))
	}
...
var mappingListCustomerSecretKeysSortOrderEnum = map[string]ListCustomerSecretKeysSortOrderEnum{
	"ASCENDING":  ListCustomerSecretKeysSortOrderAscending,
	"DESCENDING": ListCustomerSecretKeysSortOrderDescending,
}

var mappingListCustomerSecretKeysSortOrderEnumLowerCase = map[string]ListCustomerSecretKeysSortOrderEnum{
	"ascending":  ListCustomerSecretKeysSortOrderAscending,
	"descending": ListCustomerSecretKeysSortOrderDescending,
}
...
func GetListCustomerSecretKeysSortOrderEnumValues() []ListCustomerSecretKeysSortOrderEnum {
	values := make([]ListCustomerSecretKeysSortOrderEnum, 0)
	for _, v := range mappingListCustomerSecretKeysSortOrderEnum {
...
func GetMappingListCustomerSecretKeysSortOrderEnum(val string) (ListCustomerSecretKeysSortOrderEnum, bool) {
	enum, ok := mappingListCustomerSecretKeysSortOrderEnumLowerCase[strings.ToLower(val)]
	return enum, ok
}

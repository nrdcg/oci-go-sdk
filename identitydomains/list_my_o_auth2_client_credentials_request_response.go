...
func (request ListMyOAuth2ClientCredentialsRequest) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
	if _, ok := GetMappingListMyOAuth2ClientCredentialsSortOrderEnum(string(request.SortOrder)); !ok && request.SortOrder != "" {
		errMessage = append(errMessage, fmt.Sprintf("unsupported enum value for SortOrder: %s. Supported values are: %s.", request.SortOrder, strings.Join(GetListMyOAuth2ClientCredentialsSortOrderEnumStringValues(), ",")))
	}
	if len(errMessage) > 0 {
...
var mappingListMyOAuth2ClientCredentialsSortOrderEnum = map[string]ListMyOAuth2ClientCredentialsSortOrderEnum{
...
func GetListMyOAuth2ClientCredentialsSortOrderEnumValues() []ListMyOAuth2ClientCredentialsSortOrderEnum {
	values := make([]ListMyOAuth2ClientCredentialsSortOrderEnum, 0)
	for _, v := range mappingListMyOAuth2ClientCredentialsSortOrderEnum {
...
func GetMappingListMyOAuth2ClientCredentialsSortOrderEnum(val string) (ListMyOAuth2ClientCredentialsSortOrderEnum, bool) {
	enum, ok := mappingListMyOAuth2ClientCredentialsSortOrderEnumLowerCase[strings.ToLower(val)]
	return enum, ok
}

...
func (request ListMyUserDbCredentialsRequest) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
	if _, ok := GetMappingListMyUserDbCredentialsSortOrderEnum(string(request.SortOrder)); !ok && request.SortOrder != "" {
		errMessage = append(errMessage, fmt.Sprintf("unsupported enum value for SortOrder: %s. Supported values are: %s.", request.SortOrder, strings.Join(GetListMyUserDbCredentialsSortOrderEnumStringValues(), ",")))
	}
	if len(errMessage) > 0 {
...
var mappingListMyUserDbCredentialsSortOrderEnum = map[string]ListMyUserDbCredentialsSortOrderEnum{
	...
	"DESCENDING": ListMyUserDbCredentialsSortOrderDescending,
}

var mappingListMyUserDbCredentialsSortOrderEnumLowerCase = map[string]ListMyUserDbCredentialsSortOrderEnum{
	"ascending":  ListMyUserDbCredentialsSortOrderAscending,
	"descending": ListMyUserDbCredentialsSortOrderDescending,
}
...
func GetListMyUserDbCredentialsSortOrderEnumValues() []ListMyUserDbCredentialsSortOrderEnum {
	values := make([]ListMyUserDbCredentialsSortOrderEnum, 0)
	for _, v := range mappingListMyUserDbCredentialsSortOrderEnum {
...
func GetMappingListMyUserDbCredentialsSortOrderEnum(val string) (ListMyUserDbCredentialsSortOrderEnum, bool) {
	enum, ok := mappingListMyUserDbCredentialsSortOrderEnumLowerCase[strings.ToLower(val)]
	return enum, ok
}

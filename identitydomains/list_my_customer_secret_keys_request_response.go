...
func (request ListMyCustomerSecretKeysRequest) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
	if _, ok := GetMappingListMyCustomerSecretKeysSortOrderEnum(string(request.SortOrder)); !ok && request.SortOrder != "" {
		errMessage = append(errMessage, fmt.Sprintf("unsupported enum value for SortOrder: %s. Supported values are: %s.", request.SortOrder, strings.Join(GetListMyCustomerSecretKeysSortOrderEnumStringValues(), ",")))
	}
	if len(errMessage) > 0 {
...
var mappingListMyCustomerSecretKeysSortOrderEnum = map[string]ListMyCustomerSecretKeysSortOrderEnum{
	"ASCENDING":  ListMyCustomerSecretKeysSortOrderAscending,
	"DESCENDING": ListMyCustomerSecretKeysSortOrderDescending,
}

var mappingListMyCustomerSecretKeysSortOrderEnumLowerCase = map[string]ListMyCustomerSecretKeysSortOrderEnum{
	"ascending":  ListMyCustomerSecretKeysSortOrderAscending,
	"descending": ListMyCustomerSecretKeysSortOrderDescending,
}
...
func GetListMyCustomerSecretKeysSortOrderEnumValues() []ListMyCustomerSecretKeysSortOrderEnum {
	values := make([]ListMyCustomerSecretKeysSortOrderEnum, 0)
	for _, v := range mappingListMyCustomerSecretKeysSortOrderEnum {
...
func GetMappingListMyCustomerSecretKeysSortOrderEnum(val string) (ListMyCustomerSecretKeysSortOrderEnum, bool) {
	enum, ok := mappingListMyCustomerSecretKeysSortOrderEnumLowerCase[strings.ToLower(val)]
	return enum, ok
}

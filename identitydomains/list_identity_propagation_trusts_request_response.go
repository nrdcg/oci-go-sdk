...
func (request ListIdentityPropagationTrustsRequest) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
	if _, ok := GetMappingListIdentityPropagationTrustsSortOrderEnum(string(request.SortOrder)); !ok && request.SortOrder != "" {
		errMessage = append(errMessage, fmt.Sprintf("unsupported enum value for SortOrder: %s. Supported values are: %s.", request.SortOrder, strings.Join(GetListIdentityPropagationTrustsSortOrderEnumStringValues(), ",")))
	}
...
var mappingListIdentityPropagationTrustsSortOrderEnum = map[string]ListIdentityPropagationTrustsSortOrderEnum{
	"ASCENDING":  ListIdentityPropagationTrustsSortOrderAscending,
	"DESCENDING": ListIdentityPropagationTrustsSortOrderDescending,
}

var mappingListIdentityPropagationTrustsSortOrderEnumLowerCase = map[string]ListIdentityPropagationTrustsSortOrderEnum{
	"ascending":  ListIdentityPropagationTrustsSortOrderAscending,
	"descending": ListIdentityPropagationTrustsSortOrderDescending,
}
...
func GetListIdentityPropagationTrustsSortOrderEnumValues() []ListIdentityPropagationTrustsSortOrderEnum {
	values := make([]ListIdentityPropagationTrustsSortOrderEnum, 0)
	for _, v := range mappingListIdentityPropagationTrustsSortOrderEnum {
...
func GetMappingListIdentityPropagationTrustsSortOrderEnum(val string) (ListIdentityPropagationTrustsSortOrderEnum, bool) {
	enum, ok := mappingListIdentityPropagationTrustsSortOrderEnumLowerCase[strings.ToLower(val)]
	return enum, ok
}

...
func (request ListCloudGateMappingsRequest) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
	if _, ok := GetMappingListCloudGateMappingsSortOrderEnum(string(request.SortOrder)); !ok && request.SortOrder != "" {
		errMessage = append(errMessage, fmt.Sprintf("unsupported enum value for SortOrder: %s. Supported values are: %s.", request.SortOrder, strings.Join(GetListCloudGateMappingsSortOrderEnumStringValues(), ",")))
	}
...
var mappingListCloudGateMappingsSortOrderEnum = map[string]ListCloudGateMappingsSortOrderEnum{
	"ASCENDING":  ListCloudGateMappingsSortOrderAscending,
	"DESCENDING": ListCloudGateMappingsSortOrderDescending,
}

var mappingListCloudGateMappingsSortOrderEnumLowerCase = map[string]ListCloudGateMappingsSortOrderEnum{
	"ascending":  ListCloudGateMappingsSortOrderAscending,
	"descending": ListCloudGateMappingsSortOrderDescending,
}
...
func GetListCloudGateMappingsSortOrderEnumValues() []ListCloudGateMappingsSortOrderEnum {
	values := make([]ListCloudGateMappingsSortOrderEnum, 0)
	for _, v := range mappingListCloudGateMappingsSortOrderEnum {
...
func GetMappingListCloudGateMappingsSortOrderEnum(val string) (ListCloudGateMappingsSortOrderEnum, bool) {
	enum, ok := mappingListCloudGateMappingsSortOrderEnumLowerCase[strings.ToLower(val)]
	return enum, ok
}

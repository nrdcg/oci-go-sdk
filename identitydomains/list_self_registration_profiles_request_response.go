...
func (request ListSelfRegistrationProfilesRequest) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
	if _, ok := GetMappingListSelfRegistrationProfilesSortOrderEnum(string(request.SortOrder)); !ok && request.SortOrder != "" {
		errMessage = append(errMessage, fmt.Sprintf("unsupported enum value for SortOrder: %s. Supported values are: %s.", request.SortOrder, strings.Join(GetListSelfRegistrationProfilesSortOrderEnumStringValues(), ",")))
	}
...
var mappingListSelfRegistrationProfilesSortOrderEnum = map[string]ListSelfRegistrationProfilesSortOrderEnum{
	"ASCENDING":  ListSelfRegistrationProfilesSortOrderAscending,
	"DESCENDING": ListSelfRegistrationProfilesSortOrderDescending,
}

var mappingListSelfRegistrationProfilesSortOrderEnumLowerCase = map[string]ListSelfRegistrationProfilesSortOrderEnum{
	"ascending":  ListSelfRegistrationProfilesSortOrderAscending,
	"descending": ListSelfRegistrationProfilesSortOrderDescending,
}
...
func GetListSelfRegistrationProfilesSortOrderEnumValues() []ListSelfRegistrationProfilesSortOrderEnum {
	values := make([]ListSelfRegistrationProfilesSortOrderEnum, 0)
	for _, v := range mappingListSelfRegistrationProfilesSortOrderEnum {
...
func GetMappingListSelfRegistrationProfilesSortOrderEnum(val string) (ListSelfRegistrationProfilesSortOrderEnum, bool) {
	enum, ok := mappingListSelfRegistrationProfilesSortOrderEnumLowerCase[strings.ToLower(val)]
	return enum, ok
}

...
func (m MySupportAccount) ValidateEnumValue() (bool, error) {
	...
	if _, ok := GetMappingMySupportAccountProviderEnum(string(m.Provider)); !ok && m.Provider != "" {
		errMessage = append(errMessage, fmt.Sprintf("unsupported enum value for Provider: %s. Supported values are: %s.", m.Provider, strings.Join(GetMySupportAccountProviderEnumStringValues(), ",")))
	}
	if len(errMessage) > 0 {
...
var mappingMySupportAccountProviderEnum = map[string]MySupportAccountProviderEnum{
	"MOS": MySupportAccountProviderMos,
}

var mappingMySupportAccountProviderEnumLowerCase = map[string]MySupportAccountProviderEnum{
	"mos": MySupportAccountProviderMos,
}
...
func GetMySupportAccountProviderEnumValues() []MySupportAccountProviderEnum {
	values := make([]MySupportAccountProviderEnum, 0)
	for _, v := range mappingMySupportAccountProviderEnum {
...
func GetMappingMySupportAccountProviderEnum(val string) (MySupportAccountProviderEnum, bool) {
	enum, ok := mappingMySupportAccountProviderEnumLowerCase[strings.ToLower(val)]
	return enum, ok
}

...
func (request ListDynamicResourceGroupsRequest) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
	if _, ok := GetMappingListDynamicResourceGroupsSortOrderEnum(string(request.SortOrder)); !ok && request.SortOrder != "" {
		errMessage = append(errMessage, fmt.Sprintf("unsupported enum value for SortOrder: %s. Supported values are: %s.", request.SortOrder, strings.Join(GetListDynamicResourceGroupsSortOrderEnumStringValues(), ",")))
	}
...
var mappingListDynamicResourceGroupsSortOrderEnum = map[string]ListDynamicResourceGroupsSortOrderEnum{
	"ASCENDING":  ListDynamicResourceGroupsSortOrderAscending,
	"DESCENDING": ListDynamicResourceGroupsSortOrderDescending,
}

var mappingListDynamicResourceGroupsSortOrderEnumLowerCase = map[string]ListDynamicResourceGroupsSortOrderEnum{
	"ascending":  ListDynamicResourceGroupsSortOrderAscending,
	"descending": ListDynamicResourceGroupsSortOrderDescending,
}
...
func GetListDynamicResourceGroupsSortOrderEnumValues() []ListDynamicResourceGroupsSortOrderEnum {
	values := make([]ListDynamicResourceGroupsSortOrderEnum, 0)
	for _, v := range mappingListDynamicResourceGroupsSortOrderEnum {
...
func GetMappingListDynamicResourceGroupsSortOrderEnum(val string) (ListDynamicResourceGroupsSortOrderEnum, bool) {
	enum, ok := mappingListDynamicResourceGroupsSortOrderEnumLowerCase[strings.ToLower(val)]
	return enum, ok
}

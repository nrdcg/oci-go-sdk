...
func (request ListPasswordPoliciesRequest) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
	if _, ok := GetMappingListPasswordPoliciesSortOrderEnum(string(request.SortOrder)); !ok && request.SortOrder != "" {
		errMessage = append(errMessage, fmt.Sprintf("unsupported enum value for SortOrder: %s. Supported values are: %s.", request.SortOrder, strings.Join(GetListPasswordPoliciesSortOrderEnumStringValues(), ",")))
	}
...
var mappingListPasswordPoliciesSortOrderEnum = map[string]ListPasswordPoliciesSortOrderEnum{
	"ASCENDING":  ListPasswordPoliciesSortOrderAscending,
	"DESCENDING": ListPasswordPoliciesSortOrderDescending,
}

var mappingListPasswordPoliciesSortOrderEnumLowerCase = map[string]ListPasswordPoliciesSortOrderEnum{
	"ascending":  ListPasswordPoliciesSortOrderAscending,
	"descending": ListPasswordPoliciesSortOrderDescending,
}
...
func GetListPasswordPoliciesSortOrderEnumValues() []ListPasswordPoliciesSortOrderEnum {
	values := make([]ListPasswordPoliciesSortOrderEnum, 0)
	for _, v := range mappingListPasswordPoliciesSortOrderEnum {
...
func GetMappingListPasswordPoliciesSortOrderEnum(val string) (ListPasswordPoliciesSortOrderEnum, bool) {
	enum, ok := mappingListPasswordPoliciesSortOrderEnumLowerCase[strings.ToLower(val)]
	return enum, ok
}

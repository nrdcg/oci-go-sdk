...
// PutMappedAttributeRequest wrapper for the PutMappedAttribute operation
//
// # See also
//
// Click https://docs.oracle.com/en-us/iaas/tools/go-sdk-examples/latest/identitydomains/PutMappedAttribute.go.html to see an example of how to use PutMappedAttributeRequest.
type PutMappedAttributeRequest struct {

	// ID of the resource
	MappedAttributeId *string `mandatory:"true" contributesTo:"path" name:"mappedAttributeId"`
	...
	MappedAttribute `contributesTo:"body"`
...
func (request PutMappedAttributeRequest) String() string {
	return common.PointerString(request)
}

// HTTPRequest implements the OCIRequest interface
func (request PutMappedAttributeRequest) HTTPRequest(method, path string, binaryRequestBody *common.OCIReadSeekCloser, extraHeaders map[string]string) (http.Request, error) {
...
func (request PutMappedAttributeRequest) BinaryRequestBody() (*common.OCIReadSeekCloser, bool) {
...
func (request PutMappedAttributeRequest) RetryPolicy() *common.RetryPolicy {
...
func (request PutMappedAttributeRequest) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
...
// PutMappedAttributeResponse wrapper for the PutMappedAttribute operation
type PutMappedAttributeResponse struct {

	// The underlying http response
	RawResponse *http.Response

	// The MappedAttribute instance
	MappedAttribute `presentIn:"body"`
...
func (response PutMappedAttributeResponse) String() string {
	return common.PointerString(response)
}

// HTTPResponse implements the OCIResponse interface
func (response PutMappedAttributeResponse) HTTPResponse() *http.Response {

...
func (m MyOAuth2ClientCredential) ValidateEnumValue() (bool, error) {
	...
	if _, ok := GetMappingMyOAuth2ClientCredentialStatusEnum(string(m.Status)); !ok && m.Status != "" {
		errMessage = append(errMessage, fmt.Sprintf("unsupported enum value for Status: %s. Supported values are: %s.", m.Status, strings.Join(GetMyOAuth2ClientCredentialStatusEnumStringValues(), ",")))
	}
	if len(errMessage) > 0 {
...
var mappingMyOAuth2ClientCredentialStatusEnum = map[string]MyOAuth2ClientCredentialStatusEnum{
	"ACTIVE":   MyOAuth2ClientCredentialStatusActive,
	"INACTIVE": MyOAuth2ClientCredentialStatusInactive,
}

var mappingMyOAuth2ClientCredentialStatusEnumLowerCase = map[string]MyOAuth2ClientCredentialStatusEnum{
	"active":   MyOAuth2ClientCredentialStatusActive,
	"inactive": MyOAuth2ClientCredentialStatusInactive,
}
...
func GetMyOAuth2ClientCredentialStatusEnumValues() []MyOAuth2ClientCredentialStatusEnum {
	values := make([]MyOAuth2ClientCredentialStatusEnum, 0)
	for _, v := range mappingMyOAuth2ClientCredentialStatusEnum {
...
func GetMappingMyOAuth2ClientCredentialStatusEnum(val string) (MyOAuth2ClientCredentialStatusEnum, bool) {
	enum, ok := mappingMyOAuth2ClientCredentialStatusEnumLowerCase[strings.ToLower(val)]
	return enum, ok
}

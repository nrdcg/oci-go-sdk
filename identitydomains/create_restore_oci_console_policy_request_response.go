...
type CreateRestoreOciConsolePolicyRequest struct {
	...
	RestoreOciConsolePolicy `contributesTo:"body"`
...
type CreateRestoreOciConsolePolicyResponse struct {

	// The underlying http response
	RawResponse *http.Response

	// The RestoreOciConsolePolicy instance
	RestoreOciConsolePolicy `presentIn:"body"`

...
type GetOciConsoleSignOnPolicyConsentRequest struct {

	// ID of the resource
	OciConsoleSignOnPolicyConsentId *string `mandatory:"true" contributesTo:"path" name:"ociConsoleSignOnPolicyConsentId"`
...
type GetOciConsoleSignOnPolicyConsentResponse struct {

	// The underlying http response
	RawResponse *http.Response

	// The OciConsoleSignOnPolicyConsent instance
	OciConsoleSignOnPolicyConsent `presentIn:"body"`

...
func (request ListMyTrustedUserAgentsRequest) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
	if _, ok := GetMappingListMyTrustedUserAgentsSortOrderEnum(string(request.SortOrder)); !ok && request.SortOrder != "" {
		errMessage = append(errMessage, fmt.Sprintf("unsupported enum value for SortOrder: %s. Supported values are: %s.", request.SortOrder, strings.Join(GetListMyTrustedUserAgentsSortOrderEnumStringValues(), ",")))
	}
...
var mappingListMyTrustedUserAgentsSortOrderEnum = map[string]ListMyTrustedUserAgentsSortOrderEnum{
	"ASCENDING":  ListMyTrustedUserAgentsSortOrderAscending,
	"DESCENDING": ListMyTrustedUserAgentsSortOrderDescending,
}

var mappingListMyTrustedUserAgentsSortOrderEnumLowerCase = map[string]ListMyTrustedUserAgentsSortOrderEnum{
	"ascending":  ListMyTrustedUserAgentsSortOrderAscending,
	"descending": ListMyTrustedUserAgentsSortOrderDescending,
}
...
func GetListMyTrustedUserAgentsSortOrderEnumValues() []ListMyTrustedUserAgentsSortOrderEnum {
	values := make([]ListMyTrustedUserAgentsSortOrderEnum, 0)
	for _, v := range mappingListMyTrustedUserAgentsSortOrderEnum {
...
func GetMappingListMyTrustedUserAgentsSortOrderEnum(val string) (ListMyTrustedUserAgentsSortOrderEnum, bool) {
	enum, ok := mappingListMyTrustedUserAgentsSortOrderEnumLowerCase[strings.ToLower(val)]
	return enum, ok
}

...
func (request ListApprovalWorkflowStepsRequest) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
	if _, ok := GetMappingListApprovalWorkflowStepsSortOrderEnum(string(request.SortOrder)); !ok && request.SortOrder != "" {
		errMessage = append(errMessage, fmt.Sprintf("unsupported enum value for SortOrder: %s. Supported values are: %s.", request.SortOrder, strings.Join(GetListApprovalWorkflowStepsSortOrderEnumStringValues(), ",")))
	}
...
var mappingListApprovalWorkflowStepsSortOrderEnum = map[string]ListApprovalWorkflowStepsSortOrderEnum{
	"ASCENDING":  ListApprovalWorkflowStepsSortOrderAscending,
	"DESCENDING": ListApprovalWorkflowStepsSortOrderDescending,
}

var mappingListApprovalWorkflowStepsSortOrderEnumLowerCase = map[string]ListApprovalWorkflowStepsSortOrderEnum{
	"ascending":  ListApprovalWorkflowStepsSortOrderAscending,
	"descending": ListApprovalWorkflowStepsSortOrderDescending,
}
...
func GetListApprovalWorkflowStepsSortOrderEnumValues() []ListApprovalWorkflowStepsSortOrderEnum {
	values := make([]ListApprovalWorkflowStepsSortOrderEnum, 0)
	for _, v := range mappingListApprovalWorkflowStepsSortOrderEnum {
...
func GetMappingListApprovalWorkflowStepsSortOrderEnum(val string) (ListApprovalWorkflowStepsSortOrderEnum, bool) {
	enum, ok := mappingListApprovalWorkflowStepsSortOrderEnumLowerCase[strings.ToLower(val)]
	return enum, ok
}

...
type IdentityProofingProviderTemplates struct {
	...
	Resources []IdentityProofingProviderTemplate `mandatory:"true" json:"Resources"`
...
func (m IdentityProofingProviderTemplates) String() string {
...
func (m IdentityProofingProviderTemplates) ValidateEnumValue() (bool, error) {
	errMessage := []string{}

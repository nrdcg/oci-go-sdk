...
func (request ListMyAuthTokensRequest) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
	if _, ok := GetMappingListMyAuthTokensSortOrderEnum(string(request.SortOrder)); !ok && request.SortOrder != "" {
		errMessage = append(errMessage, fmt.Sprintf("unsupported enum value for SortOrder: %s. Supported values are: %s.", request.SortOrder, strings.Join(GetListMyAuthTokensSortOrderEnumStringValues(), ",")))
	}
	if len(errMessage) > 0 {
...
var mappingListMyAuthTokensSortOrderEnum = map[string]ListMyAuthTokensSortOrderEnum{
	"ASCENDING":  ListMyAuthTokensSortOrderAscending,
	"DESCENDING": ListMyAuthTokensSortOrderDescending,
}

var mappingListMyAuthTokensSortOrderEnumLowerCase = map[string]ListMyAuthTokensSortOrderEnum{
	"ascending":  ListMyAuthTokensSortOrderAscending,
	"descending": ListMyAuthTokensSortOrderDescending,
}
...
func GetListMyAuthTokensSortOrderEnumValues() []ListMyAuthTokensSortOrderEnum {
	values := make([]ListMyAuthTokensSortOrderEnum, 0)
	for _, v := range mappingListMyAuthTokensSortOrderEnum {
...
func GetMappingListMyAuthTokensSortOrderEnum(val string) (ListMyAuthTokensSortOrderEnum, bool) {
	enum, ok := mappingListMyAuthTokensSortOrderEnumLowerCase[strings.ToLower(val)]
	return enum, ok
}

...
// PatchMappedAttributeRequest wrapper for the PatchMappedAttribute operation
//
// # See also
//
// Click https://docs.oracle.com/en-us/iaas/tools/go-sdk-examples/latest/identitydomains/PatchMappedAttribute.go.html to see an example of how to use PatchMappedAttributeRequest.
type PatchMappedAttributeRequest struct {
...
func (request PatchMappedAttributeRequest) String() string {
	return common.PointerString(request)
}

// HTTPRequest implements the OCIRequest interface
func (request PatchMappedAttributeRequest) HTTPRequest(method, path string, binaryRequestBody *common.OCIReadSeekCloser, extraHeaders map[string]string) (http.Request, error) {
...
func (request PatchMappedAttributeRequest) BinaryRequestBody() (*common.OCIReadSeekCloser, bool) {
...
func (request PatchMappedAttributeRequest) RetryPolicy() *common.RetryPolicy {
...
func (request PatchMappedAttributeRequest) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
...
// PatchMappedAttributeResponse wrapper for the PatchMappedAttribute operation
type PatchMappedAttributeResponse struct {
...
func (response PatchMappedAttributeResponse) String() string {
	return common.PointerString(response)
}

// HTTPResponse implements the OCIResponse interface
func (response PatchMappedAttributeResponse) HTTPResponse() *http.Response {

...
type ListOciConsoleSignOnPolicyConsentsRequest struct {
	...
	SortOrder ListOciConsoleSignOnPolicyConsentsSortOrderEnum `mandatory:"false" contributesTo:"query" name:"sortOrder" omitEmpty:"true"`
...
func (request ListOciConsoleSignOnPolicyConsentsRequest) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
	if _, ok := GetMappingListOciConsoleSignOnPolicyConsentsSortOrderEnum(string(request.SortOrder)); !ok && request.SortOrder != "" {
		errMessage = append(errMessage, fmt.Sprintf("unsupported enum value for SortOrder: %s. Supported values are: %s.", request.SortOrder, strings.Join(GetListOciConsoleSignOnPolicyConsentsSortOrderEnumStringValues(), ",")))
	}
...
type ListOciConsoleSignOnPolicyConsentsResponse struct {
	...
	// A list of OciConsoleSignOnPolicyConsents instances
	OciConsoleSignOnPolicyConsents `presentIn:"body"`
...
const (
	ListOciConsoleSignOnPolicyConsentsSortOrderAscending  ListOciConsoleSignOnPolicyConsentsSortOrderEnum = "ASCENDING"
	ListOciConsoleSignOnPolicyConsentsSortOrderDescending ListOciConsoleSignOnPolicyConsentsSortOrderEnum = "DESCENDING"
)

var mappingListOciConsoleSignOnPolicyConsentsSortOrderEnum = map[string]ListOciConsoleSignOnPolicyConsentsSortOrderEnum{
	"ASCENDING":  ListOciConsoleSignOnPolicyConsentsSortOrderAscending,
	"DESCENDING": ListOciConsoleSignOnPolicyConsentsSortOrderDescending,
}

var mappingListOciConsoleSignOnPolicyConsentsSortOrderEnumLowerCase = map[string]ListOciConsoleSignOnPolicyConsentsSortOrderEnum{
	"ascending":  ListOciConsoleSignOnPolicyConsentsSortOrderAscending,
	"descending": ListOciConsoleSignOnPolicyConsentsSortOrderDescending,
}
...
func GetListOciConsoleSignOnPolicyConsentsSortOrderEnumValues() []ListOciConsoleSignOnPolicyConsentsSortOrderEnum {
	values := make([]ListOciConsoleSignOnPolicyConsentsSortOrderEnum, 0)
	for _, v := range mappingListOciConsoleSignOnPolicyConsentsSortOrderEnum {
...
func GetMappingListOciConsoleSignOnPolicyConsentsSortOrderEnum(val string) (ListOciConsoleSignOnPolicyConsentsSortOrderEnum, bool) {
	enum, ok := mappingListOciConsoleSignOnPolicyConsentsSortOrderEnumLowerCase[strings.ToLower(val)]
	return enum, ok
}

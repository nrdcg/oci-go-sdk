...
func (m MySmtpCredential) ValidateEnumValue() (bool, error) {
	...
	if _, ok := GetMappingMySmtpCredentialStatusEnum(string(m.Status)); !ok && m.Status != "" {
		errMessage = append(errMessage, fmt.Sprintf("unsupported enum value for Status: %s. Supported values are: %s.", m.Status, strings.Join(GetMySmtpCredentialStatusEnumStringValues(), ",")))
	}
	if len(errMessage) > 0 {
...
var mappingMySmtpCredentialStatusEnum = map[string]MySmtpCredentialStatusEnum{
	"ACTIVE":   MySmtpCredentialStatusActive,
	"INACTIVE": MySmtpCredentialStatusInactive,
}

var mappingMySmtpCredentialStatusEnumLowerCase = map[string]MySmtpCredentialStatusEnum{
	"active":   MySmtpCredentialStatusActive,
	"inactive": MySmtpCredentialStatusInactive,
}
...
func GetMySmtpCredentialStatusEnumValues() []MySmtpCredentialStatusEnum {
	values := make([]MySmtpCredentialStatusEnum, 0)
	for _, v := range mappingMySmtpCredentialStatusEnum {
...
func GetMappingMySmtpCredentialStatusEnum(val string) (MySmtpCredentialStatusEnum, bool) {
	enum, ok := mappingMySmtpCredentialStatusEnumLowerCase[strings.ToLower(val)]
	return enum, ok
}

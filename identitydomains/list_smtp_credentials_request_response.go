...
func (request ListSmtpCredentialsRequest) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
	if _, ok := GetMappingListSmtpCredentialsSortOrderEnum(string(request.SortOrder)); !ok && request.SortOrder != "" {
		errMessage = append(errMessage, fmt.Sprintf("unsupported enum value for SortOrder: %s. Supported values are: %s.", request.SortOrder, strings.Join(GetListSmtpCredentialsSortOrderEnumStringValues(), ",")))
	}
...
var mappingListSmtpCredentialsSortOrderEnum = map[string]ListSmtpCredentialsSortOrderEnum{
	"ASCENDING":  ListSmtpCredentialsSortOrderAscending,
	"DESCENDING": ListSmtpCredentialsSortOrderDescending,
}

var mappingListSmtpCredentialsSortOrderEnumLowerCase = map[string]ListSmtpCredentialsSortOrderEnum{
	"ascending":  ListSmtpCredentialsSortOrderAscending,
	"descending": ListSmtpCredentialsSortOrderDescending,
}
...
func GetListSmtpCredentialsSortOrderEnumValues() []ListSmtpCredentialsSortOrderEnum {
	values := make([]ListSmtpCredentialsSortOrderEnum, 0)
	for _, v := range mappingListSmtpCredentialsSortOrderEnum {
...
func GetMappingListSmtpCredentialsSortOrderEnum(val string) (ListSmtpCredentialsSortOrderEnum, bool) {
	enum, ok := mappingListSmtpCredentialsSortOrderEnumLowerCase[strings.ToLower(val)]
	return enum, ok
}

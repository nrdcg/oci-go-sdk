...
func (m MyAuthenticationFactorsRemover) ValidateEnumValue() (bool, error) {
	...
	if _, ok := GetMappingMyAuthenticationFactorsRemoverTypeEnum(string(m.Type)); !ok && m.Type != "" {
		errMessage = append(errMessage, fmt.Sprintf("unsupported enum value for Type: %s. Supported values are: %s.", m.Type, strings.Join(GetMyAuthenticationFactorsRemoverTypeEnumStringValues(), ",")))
	}
	if len(errMessage) > 0 {
...
var mappingMyAuthenticationFactorsRemoverTypeEnum = map[string]MyAuthenticationFactorsRemoverTypeEnum{
	"KMSI":            MyAuthenticationFactorsRemoverTypeKmsi,
	"MFA":             MyAuthenticationFactorsRemoverTypeMfa,
	"ACCOUNTRECOVERY": MyAuthenticationFactorsRemoverTypeAccountrecovery,
	"ALL":             MyAuthenticationFactorsRemoverTypeAll,
}

var mappingMyAuthenticationFactorsRemoverTypeEnumLowerCase = map[string]MyAuthenticationFactorsRemoverTypeEnum{
	"kmsi":            MyAuthenticationFactorsRemoverTypeKmsi,
	"mfa":             MyAuthenticationFactorsRemoverTypeMfa,
	"accountrecovery": MyAuthenticationFactorsRemoverTypeAccountrecovery,
	"all":             MyAuthenticationFactorsRemoverTypeAll,
...
func GetMyAuthenticationFactorsRemoverTypeEnumValues() []MyAuthenticationFactorsRemoverTypeEnum {
	values := make([]MyAuthenticationFactorsRemoverTypeEnum, 0)
	for _, v := range mappingMyAuthenticationFactorsRemoverTypeEnum {
...
func GetMappingMyAuthenticationFactorsRemoverTypeEnum(val string) (MyAuthenticationFactorsRemoverTypeEnum, bool) {
	enum, ok := mappingMyAuthenticationFactorsRemoverTypeEnumLowerCase[strings.ToLower(val)]
	return enum, ok
}

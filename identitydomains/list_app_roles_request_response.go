...
func (request ListAppRolesRequest) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
	if _, ok := GetMappingListAppRolesSortOrderEnum(string(request.SortOrder)); !ok && request.SortOrder != "" {
		errMessage = append(errMessage, fmt.Sprintf("unsupported enum value for SortOrder: %s. Supported values are: %s.", request.SortOrder, strings.Join(GetListAppRolesSortOrderEnumStringValues(), ",")))
	}
...
var mappingListAppRolesSortOrderEnum = map[string]ListAppRolesSortOrderEnum{
	"ASCENDING":  ListAppRolesSortOrderAscending,
	"DESCENDING": ListAppRolesSortOrderDescending,
}

var mappingListAppRolesSortOrderEnumLowerCase = map[string]ListAppRolesSortOrderEnum{
	"ascending":  ListAppRolesSortOrderAscending,
	"descending": ListAppRolesSortOrderDescending,
}
...
func GetListAppRolesSortOrderEnumValues() []ListAppRolesSortOrderEnum {
	values := make([]ListAppRolesSortOrderEnum, 0)
	for _, v := range mappingListAppRolesSortOrderEnum {
...
func GetMappingListAppRolesSortOrderEnum(val string) (ListAppRolesSortOrderEnum, bool) {
	enum, ok := mappingListAppRolesSortOrderEnumLowerCase[strings.ToLower(val)]
	return enum, ok
}

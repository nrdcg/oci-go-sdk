...
// PutIdentityProofingProviderTemplateRequest wrapper for the PutIdentityProofingProviderTemplate operation
//
// # See also
//
// Click https://docs.oracle.com/en-us/iaas/tools/go-sdk-examples/latest/identitydomains/PutIdentityProofingProviderTemplate.go.html to see an example of how to use PutIdentityProofingProviderTemplateRequest.
type PutIdentityProofingProviderTemplateRequest struct {
...
func (request PutIdentityProofingProviderTemplateRequest) String() string {
	return common.PointerString(request)
}

// HTTPRequest implements the OCIRequest interface
func (request PutIdentityProofingProviderTemplateRequest) HTTPRequest(method, path string, binaryRequestBody *common.OCIReadSeekCloser, extraHeaders map[string]string) (http.Request, error) {
...
func (request PutIdentityProofingProviderTemplateRequest) BinaryRequestBody() (*common.OCIReadSeekCloser, bool) {
...
func (request PutIdentityProofingProviderTemplateRequest) RetryPolicy() *common.RetryPolicy {
...
func (request PutIdentityProofingProviderTemplateRequest) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
...
// PutIdentityProofingProviderTemplateResponse wrapper for the PutIdentityProofingProviderTemplate operation
type PutIdentityProofingProviderTemplateResponse struct {
...
func (response PutIdentityProofingProviderTemplateResponse) String() string {
	return common.PointerString(response)
}

// HTTPResponse implements the OCIResponse interface
func (response PutIdentityProofingProviderTemplateResponse) HTTPResponse() *http.Response {

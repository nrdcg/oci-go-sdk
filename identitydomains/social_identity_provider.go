...
type SocialIdentityProvider struct {
	...
	//  - type: boolean
	//  - uniqueness: none
	ShowOnLogin *bool `mandatory:"true" json:"showOnLogin"`
	...
	//  - type: complex
	//  - uniqueness: none
	JitProvAssignedGroups []SocialIdentityProviderJitProvAssignedGroups `mandatory:"false" json:"jitProvAssignedGroups"`
	...
	//  - type: string
	//  - uniqueness: none
	Status SocialIdentityProviderStatusEnum `mandatory:"false" json:"status,omitempty"`
	...
	//  - type: string
	//  - uniqueness: none
	RefreshTokenUrl *string `mandatory:"false" json:"refreshTokenUrl"`
	...
	//  - type: complex
	//  - uniqueness: none
	RelayIdpParamMappings []SocialIdentityProviderRelayIdpParamMappings `mandatory:"false" json:"relayIdpParamMappings"`
}
...
func (m SocialIdentityProvider) ValidateEnumValue() (bool, error) {
	...
	if _, ok := GetMappingSocialIdentityProviderStatusEnum(string(m.Status)); !ok && m.Status != "" {
		errMessage = append(errMessage, fmt.Sprintf("unsupported enum value for Status: %s. Supported values are: %s.", m.Status, strings.Join(GetSocialIdentityProviderStatusEnumStringValues(), ",")))
	}
	if len(errMessage) > 0 {
...
const (
	SocialIdentityProviderStatusCreated SocialIdentityProviderStatusEnum = "created"
	SocialIdentityProviderStatusDeleted SocialIdentityProviderStatusEnum = "deleted"
)

var mappingSocialIdentityProviderStatusEnum = map[string]SocialIdentityProviderStatusEnum{
	"created": SocialIdentityProviderStatusCreated,
	"deleted": SocialIdentityProviderStatusDeleted,
}

var mappingSocialIdentityProviderStatusEnumLowerCase = map[string]SocialIdentityProviderStatusEnum{
	"created": SocialIdentityProviderStatusCreated,
	"deleted": SocialIdentityProviderStatusDeleted,
}
...
func GetSocialIdentityProviderStatusEnumValues() []SocialIdentityProviderStatusEnum {
	values := make([]SocialIdentityProviderStatusEnum, 0)
	for _, v := range mappingSocialIdentityProviderStatusEnum {
...
func GetMappingSocialIdentityProviderStatusEnum(val string) (SocialIdentityProviderStatusEnum, bool) {
	enum, ok := mappingSocialIdentityProviderStatusEnumLowerCase[strings.ToLower(val)]
	return enum, ok
}

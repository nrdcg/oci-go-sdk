...
// PatchIdentityProofingProviderRequest wrapper for the PatchIdentityProofingProvider operation
//
// # See also
//
// Click https://docs.oracle.com/en-us/iaas/tools/go-sdk-examples/latest/identitydomains/PatchIdentityProofingProvider.go.html to see an example of how to use PatchIdentityProofingProviderRequest.
type PatchIdentityProofingProviderRequest struct {
...
func (request PatchIdentityProofingProviderRequest) String() string {
	return common.PointerString(request)
}

// HTTPRequest implements the OCIRequest interface
func (request PatchIdentityProofingProviderRequest) HTTPRequest(method, path string, binaryRequestBody *common.OCIReadSeekCloser, extraHeaders map[string]string) (http.Request, error) {
...
func (request PatchIdentityProofingProviderRequest) BinaryRequestBody() (*common.OCIReadSeekCloser, bool) {
...
func (request PatchIdentityProofingProviderRequest) RetryPolicy() *common.RetryPolicy {
...
func (request PatchIdentityProofingProviderRequest) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
...
// PatchIdentityProofingProviderResponse wrapper for the PatchIdentityProofingProvider operation
type PatchIdentityProofingProviderResponse struct {
...
func (response PatchIdentityProofingProviderResponse) String() string {
	return common.PointerString(response)
}

// HTTPResponse implements the OCIResponse interface
func (response PatchIdentityProofingProviderResponse) HTTPResponse() *http.Response {

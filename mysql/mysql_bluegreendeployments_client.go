...
// # See also
//
// Click https://docs.oracle.com/en-us/iaas/tools/go-sdk-examples/latest/mysql/ChangeBlueGreenDeploymentCompartment.go.html to see an example of how to use ChangeBlueGreenDeploymentCompartment API.
...
// # See also
//
// Click https://docs.oracle.com/en-us/iaas/tools/go-sdk-examples/latest/mysql/CreateBlueGreenDeployment.go.html to see an example of how to use CreateBlueGreenDeployment API.
...
// # See also
//
// Click https://docs.oracle.com/en-us/iaas/tools/go-sdk-examples/latest/mysql/DeleteBlueGreenDeployment.go.html to see an example of how to use DeleteBlueGreenDeployment API.
...
// # See also
//
// Click https://docs.oracle.com/en-us/iaas/tools/go-sdk-examples/latest/mysql/GetBlueGreenDeployment.go.html to see an example of how to use GetBlueGreenDeployment API.
...
// # See also
//
// Click https://docs.oracle.com/en-us/iaas/tools/go-sdk-examples/latest/mysql/ListBlueGreenDeployments.go.html to see an example of how to use ListBlueGreenDeployments API.
...
// # See also
//
// Click https://docs.oracle.com/en-us/iaas/tools/go-sdk-examples/latest/mysql/SwitchoverBlueGreenDeployment.go.html to see an example of how to use SwitchoverBlueGreenDeployment API.
...
// # See also
//
// Click https://docs.oracle.com/en-us/iaas/tools/go-sdk-examples/latest/mysql/UpdateBlueGreenDeployment.go.html to see an example of how to use UpdateBlueGreenDeployment API.

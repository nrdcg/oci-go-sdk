...
// ApproverGroupLevel It represents the group level detail for authorization
type ApproverGroupLevel struct {

	// id of the group.
	GroupId []string `mandatory:"true" json:"groupId"`

	// level of the group.
	GroupLevel *int `mandatory:"true" json:"groupLevel"`
}

func (m ApproverGroupLevel) String() string {
...
func (m ApproverGroupLevel) ValidateEnumValue() (bool, error) {
	errMessage := []string{}

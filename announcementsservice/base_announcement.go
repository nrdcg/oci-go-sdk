...
func (m *baseannouncement) UnmarshalPolymorphicJSON(data []byte) (interface{}, error) {
	...
	case "Announcement":
		...
		return mm, err
	default:
		common.Logf("Received unsupported enum value for BaseAnnouncement: %s.", m.Type)
		return *m, nil
	}
}
...
const (
	...
	BaseAnnouncementPlatformTypePaas BaseAnnouncementPlatformTypeEnum = "PAAS"
)
...
var mappingBaseAnnouncementPlatformTypeEnum = map[string]BaseAnnouncementPlatformTypeEnum{
	...
	"PAAS": BaseAnnouncementPlatformTypePaas,
}

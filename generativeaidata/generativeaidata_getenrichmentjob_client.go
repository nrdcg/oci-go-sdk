...
// NewGetEnrichmentJobClientWithConfigurationProvider Creates a new default GetEnrichmentJob client with the given configuration provider.
...
func NewGetEnrichmentJobClientWithConfigurationProvider(configProvider common.ConfigurationProvider) (client GetEnrichmentJobClient, err error) {
	...
	return newGetEnrichmentJobClientFromBaseClient(baseClient, provider)
}

// NewGetEnrichmentJobClientWithOboToken Creates a new default GetEnrichmentJob client with the given configuration provider.
...
func NewGetEnrichmentJobClientWithOboToken(configProvider common.ConfigurationProvider, oboToken string) (client GetEnrichmentJobClient, err error) {
	...
	return newGetEnrichmentJobClientFromBaseClient(baseClient, configProvider)
}

func newGetEnrichmentJobClientFromBaseClient(baseClient common.BaseClient, configProvider common.ConfigurationProvider) (client GetEnrichmentJobClient, err error) {
	// GetEnrichmentJob service default circuit breaker is enabled
	baseClient.Configuration.CircuitBreaker = common.NewCircuitBreaker(common.DefaultCircuitBreakerSettingWithServiceName("GetEnrichmentJob"))
	common.ConfigCircuitBreakerFromEnvVar(&baseClient)
	common.ConfigCircuitBreakerFromGlobalVar(&baseClient)

	client = GetEnrichmentJobClient{BaseClient: baseClient}
...
func (client *GetEnrichmentJobClient) setConfigurationProvider(configProvider common.ConfigurationProvider) error {
...
func (client GetEnrichmentJobClient) getEnrichmentJob(ctx context.Context, request common.OCIRequest, binaryReqBody *common.OCIReadSeekCloser, extraHeaders map[string]string) (common.OCIResponse, error) {

	httpRequest, err := request.HTTPRequest(http.MethodGet, "/20260325/semanticStores/{semanticStoreId}/enrichmentJobs/{enrichmentJobId}", binaryReqBody, extraHeaders)
	if err != nil {
		return nil, err
	}

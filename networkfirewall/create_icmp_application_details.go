...
func (m CreateIcmpApplicationDetails) GetDescription() *string {
...
func (m CreateIcmpApplicationDetails) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeCreateIcmpApplicationDetails CreateIcmpApplicationDetails
	s := struct {
		DiscriminatorParam string `json:"type"`
		MarshalTypeCreateIcmpApplicationDetails
	}{
		"ICMP",
		(MarshalTypeCreateIcmpApplicationDetails)(m),
	}

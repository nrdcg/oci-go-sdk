...
func (m UpdateSslForwardProxyProfileDetails) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeUpdateSslForwardProxyProfileDetails UpdateSslForwardProxyProfileDetails
	s := struct {
		DiscriminatorParam string `json:"type"`
		MarshalTypeUpdateSslForwardProxyProfileDetails
	}{
		"SSL_FORWARD_PROXY",
		(MarshalTypeUpdateSslForwardProxyProfileDetails)(m),
	}

...
func (m IcmpApplicationSummary) GetDescription() *string {
...
func (m IcmpApplicationSummary) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeIcmpApplicationSummary IcmpApplicationSummary
	s := struct {
		DiscriminatorParam string `json:"type"`
		MarshalTypeIcmpApplicationSummary
	}{
		"ICMP",
		(MarshalTypeIcmpApplicationSummary)(m),
	}

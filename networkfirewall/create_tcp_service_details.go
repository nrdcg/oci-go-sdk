...
func (m CreateTcpServiceDetails) GetDescription() *string {
...
func (m CreateTcpServiceDetails) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeCreateTcpServiceDetails CreateTcpServiceDetails
	s := struct {
		DiscriminatorParam string `json:"type"`
		MarshalTypeCreateTcpServiceDetails
	}{
		"TCP_SERVICE",
		(MarshalTypeCreateTcpServiceDetails)(m),
	}

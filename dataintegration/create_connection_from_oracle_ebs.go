...
func (m CreateConnectionFromOracleEbs) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeCreateConnectionFromOracleEbs CreateConnectionFromOracleEbs
	s := struct {
		DiscriminatorParam string `json:"modelType"`
		MarshalTypeCreateConnectionFromOracleEbs
	}{
		"ORACLE_EBS_CONNECTION",
		(MarshalTypeCreateConnectionFromOracleEbs)(m),
	}

...
func (m ConnectionSummaryFromMySqlHeatWave) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeConnectionSummaryFromMySqlHeatWave ConnectionSummaryFromMySqlHeatWave
	s := struct {
		DiscriminatorParam string `json:"modelType"`
		MarshalTypeConnectionSummaryFromMySqlHeatWave
	}{
		"MYSQL_HEATWAVE_CONNECTION",
		(MarshalTypeConnectionSummaryFromMySqlHeatWave)(m),
	}

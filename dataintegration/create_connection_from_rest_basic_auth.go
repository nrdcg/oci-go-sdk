...
func (m CreateConnectionFromRestBasicAuth) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeCreateConnectionFromRestBasicAuth CreateConnectionFromRestBasicAuth
	s := struct {
		DiscriminatorParam string `json:"modelType"`
		MarshalTypeCreateConnectionFromRestBasicAuth
	}{
		"REST_BASIC_AUTH_CONNECTION",
		(MarshalTypeCreateConnectionFromRestBasicAuth)(m),
	}

...
func (m UpdateDataAssetFromOraclePeopleSoft) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeUpdateDataAssetFromOraclePeopleSoft UpdateDataAssetFromOraclePeopleSoft
	s := struct {
		DiscriminatorParam string `json:"modelType"`
		MarshalTypeUpdateDataAssetFromOraclePeopleSoft
	}{
		"ORACLE_PEOPLESOFT_DATA_ASSET",
		(MarshalTypeUpdateDataAssetFromOraclePeopleSoft)(m),
	}

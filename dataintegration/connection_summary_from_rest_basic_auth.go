...
func (m ConnectionSummaryFromRestBasicAuth) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeConnectionSummaryFromRestBasicAuth ConnectionSummaryFromRestBasicAuth
	s := struct {
		DiscriminatorParam string `json:"modelType"`
		MarshalTypeConnectionSummaryFromRestBasicAuth
	}{
		"REST_BASIC_AUTH_CONNECTION",
		(MarshalTypeConnectionSummaryFromRestBasicAuth)(m),
	}

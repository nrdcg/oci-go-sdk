...
func (m ConnectionFromRestBasicAuthDetails) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeConnectionFromRestBasicAuthDetails ConnectionFromRestBasicAuthDetails
	s := struct {
		DiscriminatorParam string `json:"modelType"`
		MarshalTypeConnectionFromRestBasicAuthDetails
	}{
		"REST_BASIC_AUTH_CONNECTION",
		(MarshalTypeConnectionFromRestBasicAuthDetails)(m),
	}

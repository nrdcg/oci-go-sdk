...
func (m DataEntitySummaryFromObject) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
	if _, ok := GetMappingDataEntitySummaryFromObjectEntityTypeEnum(string(m.EntityType)); !ok && m.EntityType != "" {
		errMessage = append(errMessage, fmt.Sprintf("unsupported enum value for EntityType: %s. Supported values are: %s.", m.EntityType, strings.Join(GetDataEntitySummaryFromObjectEntityTypeEnumStringValues(), ",")))
	}
...
func (m DataEntitySummaryFromObject) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeDataEntitySummaryFromObject DataEntitySummaryFromObject
	s := struct {
		DiscriminatorParam string `json:"modelType"`
		MarshalTypeDataEntitySummaryFromObject
	}{
		"OBJECT_ENTITY",
		(MarshalTypeDataEntitySummaryFromObject)(m),
	}
...
func (m *DataEntitySummaryFromObject) UnmarshalJSON(data []byte) (e error) {
	model := struct {
		...
		EntityType     DataEntitySummaryFromObjectEntityTypeEnum `json:"entityType"`
...
var mappingDataEntitySummaryFromObjectEntityTypeEnum = map[string]DataEntitySummaryFromObjectEntityTypeEnum{
	"TABLE":  DataEntitySummaryFromObjectEntityTypeTable,
	"VIEW":   DataEntitySummaryFromObjectEntityTypeView,
	"FILE":   DataEntitySummaryFromObjectEntityTypeFile,
	"SQL":    DataEntitySummaryFromObjectEntityTypeSql,
	"OBJECT": DataEntitySummaryFromObjectEntityTypeObject,
}

var mappingDataEntitySummaryFromObjectEntityTypeEnumLowerCase = map[string]DataEntitySummaryFromObjectEntityTypeEnum{
	"table":  DataEntitySummaryFromObjectEntityTypeTable,
	"view":   DataEntitySummaryFromObjectEntityTypeView,
	"file":   DataEntitySummaryFromObjectEntityTypeFile,
	"sql":    DataEntitySummaryFromObjectEntityTypeSql,
...
func GetDataEntitySummaryFromObjectEntityTypeEnumValues() []DataEntitySummaryFromObjectEntityTypeEnum {
	values := make([]DataEntitySummaryFromObjectEntityTypeEnum, 0)
	for _, v := range mappingDataEntitySummaryFromObjectEntityTypeEnum {
...
func GetMappingDataEntitySummaryFromObjectEntityTypeEnum(val string) (DataEntitySummaryFromObjectEntityTypeEnum, bool) {
	enum, ok := mappingDataEntitySummaryFromObjectEntityTypeEnumLowerCase[strings.ToLower(val)]
	return enum, ok
}

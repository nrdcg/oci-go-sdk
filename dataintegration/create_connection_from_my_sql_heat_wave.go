...
func (m CreateConnectionFromMySqlHeatWave) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeCreateConnectionFromMySqlHeatWave CreateConnectionFromMySqlHeatWave
	s := struct {
		DiscriminatorParam string `json:"modelType"`
		MarshalTypeCreateConnectionFromMySqlHeatWave
	}{
		"MYSQL_HEATWAVE_CONNECTION",
		(MarshalTypeCreateConnectionFromMySqlHeatWave)(m),
	}

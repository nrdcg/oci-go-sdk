...
func (m CreateConnectionFromOraclePeopleSoft) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeCreateConnectionFromOraclePeopleSoft CreateConnectionFromOraclePeopleSoft
	s := struct {
		DiscriminatorParam string `json:"modelType"`
		MarshalTypeCreateConnectionFromOraclePeopleSoft
	}{
		"ORACLE_PEOPLESOFT_CONNECTION",
		(MarshalTypeCreateConnectionFromOraclePeopleSoft)(m),
	}

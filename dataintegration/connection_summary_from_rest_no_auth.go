...
func (m ConnectionSummaryFromRestNoAuth) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeConnectionSummaryFromRestNoAuth ConnectionSummaryFromRestNoAuth
	s := struct {
		DiscriminatorParam string `json:"modelType"`
		MarshalTypeConnectionSummaryFromRestNoAuth
	}{
		"REST_NO_AUTH_CONNECTION",
		(MarshalTypeConnectionSummaryFromRestNoAuth)(m),
	}

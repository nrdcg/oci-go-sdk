...
func (m UpdateDataAssetFromOracleSiebel) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeUpdateDataAssetFromOracleSiebel UpdateDataAssetFromOracleSiebel
	s := struct {
		DiscriminatorParam string `json:"modelType"`
		MarshalTypeUpdateDataAssetFromOracleSiebel
	}{
		"ORACLE_SIEBEL_DATA_ASSET",
		(MarshalTypeUpdateDataAssetFromOracleSiebel)(m),
	}

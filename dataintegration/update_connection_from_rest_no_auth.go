...
func (m UpdateConnectionFromRestNoAuth) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeUpdateConnectionFromRestNoAuth UpdateConnectionFromRestNoAuth
	s := struct {
		DiscriminatorParam string `json:"modelType"`
		MarshalTypeUpdateConnectionFromRestNoAuth
	}{
		"REST_NO_AUTH_CONNECTION",
		(MarshalTypeUpdateConnectionFromRestNoAuth)(m),
	}

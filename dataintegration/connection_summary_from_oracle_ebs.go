...
func (m ConnectionSummaryFromOracleEbs) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeConnectionSummaryFromOracleEbs ConnectionSummaryFromOracleEbs
	s := struct {
		DiscriminatorParam string `json:"modelType"`
		MarshalTypeConnectionSummaryFromOracleEbs
	}{
		"ORACLE_EBS_CONNECTION",
		(MarshalTypeConnectionSummaryFromOracleEbs)(m),
	}

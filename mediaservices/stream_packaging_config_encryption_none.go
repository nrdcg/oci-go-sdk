...
func (m StreamPackagingConfigEncryptionNone) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeStreamPackagingConfigEncryptionNone StreamPackagingConfigEncryptionNone
	s := struct {
		DiscriminatorParam string `json:"algorithm"`
		MarshalTypeStreamPackagingConfigEncryptionNone
	}{
		"NONE",
		(MarshalTypeStreamPackagingConfigEncryptionNone)(m),
	}

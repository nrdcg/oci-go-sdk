...
func (request ListStreamCdnConfigsRequest) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
	if _, ok := GetMappingStreamCdnConfigLifecycleStateEnum(string(request.LifecycleState)); !ok && request.LifecycleState != "" {
		errMessage = append(errMessage, fmt.Sprintf("unsupported enum value for LifecycleState: %s. Supported values are: %s.", request.LifecycleState, strings.Join(GetStreamCdnConfigLifecycleStateEnumStringValues(), ",")))
	}
	if _, ok := GetMappingListStreamCdnConfigsSortOrderEnum(string(request.SortOrder)); !ok && request.SortOrder != "" {
		errMessage = append(errMessage, fmt.Sprintf("unsupported enum value for SortOrder: %s. Supported values are: %s.", request.SortOrder, strings.Join(GetListStreamCdnConfigsSortOrderEnumStringValues(), ",")))
	}
	if _, ok := GetMappingListStreamCdnConfigsSortByEnum(string(request.SortBy)); !ok && request.SortBy != "" {
		errMessage = append(errMessage, fmt.Sprintf("unsupported enum value for SortBy: %s. Supported values are: %s.", request.SortBy, strings.Join(GetListStreamCdnConfigsSortByEnumStringValues(), ",")))
	}
	if len(errMessage) > 0 {
...
var mappingListStreamCdnConfigsSortOrderEnum = map[string]ListStreamCdnConfigsSortOrderEnum{
	"ASC":  ListStreamCdnConfigsSortOrderAsc,
	"DESC": ListStreamCdnConfigsSortOrderDesc,
}

var mappingListStreamCdnConfigsSortOrderEnumLowerCase = map[string]ListStreamCdnConfigsSortOrderEnum{
	"asc":  ListStreamCdnConfigsSortOrderAsc,
	"desc": ListStreamCdnConfigsSortOrderDesc,
}
...
func GetListStreamCdnConfigsSortOrderEnumValues() []ListStreamCdnConfigsSortOrderEnum {
	values := make([]ListStreamCdnConfigsSortOrderEnum, 0)
	for _, v := range mappingListStreamCdnConfigsSortOrderEnum {
...
func GetMappingListStreamCdnConfigsSortOrderEnum(val string) (ListStreamCdnConfigsSortOrderEnum, bool) {
	enum, ok := mappingListStreamCdnConfigsSortOrderEnumLowerCase[strings.ToLower(val)]
	return enum, ok
}
...
var mappingListStreamCdnConfigsSortByEnum = map[string]ListStreamCdnConfigsSortByEnum{
	"timeCreated": ListStreamCdnConfigsSortByTimecreated,
	"displayName": ListStreamCdnConfigsSortByDisplayname,
}

var mappingListStreamCdnConfigsSortByEnumLowerCase = map[string]ListStreamCdnConfigsSortByEnum{
	"timecreated": ListStreamCdnConfigsSortByTimecreated,
	"displayname": ListStreamCdnConfigsSortByDisplayname,
}
...
func GetListStreamCdnConfigsSortByEnumValues() []ListStreamCdnConfigsSortByEnum {
	values := make([]ListStreamCdnConfigsSortByEnum, 0)
	for _, v := range mappingListStreamCdnConfigsSortByEnum {
		values = append(values, v)
	}
	return values
}
...
func GetMappingListStreamCdnConfigsSortByEnum(val string) (ListStreamCdnConfigsSortByEnum, bool) {
	enum, ok := mappingListStreamCdnConfigsSortByEnumLowerCase[strings.ToLower(val)]
	return enum, ok
}

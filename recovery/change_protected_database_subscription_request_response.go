...
type ChangeProtectedDatabaseSubscriptionRequest struct {
	...
	ChangeProtectedDatabaseSubscriptionDetails `contributesTo:"body"`
...
type ChangeProtectedDatabaseSubscriptionResponse struct {

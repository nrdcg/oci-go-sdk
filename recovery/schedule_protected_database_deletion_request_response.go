...
type ScheduleProtectedDatabaseDeletionRequest struct {
	...
	ScheduleProtectedDatabaseDeletionDetails `contributesTo:"body"`
...
type ScheduleProtectedDatabaseDeletionResponse struct {

...
// CreateCrossTenancyDisasterRecoveryDetails The following are the details necessary to create a cross-tenancy disaster recovery (DR) association for an existing Autonomous AI Database. This may be in the same region, or in another.
// *IMPORTANT*
...
func (m CreateCrossTenancyDisasterRecoveryDetails) GetAvailabilityDomain() *string {
...
func (m CreateCrossTenancyDisasterRecoveryDetails) GetAutonomousDatabaseMaintenanceWindow() *AutonomousDatabaseMaintenanceWindowSummary {
...
func (m *CreateCrossTenancyDisasterRecoveryDetails) UnmarshalJSON(data []byte) (e error) {
	model := struct {
		...
		DisasterRecoveryType                     DisasterRecoveryConfigurationDisasterRecoveryTypeEnum             `json:"disasterRecoveryType"`
	}{}
	...
	m.DisasterRecoveryType = model.DisasterRecoveryType

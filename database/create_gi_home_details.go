...
// CreateGiHomeDetails Details for creating a Grid Infrastructure Home.
// **Warning:** Oracle recommends that you avoid using any confidential information when you supply string values using the API.
type CreateGiHomeDetails struct {

	// The grid infrastructure home image OCID (https://docs.oracle.com/iaas/Content/General/Concepts/identifiers.htm)
	GiImageId *string `mandatory:"true" json:"giImageId"`
...
func (m CreateGiHomeDetails) String() string {
...
func (m CreateGiHomeDetails) ValidateEnumValue() (bool, error) {
	errMessage := []string{}

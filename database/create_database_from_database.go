...
// CreateDatabaseFromDatabase Details for creating a database by restoring from a database backup closest to given timestamp. This would work only if given timestamp is within the time range of available automatic backups.
...
func (m CreateDatabaseFromDatabase) ValidateEnumValue() (bool, error) {
	errMessage := []string{}

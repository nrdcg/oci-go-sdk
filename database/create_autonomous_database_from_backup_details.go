...
// CreateAutonomousDatabaseFromBackupDetails Details to create an Oracle Autonomous AI Database by cloning from a backup of an existing Autonomous AI Database.
...
func (m CreateAutonomousDatabaseFromBackupDetails) GetAvailabilityDomain() *string {
...
func (m CreateAutonomousDatabaseFromBackupDetails) GetAutonomousDatabaseMaintenanceWindow() *AutonomousDatabaseMaintenanceWindowSummary {

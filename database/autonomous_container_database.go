...
const (
	...
	AutonomousContainerDatabaseNetServicesArchitectureDrcp      AutonomousContainerDatabaseNetServicesArchitectureEnum = "DRCP"
)
...
var mappingAutonomousContainerDatabaseNetServicesArchitectureEnum = map[string]AutonomousContainerDatabaseNetServicesArchitectureEnum{
	...
	"DRCP":      AutonomousContainerDatabaseNetServicesArchitectureDrcp,
}

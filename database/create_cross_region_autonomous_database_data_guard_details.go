...
// CreateCrossRegionAutonomousDatabaseDataGuardDetails Details to create an Autonomous Data Guard association for an existing Autonomous AI Database where the standby is in a different (remote) region from the source primary database.
// *IMPORTANT*
...
func (m CreateCrossRegionAutonomousDatabaseDataGuardDetails) GetAvailabilityDomain() *string {
...
func (m CreateCrossRegionAutonomousDatabaseDataGuardDetails) GetAutonomousDatabaseMaintenanceWindow() *AutonomousDatabaseMaintenanceWindowSummary {

...
// CreateAutonomousDatabaseDetails Details to create an Oracle Autonomous AI Database.
...
func (m CreateAutonomousDatabaseDetails) GetAvailabilityDomain() *string {
...
func (m CreateAutonomousDatabaseDetails) GetTransportableTablespace() *ImportTransportableTablespaceDetails {

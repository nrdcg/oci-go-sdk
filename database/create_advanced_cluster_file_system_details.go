...
// CreateAdvancedClusterFileSystemDetails Request to create an advanced cluster file system resource for a vm cluster resource.
type CreateAdvancedClusterFileSystemDetails struct {
...
func (m CreateAdvancedClusterFileSystemDetails) String() string {
...
func (m CreateAdvancedClusterFileSystemDetails) ValidateEnumValue() (bool, error) {
	errMessage := []string{}

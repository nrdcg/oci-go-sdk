...
// AutonomousDwDatabase An Oracle Autonomous AI Database.
...
const (
	...
	AutonomousDwDatabaseLifecycleStateTransporting            AutonomousDwDatabaseLifecycleStateEnum = "TRANSPORTING"
)
...
var mappingAutonomousDwDatabaseLifecycleStateEnum = map[string]AutonomousDwDatabaseLifecycleStateEnum{
	...
	"TRANSPORTING":              AutonomousDwDatabaseLifecycleStateTransporting,
}
...
const (
	...
	AutonomousDwDatabaseDbWorkloadLh   AutonomousDwDatabaseDbWorkloadEnum = "LH"
)
...
var mappingAutonomousDwDatabaseDbWorkloadEnum = map[string]AutonomousDwDatabaseDbWorkloadEnum{
	...
	"LH":   AutonomousDwDatabaseDbWorkloadLh,
}

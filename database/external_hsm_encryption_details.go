...
func (m ExternalHsmEncryptionDetails) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeExternalHsmEncryptionDetails ExternalHsmEncryptionDetails
	s := struct {
		DiscriminatorParam string `json:"providerType"`
		MarshalTypeExternalHsmEncryptionDetails
	}{
		"EXTERNAL",
		(MarshalTypeExternalHsmEncryptionDetails)(m),
	}

...
// UndeleteAutonomousDatabaseDetails Details to undelete an Oracle Autonomous AI Database.
...
func (m UndeleteAutonomousDatabaseDetails) GetAvailabilityDomain() *string {
...
func (m UndeleteAutonomousDatabaseDetails) GetAutonomousDatabaseMaintenanceWindow() *AutonomousDatabaseMaintenanceWindowSummary {
...
func (m UndeleteAutonomousDatabaseDetails) GetTransportableTablespace() *ImportTransportableTablespaceDetails {
...
func (m UndeleteAutonomousDatabaseDetails) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeUndeleteAutonomousDatabaseDetails UndeleteAutonomousDatabaseDetails
	s := struct {
		DiscriminatorParam string `json:"source"`
		MarshalTypeUndeleteAutonomousDatabaseDetails
	}{
		"UNDELETE_ADB",
		(MarshalTypeUndeleteAutonomousDatabaseDetails)(m),
	}

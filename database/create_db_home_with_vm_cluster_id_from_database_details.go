...
// CreateDbHomeWithVmClusterIdFromDatabaseDetails Note that a valid `vmClusterId` value must be supplied for the `CreateDbHomeWithDVmClusterIdFromDatabase` API operation to successfully complete.
...
func (m CreateDbHomeWithVmClusterIdFromDatabaseDetails) GetDatabaseSoftwareImageId() *string {
	return m.DatabaseSoftwareImageId
}

// GetFreeformTags returns FreeformTags
func (m CreateDbHomeWithVmClusterIdFromDatabaseDetails) GetFreeformTags() map[string]string {
	return m.FreeformTags
}

// GetDefinedTags returns DefinedTags
func (m CreateDbHomeWithVmClusterIdFromDatabaseDetails) GetDefinedTags() map[string]map[string]interface{} {
	return m.DefinedTags
}

// GetIsDesupportedVersion returns IsDesupportedVersion
func (m CreateDbHomeWithVmClusterIdFromDatabaseDetails) GetIsDesupportedVersion() *bool {
	return m.IsDesupportedVersion
}

// GetIsUnifiedAuditingEnabled returns IsUnifiedAuditingEnabled
func (m CreateDbHomeWithVmClusterIdFromDatabaseDetails) GetIsUnifiedAuditingEnabled() *bool {
...
func (m CreateDbHomeWithVmClusterIdFromDatabaseDetails) ValidateEnumValue() (bool, error) {
	errMessage := []string{}

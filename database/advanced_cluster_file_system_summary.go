...
// AdvancedClusterFileSystemSummary Details of an advanced cluster file system.
type AdvancedClusterFileSystemSummary struct {
...
func (m AdvancedClusterFileSystemSummary) String() string {
...
func (m AdvancedClusterFileSystemSummary) ValidateEnumValue() (bool, error) {
	errMessage := []string{}

...
// UpdateDbConnectionBundleDetails The details for updating a database connection bundle.
type UpdateDbConnectionBundleDetails struct {
...
func (m UpdateDbConnectionBundleDetails) String() string {
...
func (m UpdateDbConnectionBundleDetails) ValidateEnumValue() (bool, error) {
	errMessage := []string{}

...
// CreateAutonomousDatabaseCloneDetails Details to create an Oracle Autonomous AI Database by cloning an existing Autonomous AI Database.
...
func (m CreateAutonomousDatabaseCloneDetails) GetAvailabilityDomain() *string {
...
func (m CreateAutonomousDatabaseCloneDetails) GetAutonomousDatabaseMaintenanceWindow() *AutonomousDatabaseMaintenanceWindowSummary {

...
type ImportTransportableTablespaceDetails struct {
	...
	TtsBundleUrl *string `mandatory:"true" json:"ttsBundleUrl"`
}

func (m ImportTransportableTablespaceDetails) String() string {
...
func (m ImportTransportableTablespaceDetails) ValidateEnumValue() (bool, error) {
	errMessage := []string{}

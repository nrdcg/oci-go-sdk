...
// CreateAutonomousDatabaseFromBackupTimestampDetails Details to create a point-in-time clone of an Oracle Autonomous AI Database by specifying a timestamp. Point-in-time clones use backups as the source of the data for the clone.
...
func (m CreateAutonomousDatabaseFromBackupTimestampDetails) GetAvailabilityDomain() *string {
...
func (m CreateAutonomousDatabaseFromBackupTimestampDetails) GetAutonomousDatabaseMaintenanceWindow() *AutonomousDatabaseMaintenanceWindowSummary {

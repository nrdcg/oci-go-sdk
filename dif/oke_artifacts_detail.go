...
// OkeArtifactsDetail Detail to deploy artifacts for OKE service.
type OkeArtifactsDetail struct {
...
func (m OkeArtifactsDetail) String() string {
...
func (m OkeArtifactsDetail) ValidateEnumValue() (bool, error) {
	errMessage := []string{}

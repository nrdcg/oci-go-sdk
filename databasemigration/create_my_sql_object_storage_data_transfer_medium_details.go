...
func (m CreateMySqlObjectStorageDataTransferMediumDetails) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeCreateMySqlObjectStorageDataTransferMediumDetails CreateMySqlObjectStorageDataTransferMediumDetails
	s := struct {
		DiscriminatorParam string `json:"type"`
		MarshalTypeCreateMySqlObjectStorageDataTransferMediumDetails
	}{
		"OBJECT_STORAGE",
		(MarshalTypeCreateMySqlObjectStorageDataTransferMediumDetails)(m),
	}

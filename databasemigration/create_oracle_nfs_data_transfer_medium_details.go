...
func (m CreateOracleNfsDataTransferMediumDetails) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeCreateOracleNfsDataTransferMediumDetails CreateOracleNfsDataTransferMediumDetails
	s := struct {
		DiscriminatorParam string `json:"type"`
		MarshalTypeCreateOracleNfsDataTransferMediumDetails
	}{
		"NFS",
		(MarshalTypeCreateOracleNfsDataTransferMediumDetails)(m),
	}

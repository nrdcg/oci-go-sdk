...
// UpdateOracleAwsS3DataTransferMediumDetails AWS S3 bucket details used for source Connection resources with RDS_ORACLE type.
...
func (m UpdateOracleAwsS3DataTransferMediumDetails) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeUpdateOracleAwsS3DataTransferMediumDetails UpdateOracleAwsS3DataTransferMediumDetails
	s := struct {
		DiscriminatorParam string `json:"type"`
		MarshalTypeUpdateOracleAwsS3DataTransferMediumDetails
	}{
		"AWS_S3",
		(MarshalTypeUpdateOracleAwsS3DataTransferMediumDetails)(m),
	}

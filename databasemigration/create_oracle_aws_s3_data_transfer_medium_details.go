...
// CreateOracleAwsS3DataTransferMediumDetails AWS S3 bucket details used for source Connection resources with RDS_ORACLE type.
...
func (m CreateOracleAwsS3DataTransferMediumDetails) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeCreateOracleAwsS3DataTransferMediumDetails CreateOracleAwsS3DataTransferMediumDetails
	s := struct {
		DiscriminatorParam string `json:"type"`
		MarshalTypeCreateOracleAwsS3DataTransferMediumDetails
	}{
		"AWS_S3",
		(MarshalTypeCreateOracleAwsS3DataTransferMediumDetails)(m),
	}

...
func (m UpdateOracleObjectStorageDataTransferMediumDetails) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeUpdateOracleObjectStorageDataTransferMediumDetails UpdateOracleObjectStorageDataTransferMediumDetails
	s := struct {
		DiscriminatorParam string `json:"type"`
		MarshalTypeUpdateOracleObjectStorageDataTransferMediumDetails
	}{
		"OBJECT_STORAGE",
		(MarshalTypeUpdateOracleObjectStorageDataTransferMediumDetails)(m),
	}

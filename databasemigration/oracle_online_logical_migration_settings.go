...
// OracleOnlineLogicalMigrationSettings Oracle online logical migration settings.
type OracleOnlineLogicalMigrationSettings struct {
...
func (m OracleOnlineLogicalMigrationSettings) String() string {
...
func (m OracleOnlineLogicalMigrationSettings) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
...
func (m OracleOnlineLogicalMigrationSettings) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeOracleOnlineLogicalMigrationSettings OracleOnlineLogicalMigrationSettings
	s := struct {
		DiscriminatorParam string `json:"migrationMethod"`
		MarshalTypeOracleOnlineLogicalMigrationSettings
	}{
		"ONLINE_LOGICAL",
		(MarshalTypeOracleOnlineLogicalMigrationSettings)(m),
	}
...
func (m *OracleOnlineLogicalMigrationSettings) UnmarshalJSON(data []byte) (e error) {
	model := struct {

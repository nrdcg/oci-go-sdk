...
// OracleAssessment Oracle Assessment resource
type OracleAssessment struct {
	...
	IsCdbSupported *bool `mandatory:"false" json:"isCdbSupported"`
...
// GetId returns Id
func (m OracleAssessment) GetId() *string {
	return m.Id
}

// GetDescription returns Description
func (m OracleAssessment) GetDescription() *string {
	return m.Description
}

// GetDisplayName returns DisplayName
func (m OracleAssessment) GetDisplayName() *string {
	return m.DisplayName
}

// GetCompartmentId returns CompartmentId
func (m OracleAssessment) GetCompartmentId() *string {
	return m.CompartmentId
}

// GetNetworkSpeedMegabitPerSecond returns NetworkSpeedMegabitPerSecond
func (m OracleAssessment) GetNetworkSpeedMegabitPerSecond() NetworkSpeedMegabitPerSecondEnum {
	return m.NetworkSpeedMegabitPerSecond
}

// GetAcceptableDowntime returns AcceptableDowntime
func (m OracleAssessment) GetAcceptableDowntime() AcceptableDowntimeEnum {
	return m.AcceptableDowntime
}

// GetDatabaseDataSize returns DatabaseDataSize
func (m OracleAssessment) GetDatabaseDataSize() DatabaseDataSizeEnum {
	return m.DatabaseDataSize
}

// GetDdlExpectation returns DdlExpectation
func (m OracleAssessment) GetDdlExpectation() DdlExpectationEnum {
	return m.DdlExpectation
}

// GetCreationType returns CreationType
func (m OracleAssessment) GetCreationType() CreationTypeEnum {
	return m.CreationType
}

// GetMigrationId returns MigrationId
func (m OracleAssessment) GetMigrationId() *string {
	return m.MigrationId
}

// GetSourceDatabaseConnection returns SourceDatabaseConnection
func (m OracleAssessment) GetSourceDatabaseConnection() *SourceAssessmentConnection {
...
func (m OracleAssessment) GetLifecycleState() AssessmentLifecycleStatesEnum {
	return m.LifecycleState
}

// GetAssessmentMigrationType returns AssessmentMigrationType
func (m OracleAssessment) GetAssessmentMigrationType() AssessmentMigrationTypesEnum {
	return m.AssessmentMigrationType
}

// GetTimeCreated returns TimeCreated
func (m OracleAssessment) GetTimeCreated() *common.SDKTime {
	return m.TimeCreated
}

// GetTimeUpdated returns TimeUpdated
func (m OracleAssessment) GetTimeUpdated() *common.SDKTime {
	return m.TimeUpdated
}

// GetFreeformTags returns FreeformTags
func (m OracleAssessment) GetFreeformTags() map[string]string {
	return m.FreeformTags
}

// GetDefinedTags returns DefinedTags
func (m OracleAssessment) GetDefinedTags() map[string]map[string]interface{} {
	return m.DefinedTags
}

// GetSystemTags returns SystemTags
func (m OracleAssessment) GetSystemTags() map[string]map[string]interface{} {
	return m.SystemTags
}

func (m OracleAssessment) String() string {
...
func (m OracleAssessment) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
...
func (m OracleAssessment) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeOracleAssessment OracleAssessment
	s := struct {
		DiscriminatorParam string `json:"databaseCombination"`
		MarshalTypeOracleAssessment
	}{
		"ORACLE",
		(MarshalTypeOracleAssessment)(m),
	}

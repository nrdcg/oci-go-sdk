...
// DatabaseConnectionTypeSummary Connection type e.g. ORACLE and array of technology type objects.
type DatabaseConnectionTypeSummary struct {
	...
	TechnologyTypes []DatabaseTechnologyType `mandatory:"false" json:"technologyTypes"`
}

func (m DatabaseConnectionTypeSummary) String() string {
...
func (m DatabaseConnectionTypeSummary) ValidateEnumValue() (bool, error) {
	errMessage := []string{}

...
// CreateOracleOnlineLogicalMigrationSettings Create settings for an online logical Oracle migration.
type CreateOracleOnlineLogicalMigrationSettings struct {
...
func (m CreateOracleOnlineLogicalMigrationSettings) String() string {
...
func (m CreateOracleOnlineLogicalMigrationSettings) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
...
func (m CreateOracleOnlineLogicalMigrationSettings) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeCreateOracleOnlineLogicalMigrationSettings CreateOracleOnlineLogicalMigrationSettings
	s := struct {
		DiscriminatorParam string `json:"migrationMethod"`
		MarshalTypeCreateOracleOnlineLogicalMigrationSettings
	}{
		"ONLINE_LOGICAL",
		(MarshalTypeCreateOracleOnlineLogicalMigrationSettings)(m),
	}
...
func (m *CreateOracleOnlineLogicalMigrationSettings) UnmarshalJSON(data []byte) (e error) {
	model := struct {

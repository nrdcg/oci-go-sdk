...
// UpdateMySqlAssessmentDetails Update MySql Assessment resource parameters.
type UpdateMySqlAssessmentDetails struct {
	...
	MigrationScope MigrationScopeMySqlEnum `mandatory:"false" json:"migrationScope,omitempty"`
}

// GetDescription returns Description
func (m UpdateMySqlAssessmentDetails) GetDescription() *string {
	return m.Description
}

// GetDisplayName returns DisplayName
func (m UpdateMySqlAssessmentDetails) GetDisplayName() *string {
	return m.DisplayName
}

// GetNetworkSpeedMegabitPerSecond returns NetworkSpeedMegabitPerSecond
func (m UpdateMySqlAssessmentDetails) GetNetworkSpeedMegabitPerSecond() NetworkSpeedMegabitPerSecondEnum {
	return m.NetworkSpeedMegabitPerSecond
}

// GetAcceptableDowntime returns AcceptableDowntime
func (m UpdateMySqlAssessmentDetails) GetAcceptableDowntime() AcceptableDowntimeEnum {
	return m.AcceptableDowntime
}

// GetDatabaseDataSize returns DatabaseDataSize
func (m UpdateMySqlAssessmentDetails) GetDatabaseDataSize() DatabaseDataSizeEnum {
	return m.DatabaseDataSize
}

// GetDdlExpectation returns DdlExpectation
func (m UpdateMySqlAssessmentDetails) GetDdlExpectation() DdlExpectationEnum {
	return m.DdlExpectation
}

// GetCreationType returns CreationType
func (m UpdateMySqlAssessmentDetails) GetCreationType() CreationTypeEnum {
	return m.CreationType
}

// GetSourceDatabaseConnection returns SourceDatabaseConnection
func (m UpdateMySqlAssessmentDetails) GetSourceDatabaseConnection() *SourceAssessmentConnection {
...
func (m UpdateMySqlAssessmentDetails) GetFreeformTags() map[string]string {
	return m.FreeformTags
}

// GetDefinedTags returns DefinedTags
func (m UpdateMySqlAssessmentDetails) GetDefinedTags() map[string]map[string]interface{} {
	return m.DefinedTags
}

func (m UpdateMySqlAssessmentDetails) String() string {
...
func (m UpdateMySqlAssessmentDetails) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
...
func (m UpdateMySqlAssessmentDetails) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeUpdateMySqlAssessmentDetails UpdateMySqlAssessmentDetails
	s := struct {
		DiscriminatorParam string `json:"databaseCombination"`
		MarshalTypeUpdateMySqlAssessmentDetails
	}{
		"MYSQL",
		(MarshalTypeUpdateMySqlAssessmentDetails)(m),
	}

...
func (m OracleDbLinkDataTransferMediumDetails) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeOracleDbLinkDataTransferMediumDetails OracleDbLinkDataTransferMediumDetails
	s := struct {
		DiscriminatorParam string `json:"type"`
		MarshalTypeOracleDbLinkDataTransferMediumDetails
	}{
		"DBLINK",
		(MarshalTypeOracleDbLinkDataTransferMediumDetails)(m),
	}

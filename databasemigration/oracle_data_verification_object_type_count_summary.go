...
// OracleDataVerificationObjectTypeCountSummary Object type count comparison summary line for Oracle migrations.
type OracleDataVerificationObjectTypeCountSummary struct {
...
func (m OracleDataVerificationObjectTypeCountSummary) GetSchemaName() *string {
	return m.SchemaName
}

// GetSourceObjectCount returns SourceObjectCount
func (m OracleDataVerificationObjectTypeCountSummary) GetSourceObjectCount() *int {
	return m.SourceObjectCount
}

// GetTargetObjectCount returns TargetObjectCount
func (m OracleDataVerificationObjectTypeCountSummary) GetTargetObjectCount() *int {
	return m.TargetObjectCount
}

// GetDeltaPercent returns DeltaPercent
func (m OracleDataVerificationObjectTypeCountSummary) GetDeltaPercent() *float64 {
	return m.DeltaPercent
}

func (m OracleDataVerificationObjectTypeCountSummary) String() string {
...
func (m OracleDataVerificationObjectTypeCountSummary) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
...
func (m OracleDataVerificationObjectTypeCountSummary) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeOracleDataVerificationObjectTypeCountSummary OracleDataVerificationObjectTypeCountSummary
	s := struct {
		DiscriminatorParam string `json:"databaseCombination"`
		MarshalTypeOracleDataVerificationObjectTypeCountSummary
	}{
		"ORACLE",
		(MarshalTypeOracleDataVerificationObjectTypeCountSummary)(m),
	}

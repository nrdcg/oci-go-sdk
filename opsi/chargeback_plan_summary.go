...
// ChargebackPlanSummary Summary of a Ops Insights chargeback plan.
type ChargebackPlanSummary struct {
	...
	EntitySource ChargebackPlanEntitySourceEnum `mandatory:"true" json:"entitySource"`
	...
	PlanCustomItems []CreatePlanCustomItemDetails `mandatory:"true" json:"planCustomItems"`
...
func (m ChargebackPlanSummary) String() string {
...
func (m ChargebackPlanSummary) ValidateEnumValue() (bool, error) {
	errMessage := []string{}

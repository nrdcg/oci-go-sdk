...
type ChangeMacsManagedCloudDatabaseInsightConnectionRequest struct {

	// Unique database insight identifier
	DatabaseInsightId *string `mandatory:"true" contributesTo:"path" name:"databaseInsightId"`

	// The information to be updated.
	ChangeMacsManagedCloudDatabaseInsightConnectionDetails `contributesTo:"body"`
...
type ChangeMacsManagedCloudDatabaseInsightConnectionResponse struct {

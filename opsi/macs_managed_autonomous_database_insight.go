...
// MacsManagedAutonomousDatabaseInsight Database insight resource.
type MacsManagedAutonomousDatabaseInsight struct {
...
// GetId returns Id
func (m MacsManagedAutonomousDatabaseInsight) GetId() *string {
	return m.Id
}

// GetCompartmentId returns CompartmentId
func (m MacsManagedAutonomousDatabaseInsight) GetCompartmentId() *string {
	return m.CompartmentId
}

// GetStatus returns Status
func (m MacsManagedAutonomousDatabaseInsight) GetStatus() ResourceStatusEnum {
	return m.Status
}

// GetDatabaseType returns DatabaseType
func (m MacsManagedAutonomousDatabaseInsight) GetDatabaseType() *string {
	return m.DatabaseType
}

// GetDatabaseVersion returns DatabaseVersion
func (m MacsManagedAutonomousDatabaseInsight) GetDatabaseVersion() *string {
	return m.DatabaseVersion
}

// GetProcessorCount returns ProcessorCount
func (m MacsManagedAutonomousDatabaseInsight) GetProcessorCount() *int {
	return m.ProcessorCount
}

// GetFreeformTags returns FreeformTags
func (m MacsManagedAutonomousDatabaseInsight) GetFreeformTags() map[string]string {
	return m.FreeformTags
}

// GetDefinedTags returns DefinedTags
func (m MacsManagedAutonomousDatabaseInsight) GetDefinedTags() map[string]map[string]interface{} {
	return m.DefinedTags
}

// GetSystemTags returns SystemTags
func (m MacsManagedAutonomousDatabaseInsight) GetSystemTags() map[string]map[string]interface{} {
	return m.SystemTags
}

// GetTimeCreated returns TimeCreated
func (m MacsManagedAutonomousDatabaseInsight) GetTimeCreated() *common.SDKTime {
	return m.TimeCreated
}

// GetTimeUpdated returns TimeUpdated
func (m MacsManagedAutonomousDatabaseInsight) GetTimeUpdated() *common.SDKTime {
	return m.TimeUpdated
}

// GetLifecycleState returns LifecycleState
func (m MacsManagedAutonomousDatabaseInsight) GetLifecycleState() LifecycleStateEnum {
	return m.LifecycleState
}

// GetLifecycleDetails returns LifecycleDetails
func (m MacsManagedAutonomousDatabaseInsight) GetLifecycleDetails() *string {
	return m.LifecycleDetails
}

// GetDatabaseConnectionStatusDetails returns DatabaseConnectionStatusDetails
func (m MacsManagedAutonomousDatabaseInsight) GetDatabaseConnectionStatusDetails() *string {
	return m.DatabaseConnectionStatusDetails
}

func (m MacsManagedAutonomousDatabaseInsight) String() string {
...
func (m MacsManagedAutonomousDatabaseInsight) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
...
func (m MacsManagedAutonomousDatabaseInsight) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeMacsManagedAutonomousDatabaseInsight MacsManagedAutonomousDatabaseInsight
	s := struct {
		DiscriminatorParam string `json:"entitySource"`
		MarshalTypeMacsManagedAutonomousDatabaseInsight
	}{
		"MACS_MANAGED_AUTONOMOUS_DATABASE",
		(MarshalTypeMacsManagedAutonomousDatabaseInsight)(m),
	}
...
func (m *MacsManagedAutonomousDatabaseInsight) UnmarshalJSON(data []byte) (e error) {
	model := struct {

...
// UpdateChargebackPlanReportDetails The details used to update a Ops Insights chargeback plan report.
...
func (m UpdateChargebackPlanReportDetails) ValidateEnumValue() (bool, error) {
	errMessage := []string{}

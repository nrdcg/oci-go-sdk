...
type ChangeExternalMysqlDatabaseInsightConnectionRequest struct {

	// Unique database insight identifier
	DatabaseInsightId *string `mandatory:"true" contributesTo:"path" name:"databaseInsightId"`

	// The information to be updated.
	ChangeExternalMysqlDatabaseInsightConnectionDetails `contributesTo:"body"`
...
type ChangeExternalMysqlDatabaseInsightConnectionResponse struct {

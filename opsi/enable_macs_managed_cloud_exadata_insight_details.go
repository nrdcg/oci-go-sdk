...
func (m EnableMacsManagedCloudExadataInsightDetails) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeEnableMacsManagedCloudExadataInsightDetails EnableMacsManagedCloudExadataInsightDetails
	s := struct {
		DiscriminatorParam string `json:"entitySource"`
		MarshalTypeEnableMacsManagedCloudExadataInsightDetails
	}{
		"MACS_MANAGED_CLOUD_EXADATA",
		(MarshalTypeEnableMacsManagedCloudExadataInsightDetails)(m),
	}

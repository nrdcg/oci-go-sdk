...
func (m UpdatePeComanagedHostInsightDetails) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeUpdatePeComanagedHostInsightDetails UpdatePeComanagedHostInsightDetails
	s := struct {
		DiscriminatorParam string `json:"entitySource"`
		MarshalTypeUpdatePeComanagedHostInsightDetails
	}{
		"PE_COMANAGED_HOST",
		(MarshalTypeUpdatePeComanagedHostInsightDetails)(m),
	}

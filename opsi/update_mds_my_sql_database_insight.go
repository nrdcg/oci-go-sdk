...
type UpdateMdsMySqlDatabaseInsight struct {
...
func (m UpdateMdsMySqlDatabaseInsight) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeUpdateMdsMySqlDatabaseInsight UpdateMdsMySqlDatabaseInsight
	s := struct {
		DiscriminatorParam string `json:"entitySource"`
		MarshalTypeUpdateMdsMySqlDatabaseInsight
	}{
		"MDS_MYSQL_DATABASE_SYSTEM",
		(MarshalTypeUpdateMdsMySqlDatabaseInsight)(m),
	}

...
// TestMacsManagedAutonomousDatabaseInsightConnectionDetails Connection details of a MACS-managed Autonomous database .
type TestMacsManagedAutonomousDatabaseInsightConnectionDetails struct {
...
func (m TestMacsManagedAutonomousDatabaseInsightConnectionDetails) String() string {
...
func (m TestMacsManagedAutonomousDatabaseInsightConnectionDetails) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
...
func (m *TestMacsManagedAutonomousDatabaseInsightConnectionDetails) UnmarshalJSON(data []byte) (e error) {
	model := struct {

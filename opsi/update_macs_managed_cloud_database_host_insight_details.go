...
type UpdateMacsManagedCloudDatabaseHostInsightDetails struct {
...
func (m UpdateMacsManagedCloudDatabaseHostInsightDetails) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeUpdateMacsManagedCloudDatabaseHostInsightDetails UpdateMacsManagedCloudDatabaseHostInsightDetails
	s := struct {
		DiscriminatorParam string `json:"entitySource"`
		MarshalTypeUpdateMacsManagedCloudDatabaseHostInsightDetails
	}{
		"MACS_MANAGED_CLOUD_DB_HOST",
		(MarshalTypeUpdateMacsManagedCloudDatabaseHostInsightDetails)(m),
	}

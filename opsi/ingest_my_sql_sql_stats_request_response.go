...
type IngestMySqlSqlStatsRequest struct {

	// Collection of MySql SQL stats objects for a particular database.
	IngestMySqlSqlStatsDetails `contributesTo:"body"`
...
type IngestMySqlSqlStatsResponse struct {

	// The underlying http response
	RawResponse *http.Response

	// The IngestMySqlSqlStatsResponseDetails instance
	IngestMySqlSqlStatsResponseDetails `presentIn:"body"`

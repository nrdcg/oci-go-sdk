...
type CreateMacsManagedCloudExadataInsightDetails struct {
	...
	MemberVmClusterDetails []CreateMacsManagedCloudExadataVmclusterDetails `mandatory:"false" json:"memberVmClusterDetails"`
}
...
func (m CreateMacsManagedCloudExadataInsightDetails) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeCreateMacsManagedCloudExadataInsightDetails CreateMacsManagedCloudExadataInsightDetails
	s := struct {
		DiscriminatorParam string `json:"entitySource"`
		MarshalTypeCreateMacsManagedCloudExadataInsightDetails
	}{
		"MACS_MANAGED_CLOUD_EXADATA",
		(MarshalTypeCreateMacsManagedCloudExadataInsightDetails)(m),
	}

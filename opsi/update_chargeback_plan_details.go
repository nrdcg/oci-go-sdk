...
// UpdateChargebackPlanDetails The details used to update a Ops Insights chargeback plan.
type UpdateChargebackPlanDetails struct {
...
func (m UpdateChargebackPlanDetails) String() string {
...
func (m UpdateChargebackPlanDetails) ValidateEnumValue() (bool, error) {
	errMessage := []string{}

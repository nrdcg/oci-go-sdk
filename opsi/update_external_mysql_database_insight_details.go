...
type UpdateExternalMysqlDatabaseInsightDetails struct {
...
func (m UpdateExternalMysqlDatabaseInsightDetails) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeUpdateExternalMysqlDatabaseInsightDetails UpdateExternalMysqlDatabaseInsightDetails
	s := struct {
		DiscriminatorParam string `json:"entitySource"`
		MarshalTypeUpdateExternalMysqlDatabaseInsightDetails
	}{
		"EXTERNAL_MYSQL_DATABASE_SYSTEM",
		(MarshalTypeUpdateExternalMysqlDatabaseInsightDetails)(m),
	}

...
func (m PerformanceTuningWorkItemDetails) MarshalJSON() (buff []byte, e error) {
	type MarshalTypePerformanceTuningWorkItemDetails PerformanceTuningWorkItemDetails
	s := struct {
		DiscriminatorParam string `json:"kind"`
		MarshalTypePerformanceTuningWorkItemDetails
	}{
		"PERFORMANCE_TUNING",
		(MarshalTypePerformanceTuningWorkItemDetails)(m),
	}

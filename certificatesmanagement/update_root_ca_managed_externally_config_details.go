...
// UpdateRootCaManagedExternallyConfigDetails The configuration details for updating an externally managed private root certificate authority (CA) issued by an external CA.
type UpdateRootCaManagedExternallyConfigDetails struct {
...
func (m UpdateRootCaManagedExternallyConfigDetails) GetVersionName() *string {
	return m.VersionName
}

// GetStage returns Stage
func (m UpdateRootCaManagedExternallyConfigDetails) GetStage() UpdateCertificateAuthorityConfigDetailsStageEnum {
	return m.Stage
}

func (m UpdateRootCaManagedExternallyConfigDetails) String() string {
...
func (m UpdateRootCaManagedExternallyConfigDetails) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
...
func (m UpdateRootCaManagedExternallyConfigDetails) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeUpdateRootCaManagedExternallyConfigDetails UpdateRootCaManagedExternallyConfigDetails
	s := struct {
		DiscriminatorParam string `json:"configType"`
		MarshalTypeUpdateRootCaManagedExternallyConfigDetails
	}{
		"ROOT_CA_MANAGED_EXTERNALLY",
		(MarshalTypeUpdateRootCaManagedExternallyConfigDetails)(m),
	}

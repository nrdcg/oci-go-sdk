...
type LinkWithTenancyNames struct {
	...
	ParentTenancyName *string `mandatory:"true" json:"parentTenancyName"`

	// Name of the child tenancy.
	ChildTenancyName *string `mandatory:"true" json:"childTenancyName"`
...
func (m LinkWithTenancyNames) String() string {
...
func (m LinkWithTenancyNames) ValidateEnumValue() (bool, error) {
	errMessage := []string{}

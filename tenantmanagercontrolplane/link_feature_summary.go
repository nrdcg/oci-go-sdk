...
type LinkFeatureSummary struct {
	...
	PartnerServiceConsoleUrl *string `mandatory:"false" json:"partnerServiceConsoleUrl"`

	// UserGuideUrl of the feature.
	UserGuideUrl *string `mandatory:"false" json:"userGuideUrl"`
}

func (m LinkFeatureSummary) String() string {
...
func (m LinkFeatureSummary) ValidateEnumValue() (bool, error) {
	errMessage := []string{}

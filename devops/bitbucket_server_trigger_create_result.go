...
func (m BitbucketServerTriggerCreateResult) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeBitbucketServerTriggerCreateResult BitbucketServerTriggerCreateResult
	s := struct {
		DiscriminatorParam string `json:"triggerSource"`
		MarshalTypeBitbucketServerTriggerCreateResult
	}{
		"BITBUCKET_SERVER",
		(MarshalTypeBitbucketServerTriggerCreateResult)(m),
	}

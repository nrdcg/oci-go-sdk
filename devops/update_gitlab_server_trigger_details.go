...
func (m UpdateGitlabServerTriggerDetails) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeUpdateGitlabServerTriggerDetails UpdateGitlabServerTriggerDetails
	s := struct {
		DiscriminatorParam string `json:"triggerSource"`
		MarshalTypeUpdateGitlabServerTriggerDetails
	}{
		"GITLAB_SERVER",
		(MarshalTypeUpdateGitlabServerTriggerDetails)(m),
	}

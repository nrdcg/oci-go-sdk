...
func (m UpdateBitbucketCloudTriggerDetails) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeUpdateBitbucketCloudTriggerDetails UpdateBitbucketCloudTriggerDetails
	s := struct {
		DiscriminatorParam string `json:"triggerSource"`
		MarshalTypeUpdateBitbucketCloudTriggerDetails
	}{
		"BITBUCKET_CLOUD",
		(MarshalTypeUpdateBitbucketCloudTriggerDetails)(m),
	}

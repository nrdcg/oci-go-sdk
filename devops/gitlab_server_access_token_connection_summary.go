...
// GitlabServerAccessTokenConnectionSummary Summary information for a connection of the type `GITLAB_SERVER_ACCESS_TOKEN`.
...
func (m GitlabServerAccessTokenConnectionSummary) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeGitlabServerAccessTokenConnectionSummary GitlabServerAccessTokenConnectionSummary
	s := struct {
		DiscriminatorParam string `json:"connectionType"`
		MarshalTypeGitlabServerAccessTokenConnectionSummary
	}{
		"GITLAB_SERVER_ACCESS_TOKEN",
		(MarshalTypeGitlabServerAccessTokenConnectionSummary)(m),
	}

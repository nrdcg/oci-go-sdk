...
// BitbucketCloudAppPasswordConnectionSummary Summary information for a connection of the type `BITBUCKET_CLOUD_APP_PASSWORD`.
...
func (m BitbucketCloudAppPasswordConnectionSummary) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeBitbucketCloudAppPasswordConnectionSummary BitbucketCloudAppPasswordConnectionSummary
	s := struct {
		DiscriminatorParam string `json:"connectionType"`
		MarshalTypeBitbucketCloudAppPasswordConnectionSummary
	}{
		"BITBUCKET_CLOUD_APP_PASSWORD",
		(MarshalTypeBitbucketCloudAppPasswordConnectionSummary)(m),
	}

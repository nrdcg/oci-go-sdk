...
func (m BitbucketServerTriggerSummary) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeBitbucketServerTriggerSummary BitbucketServerTriggerSummary
	s := struct {
		DiscriminatorParam string `json:"triggerSource"`
		MarshalTypeBitbucketServerTriggerSummary
	}{
		"BITBUCKET_SERVER",
		(MarshalTypeBitbucketServerTriggerSummary)(m),
	}

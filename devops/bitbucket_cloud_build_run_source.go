...
func (m BitbucketCloudBuildRunSource) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeBitbucketCloudBuildRunSource BitbucketCloudBuildRunSource
	s := struct {
		DiscriminatorParam string `json:"sourceType"`
		MarshalTypeBitbucketCloudBuildRunSource
	}{
		"BITBUCKET_CLOUD",
		(MarshalTypeBitbucketCloudBuildRunSource)(m),
	}

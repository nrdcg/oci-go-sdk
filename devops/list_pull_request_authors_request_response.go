...
func (request ListPullRequestAuthorsRequest) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
	if _, ok := GetMappingListPullRequestAuthorsSortOrderEnum(string(request.SortOrder)); !ok && request.SortOrder != "" {
		errMessage = append(errMessage, fmt.Sprintf("unsupported enum value for SortOrder: %s. Supported values are: %s.", request.SortOrder, strings.Join(GetListPullRequestAuthorsSortOrderEnumStringValues(), ",")))
	}
	if len(errMessage) > 0 {
...
var mappingListPullRequestAuthorsSortOrderEnum = map[string]ListPullRequestAuthorsSortOrderEnum{
	"ASC":  ListPullRequestAuthorsSortOrderAsc,
	"DESC": ListPullRequestAuthorsSortOrderDesc,
}

var mappingListPullRequestAuthorsSortOrderEnumLowerCase = map[string]ListPullRequestAuthorsSortOrderEnum{
	"asc":  ListPullRequestAuthorsSortOrderAsc,
	"desc": ListPullRequestAuthorsSortOrderDesc,
}
...
func GetListPullRequestAuthorsSortOrderEnumValues() []ListPullRequestAuthorsSortOrderEnum {
	values := make([]ListPullRequestAuthorsSortOrderEnum, 0)
	for _, v := range mappingListPullRequestAuthorsSortOrderEnum {
...
func GetMappingListPullRequestAuthorsSortOrderEnum(val string) (ListPullRequestAuthorsSortOrderEnum, bool) {
	enum, ok := mappingListPullRequestAuthorsSortOrderEnumLowerCase[strings.ToLower(val)]
	return enum, ok
}

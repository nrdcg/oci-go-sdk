...
// GitlabServerAccessTokenConnection The properties that define a connection of the type `GITLAB_SERVER_ACCESS_TOKEN`.
...
func (m GitlabServerAccessTokenConnection) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeGitlabServerAccessTokenConnection GitlabServerAccessTokenConnection
	s := struct {
		DiscriminatorParam string `json:"connectionType"`
		MarshalTypeGitlabServerAccessTokenConnection
	}{
		"GITLAB_SERVER_ACCESS_TOKEN",
		(MarshalTypeGitlabServerAccessTokenConnection)(m),
	}

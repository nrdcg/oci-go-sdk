...
func (m CreateBitbucketCloudTriggerDetails) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeCreateBitbucketCloudTriggerDetails CreateBitbucketCloudTriggerDetails
	s := struct {
		DiscriminatorParam string `json:"triggerSource"`
		MarshalTypeCreateBitbucketCloudTriggerDetails
	}{
		"BITBUCKET_CLOUD",
		(MarshalTypeCreateBitbucketCloudTriggerDetails)(m),
	}

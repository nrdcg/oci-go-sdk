...
func (m CreateBitbucketServerTriggerDetails) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeCreateBitbucketServerTriggerDetails CreateBitbucketServerTriggerDetails
	s := struct {
		DiscriminatorParam string `json:"triggerSource"`
		MarshalTypeCreateBitbucketServerTriggerDetails
	}{
		"BITBUCKET_SERVER",
		(MarshalTypeCreateBitbucketServerTriggerDetails)(m),
	}

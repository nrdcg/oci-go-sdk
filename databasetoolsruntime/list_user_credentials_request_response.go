...
func (request ListUserCredentialsRequest) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
	if _, ok := GetMappingListUserCredentialsSortOrderEnum(string(request.SortOrder)); !ok && request.SortOrder != "" {
		errMessage = append(errMessage, fmt.Sprintf("unsupported enum value for SortOrder: %s. Supported values are: %s.", request.SortOrder, strings.Join(GetListUserCredentialsSortOrderEnumStringValues(), ",")))
	}
	if len(errMessage) > 0 {
...
var mappingListUserCredentialsSortOrderEnum = map[string]ListUserCredentialsSortOrderEnum{
	"ASC":  ListUserCredentialsSortOrderAsc,
	"DESC": ListUserCredentialsSortOrderDesc,
}

var mappingListUserCredentialsSortOrderEnumLowerCase = map[string]ListUserCredentialsSortOrderEnum{
	"asc":  ListUserCredentialsSortOrderAsc,
	"desc": ListUserCredentialsSortOrderDesc,
}
...
func GetListUserCredentialsSortOrderEnumValues() []ListUserCredentialsSortOrderEnum {
	values := make([]ListUserCredentialsSortOrderEnum, 0)
	for _, v := range mappingListUserCredentialsSortOrderEnum {
...
func GetMappingListUserCredentialsSortOrderEnum(val string) (ListUserCredentialsSortOrderEnum, bool) {
	enum, ok := mappingListUserCredentialsSortOrderEnumLowerCase[strings.ToLower(val)]
	return enum, ok
}

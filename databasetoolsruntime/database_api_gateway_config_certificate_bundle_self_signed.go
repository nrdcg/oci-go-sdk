...
func (m DatabaseApiGatewayConfigCertificateBundleSelfSigned) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeDatabaseApiGatewayConfigCertificateBundleSelfSigned DatabaseApiGatewayConfigCertificateBundleSelfSigned
	s := struct {
		DiscriminatorParam string `json:"type"`
		MarshalTypeDatabaseApiGatewayConfigCertificateBundleSelfSigned
	}{
		"SELF_SIGNED",
		(MarshalTypeDatabaseApiGatewayConfigCertificateBundleSelfSigned)(m),
	}

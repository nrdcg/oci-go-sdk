...
func (m UpdateCredentialBasicDetails) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeUpdateCredentialBasicDetails UpdateCredentialBasicDetails
	s := struct {
		DiscriminatorParam string `json:"type"`
		MarshalTypeUpdateCredentialBasicDetails
	}{
		"BASIC",
		(MarshalTypeUpdateCredentialBasicDetails)(m),
	}

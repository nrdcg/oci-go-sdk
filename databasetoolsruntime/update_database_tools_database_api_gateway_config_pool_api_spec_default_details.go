...
func (m UpdateDatabaseToolsDatabaseApiGatewayConfigPoolApiSpecDefaultDetails) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeUpdateDatabaseToolsDatabaseApiGatewayConfigPoolApiSpecDefaultDetails UpdateDatabaseToolsDatabaseApiGatewayConfigPoolApiSpecDefaultDetails
	s := struct {
		DiscriminatorParam string `json:"type"`
		MarshalTypeUpdateDatabaseToolsDatabaseApiGatewayConfigPoolApiSpecDefaultDetails
	}{
		"DEFAULT",
		(MarshalTypeUpdateDatabaseToolsDatabaseApiGatewayConfigPoolApiSpecDefaultDetails)(m),
	}

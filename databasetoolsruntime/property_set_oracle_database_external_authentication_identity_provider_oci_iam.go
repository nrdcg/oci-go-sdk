...
func (m PropertySetOracleDatabaseExternalAuthenticationIdentityProviderOciIam) MarshalJSON() (buff []byte, e error) {
	type MarshalTypePropertySetOracleDatabaseExternalAuthenticationIdentityProviderOciIam PropertySetOracleDatabaseExternalAuthenticationIdentityProviderOciIam
	s := struct {
		DiscriminatorParam string `json:"type"`
		MarshalTypePropertySetOracleDatabaseExternalAuthenticationIdentityProviderOciIam
	}{
		"OCI_IAM",
		(MarshalTypePropertySetOracleDatabaseExternalAuthenticationIdentityProviderOciIam)(m),
	}

...
func (m ValidateDatabaseToolsConnectionPostgresqlDetails) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeValidateDatabaseToolsConnectionPostgresqlDetails ValidateDatabaseToolsConnectionPostgresqlDetails
	s := struct {
		DiscriminatorParam string `json:"type"`
		MarshalTypeValidateDatabaseToolsConnectionPostgresqlDetails
	}{
		"POSTGRESQL",
		(MarshalTypeValidateDatabaseToolsConnectionPostgresqlDetails)(m),
	}

...
func (request GetDatabaseToolsDatabaseApiGatewayConfigGlobalRequest) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
	if _, ok := GetMappingGetDatabaseToolsDatabaseApiGatewayConfigGlobalGlobalKeyEnum(string(request.GlobalKey)); !ok && request.GlobalKey != "" {
		errMessage = append(errMessage, fmt.Sprintf("unsupported enum value for GlobalKey: %s. Supported values are: %s.", request.GlobalKey, strings.Join(GetGetDatabaseToolsDatabaseApiGatewayConfigGlobalGlobalKeyEnumStringValues(), ",")))
	}
	if len(errMessage) > 0 {
...
var mappingGetDatabaseToolsDatabaseApiGatewayConfigGlobalGlobalKeyEnum = map[string]GetDatabaseToolsDatabaseApiGatewayConfigGlobalGlobalKeyEnum{
	"SETTINGS": GetDatabaseToolsDatabaseApiGatewayConfigGlobalGlobalKeySettings,
}

var mappingGetDatabaseToolsDatabaseApiGatewayConfigGlobalGlobalKeyEnumLowerCase = map[string]GetDatabaseToolsDatabaseApiGatewayConfigGlobalGlobalKeyEnum{
	"settings": GetDatabaseToolsDatabaseApiGatewayConfigGlobalGlobalKeySettings,
}
...
func GetGetDatabaseToolsDatabaseApiGatewayConfigGlobalGlobalKeyEnumValues() []GetDatabaseToolsDatabaseApiGatewayConfigGlobalGlobalKeyEnum {
	values := make([]GetDatabaseToolsDatabaseApiGatewayConfigGlobalGlobalKeyEnum, 0)
	for _, v := range mappingGetDatabaseToolsDatabaseApiGatewayConfigGlobalGlobalKeyEnum {
...
func GetMappingGetDatabaseToolsDatabaseApiGatewayConfigGlobalGlobalKeyEnum(val string) (GetDatabaseToolsDatabaseApiGatewayConfigGlobalGlobalKeyEnum, bool) {
	enum, ok := mappingGetDatabaseToolsDatabaseApiGatewayConfigGlobalGlobalKeyEnumLowerCase[strings.ToLower(val)]
	return enum, ok
}

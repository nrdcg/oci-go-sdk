...
func (m PropertySetApexFaIntegration) MarshalJSON() (buff []byte, e error) {
	type MarshalTypePropertySetApexFaIntegration PropertySetApexFaIntegration
	s := struct {
		DiscriminatorParam string `json:"key"`
		MarshalTypePropertySetApexFaIntegration
	}{
		"APEX_FA_INTEGRATION",
		(MarshalTypePropertySetApexFaIntegration)(m),
	}

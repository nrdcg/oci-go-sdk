...
func (m ContainerImageFunctionSourceDetails) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeContainerImageFunctionSourceDetails ContainerImageFunctionSourceDetails
	s := struct {
		DiscriminatorParam string `json:"sourceType"`
		MarshalTypeContainerImageFunctionSourceDetails
	}{
		"CONTAINER_IMAGE",
		(MarshalTypeContainerImageFunctionSourceDetails)(m),
	}

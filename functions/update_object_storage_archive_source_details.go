...
func (m UpdateObjectStorageArchiveSourceDetails) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeUpdateObjectStorageArchiveSourceDetails UpdateObjectStorageArchiveSourceDetails
	s := struct {
		DiscriminatorParam string `json:"archiveSourceType"`
		MarshalTypeUpdateObjectStorageArchiveSourceDetails
	}{
		"OBJECT_STORAGE_ARCHIVE",
		(MarshalTypeUpdateObjectStorageArchiveSourceDetails)(m),
	}

...
func (m UpdateFunctionUpdateRuntimeConfig) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeUpdateFunctionUpdateRuntimeConfig UpdateFunctionUpdateRuntimeConfig
	s := struct {
		DiscriminatorParam string `json:"runtimeConfigType"`
		MarshalTypeUpdateFunctionUpdateRuntimeConfig
	}{
		"FUNCTION_UPDATE",
		(MarshalTypeUpdateFunctionUpdateRuntimeConfig)(m),
	}

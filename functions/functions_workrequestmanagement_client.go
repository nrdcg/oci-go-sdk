...
// # See also
//
// Click https://docs.oracle.com/en-us/iaas/tools/go-sdk-examples/latest/functions/GetWorkRequest.go.html to see an example of how to use GetWorkRequest API.
...
// # See also
//
// Click https://docs.oracle.com/en-us/iaas/tools/go-sdk-examples/latest/functions/ListWorkRequestErrors.go.html to see an example of how to use ListWorkRequestErrors API.
...
// # See also
//
// Click https://docs.oracle.com/en-us/iaas/tools/go-sdk-examples/latest/functions/ListWorkRequestLogs.go.html to see an example of how to use ListWorkRequestLogs API.
...
// # See also
//
// Click https://docs.oracle.com/en-us/iaas/tools/go-sdk-examples/latest/functions/ListWorkRequests.go.html to see an example of how to use ListWorkRequests API.

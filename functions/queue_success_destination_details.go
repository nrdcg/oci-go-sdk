...
// QueueSuccessDestinationDetails The destination queue or channel in the Queue service to which to send the response of the successful detached function invocation.
...
func (m QueueSuccessDestinationDetails) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeQueueSuccessDestinationDetails QueueSuccessDestinationDetails
	s := struct {
		DiscriminatorParam string `json:"kind"`
		MarshalTypeQueueSuccessDestinationDetails
	}{
		"QUEUE",
		(MarshalTypeQueueSuccessDestinationDetails)(m),
	}

...
func (request ListGdpPipelinesRequest) ValidateEnumValue() (bool, error) {
	...
	if _, ok := GetMappingListGdpPipelinesSortByEnum(string(request.SortBy)); !ok && request.SortBy != "" {
		errMessage = append(errMessage, fmt.Sprintf("unsupported enum value for SortBy: %s. Supported values are: %s.", request.SortBy, strings.Join(GetListGdpPipelinesSortByEnumStringValues(), ",")))
	}
	if len(errMessage) > 0 {
...
var mappingListGdpPipelinesSortOrderEnum = map[string]ListGdpPipelinesSortOrderEnum{
	"ASC":  ListGdpPipelinesSortOrderAsc,
	"DESC": ListGdpPipelinesSortOrderDesc,
}

var mappingListGdpPipelinesSortOrderEnumLowerCase = map[string]ListGdpPipelinesSortOrderEnum{
	"asc":  ListGdpPipelinesSortOrderAsc,
	"desc": ListGdpPipelinesSortOrderDesc,
}
...
func GetListGdpPipelinesSortOrderEnumValues() []ListGdpPipelinesSortOrderEnum {
	values := make([]ListGdpPipelinesSortOrderEnum, 0)
	for _, v := range mappingListGdpPipelinesSortOrderEnum {
...
func GetMappingListGdpPipelinesSortOrderEnum(val string) (ListGdpPipelinesSortOrderEnum, bool) {
	enum, ok := mappingListGdpPipelinesSortOrderEnumLowerCase[strings.ToLower(val)]
	return enum, ok
}
...
var mappingListGdpPipelinesSortByEnum = map[string]ListGdpPipelinesSortByEnum{
	"timeCreated": ListGdpPipelinesSortByTimecreated,
	"displayName": ListGdpPipelinesSortByDisplayname,
}

var mappingListGdpPipelinesSortByEnumLowerCase = map[string]ListGdpPipelinesSortByEnum{
	"timecreated": ListGdpPipelinesSortByTimecreated,
	"displayname": ListGdpPipelinesSortByDisplayname,
}
...
func GetListGdpPipelinesSortByEnumValues() []ListGdpPipelinesSortByEnum {
	values := make([]ListGdpPipelinesSortByEnum, 0)
	for _, v := range mappingListGdpPipelinesSortByEnum {
		values = append(values, v)
	}
	return values
}
...
func GetMappingListGdpPipelinesSortByEnum(val string) (ListGdpPipelinesSortByEnum, bool) {
	enum, ok := mappingListGdpPipelinesSortByEnumLowerCase[strings.ToLower(val)]
	return enum, ok
}

...
func (m CreateCpuShapeTaskProfileExtendedInformationDetails) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeCreateCpuShapeTaskProfileExtendedInformationDetails CreateCpuShapeTaskProfileExtendedInformationDetails
	s := struct {
		DiscriminatorParam string `json:"type"`
		MarshalTypeCreateCpuShapeTaskProfileExtendedInformationDetails
	}{
		"CPU_SHAPE_TASK_PROFILE_EXTENDED_INFORMATION",
		(MarshalTypeCreateCpuShapeTaskProfileExtendedInformationDetails)(m),
	}

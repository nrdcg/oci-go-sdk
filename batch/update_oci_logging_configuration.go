...
func (m UpdateOciLoggingConfiguration) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeUpdateOciLoggingConfiguration UpdateOciLoggingConfiguration
	s := struct {
		DiscriminatorParam string `json:"type"`
		MarshalTypeUpdateOciLoggingConfiguration
	}{
		"OCI_LOGGING",
		(MarshalTypeUpdateOciLoggingConfiguration)(m),
	}

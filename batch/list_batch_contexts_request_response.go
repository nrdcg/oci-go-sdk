...
func (request ListBatchContextsRequest) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
	if _, ok := GetMappingBatchContextLifecycleStateEnum(string(request.LifecycleState)); !ok && request.LifecycleState != "" {
		errMessage = append(errMessage, fmt.Sprintf("unsupported enum value for LifecycleState: %s. Supported values are: %s.", request.LifecycleState, strings.Join(GetBatchContextLifecycleStateEnumStringValues(), ",")))
	}
	if _, ok := GetMappingListBatchContextsSortOrderEnum(string(request.SortOrder)); !ok && request.SortOrder != "" {
		errMessage = append(errMessage, fmt.Sprintf("unsupported enum value for SortOrder: %s. Supported values are: %s.", request.SortOrder, strings.Join(GetListBatchContextsSortOrderEnumStringValues(), ",")))
	}
	if _, ok := GetMappingListBatchContextsSortByEnum(string(request.SortBy)); !ok && request.SortBy != "" {
		errMessage = append(errMessage, fmt.Sprintf("unsupported enum value for SortBy: %s. Supported values are: %s.", request.SortBy, strings.Join(GetListBatchContextsSortByEnumStringValues(), ",")))
	}
	if len(errMessage) > 0 {
...
var mappingListBatchContextsSortOrderEnum = map[string]ListBatchContextsSortOrderEnum{
	"ASC":  ListBatchContextsSortOrderAsc,
	"DESC": ListBatchContextsSortOrderDesc,
}

var mappingListBatchContextsSortOrderEnumLowerCase = map[string]ListBatchContextsSortOrderEnum{
	"asc":  ListBatchContextsSortOrderAsc,
	"desc": ListBatchContextsSortOrderDesc,
}
...
func GetListBatchContextsSortOrderEnumValues() []ListBatchContextsSortOrderEnum {
	values := make([]ListBatchContextsSortOrderEnum, 0)
	for _, v := range mappingListBatchContextsSortOrderEnum {
...
func GetMappingListBatchContextsSortOrderEnum(val string) (ListBatchContextsSortOrderEnum, bool) {
	enum, ok := mappingListBatchContextsSortOrderEnumLowerCase[strings.ToLower(val)]
	return enum, ok
}
...
var mappingListBatchContextsSortByEnum = map[string]ListBatchContextsSortByEnum{
	"timeCreated": ListBatchContextsSortByTimecreated,
	"displayName": ListBatchContextsSortByDisplayname,
}

var mappingListBatchContextsSortByEnumLowerCase = map[string]ListBatchContextsSortByEnum{
	"timecreated": ListBatchContextsSortByTimecreated,
	"displayname": ListBatchContextsSortByDisplayname,
}
...
func GetListBatchContextsSortByEnumValues() []ListBatchContextsSortByEnum {
	values := make([]ListBatchContextsSortByEnum, 0)
	for _, v := range mappingListBatchContextsSortByEnum {
		values = append(values, v)
	}
	return values
}
...
func GetMappingListBatchContextsSortByEnum(val string) (ListBatchContextsSortByEnum, bool) {
	enum, ok := mappingListBatchContextsSortByEnumLowerCase[strings.ToLower(val)]
	return enum, ok
}

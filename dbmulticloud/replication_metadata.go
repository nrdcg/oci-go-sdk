...
// ReplicationMetadata Replication metadata, it has information about replication and target region.
type ReplicationMetadata struct {

	// List of all regions and their respective resource ID.
	ReplicationDetails []ReplicationDetails `mandatory:"false" json:"replicationDetails"`
}

func (m ReplicationMetadata) String() string {
...
func (m ReplicationMetadata) ValidateEnumValue() (bool, error) {
	errMessage := []string{}

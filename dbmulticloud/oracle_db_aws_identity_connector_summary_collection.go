...
// OracleDbAwsIdentityConnectorSummaryCollection List of OracleDbAwsIdentityConnectorSummary resources.
type OracleDbAwsIdentityConnectorSummaryCollection struct {

	// This list contains the summary of Oracle DB AWS Identity Connector resources.
	Items []OracleDbAwsIdentityConnectorSummary `mandatory:"true" json:"items"`
}

func (m OracleDbAwsIdentityConnectorSummaryCollection) String() string {
...
func (m OracleDbAwsIdentityConnectorSummaryCollection) ValidateEnumValue() (bool, error) {
	errMessage := []string{}

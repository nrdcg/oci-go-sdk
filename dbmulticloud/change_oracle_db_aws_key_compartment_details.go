...
// ChangeOracleDbAwsKeyCompartmentDetails Details of the new compartment to contain the Oracle DB AWS Key resource.
type ChangeOracleDbAwsKeyCompartmentDetails struct {
...
func (m ChangeOracleDbAwsKeyCompartmentDetails) String() string {
...
func (m ChangeOracleDbAwsKeyCompartmentDetails) ValidateEnumValue() (bool, error) {
	errMessage := []string{}

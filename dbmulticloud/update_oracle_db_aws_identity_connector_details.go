...
// UpdateOracleDbAwsIdentityConnectorDetails This object is about to provide input params to create Oracle DB AWS Identity Connector Resource.
type UpdateOracleDbAwsIdentityConnectorDetails struct {
	...
	ServiceRoleDetails []ServiceRoleDetail `mandatory:"false" json:"serviceRoleDetails"`
...
func (m UpdateOracleDbAwsIdentityConnectorDetails) String() string {
...
func (m UpdateOracleDbAwsIdentityConnectorDetails) ValidateEnumValue() (bool, error) {
	errMessage := []string{}

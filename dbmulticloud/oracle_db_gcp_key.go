...
func (m OracleDbGcpKey) ValidateEnumValue() (bool, error) {
	...
	if _, ok := GetMappingOracleDbGcpKeyLifecycleStateEnum(string(m.LifecycleState)); !ok && m.LifecycleState != "" {
		errMessage = append(errMessage, fmt.Sprintf("unsupported enum value for LifecycleState: %s. Supported values are: %s.", m.LifecycleState, strings.Join(GetOracleDbGcpKeyLifecycleStateEnumStringValues(), ",")))
	}
	if len(errMessage) > 0 {
...
var mappingOracleDbGcpKeyLifecycleStateEnum = map[string]OracleDbGcpKeyLifecycleStateEnum{
	"CREATING": OracleDbGcpKeyLifecycleStateCreating,
	"ACTIVE":   OracleDbGcpKeyLifecycleStateActive,
	"UPDATING": OracleDbGcpKeyLifecycleStateUpdating,
	"DELETING": OracleDbGcpKeyLifecycleStateDeleting,
	"DELETED":  OracleDbGcpKeyLifecycleStateDeleted,
	"FAILED":   OracleDbGcpKeyLifecycleStateFailed,
}

var mappingOracleDbGcpKeyLifecycleStateEnumLowerCase = map[string]OracleDbGcpKeyLifecycleStateEnum{
	"creating": OracleDbGcpKeyLifecycleStateCreating,
	"active":   OracleDbGcpKeyLifecycleStateActive,
	"updating": OracleDbGcpKeyLifecycleStateUpdating,
	"deleting": OracleDbGcpKeyLifecycleStateDeleting,
...
func GetOracleDbGcpKeyLifecycleStateEnumValues() []OracleDbGcpKeyLifecycleStateEnum {
	values := make([]OracleDbGcpKeyLifecycleStateEnum, 0)
	for _, v := range mappingOracleDbGcpKeyLifecycleStateEnum {
...
func GetMappingOracleDbGcpKeyLifecycleStateEnum(val string) (OracleDbGcpKeyLifecycleStateEnum, bool) {
	enum, ok := mappingOracleDbGcpKeyLifecycleStateEnumLowerCase[strings.ToLower(val)]
	return enum, ok
}

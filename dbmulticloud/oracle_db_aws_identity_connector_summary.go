...
// OracleDbAwsIdentityConnectorSummary Oracle DB AWS Identity Connector resource summary.
type OracleDbAwsIdentityConnectorSummary struct {
	...
	ServiceRoleDetails []ServiceRoleDetails `mandatory:"false" json:"serviceRoleDetails"`

	// AWS resource location.
	AwsLocation *string `mandatory:"false" json:"awsLocation"`
...
func (m OracleDbAwsIdentityConnectorSummary) String() string {
...
func (m OracleDbAwsIdentityConnectorSummary) ValidateEnumValue() (bool, error) {
	errMessage := []string{}

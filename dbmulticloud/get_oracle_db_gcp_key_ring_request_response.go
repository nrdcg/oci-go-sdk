...
func (request GetOracleDbGcpKeyRingRequest) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
	if _, ok := GetMappingGetOracleDbGcpKeyRingSortOrderEnum(string(request.SortOrder)); !ok && request.SortOrder != "" {
		errMessage = append(errMessage, fmt.Sprintf("unsupported enum value for SortOrder: %s. Supported values are: %s.", request.SortOrder, strings.Join(GetGetOracleDbGcpKeyRingSortOrderEnumStringValues(), ",")))
	}
	if len(errMessage) > 0 {
...
var mappingGetOracleDbGcpKeyRingSortOrderEnum = map[string]GetOracleDbGcpKeyRingSortOrderEnum{
	"ASC":  GetOracleDbGcpKeyRingSortOrderAsc,
	"DESC": GetOracleDbGcpKeyRingSortOrderDesc,
}

var mappingGetOracleDbGcpKeyRingSortOrderEnumLowerCase = map[string]GetOracleDbGcpKeyRingSortOrderEnum{
	"asc":  GetOracleDbGcpKeyRingSortOrderAsc,
	"desc": GetOracleDbGcpKeyRingSortOrderDesc,
}
...
func GetGetOracleDbGcpKeyRingSortOrderEnumValues() []GetOracleDbGcpKeyRingSortOrderEnum {
	values := make([]GetOracleDbGcpKeyRingSortOrderEnum, 0)
	for _, v := range mappingGetOracleDbGcpKeyRingSortOrderEnum {
...
func GetMappingGetOracleDbGcpKeyRingSortOrderEnum(val string) (GetOracleDbGcpKeyRingSortOrderEnum, bool) {
	enum, ok := mappingGetOracleDbGcpKeyRingSortOrderEnumLowerCase[strings.ToLower(val)]
	return enum, ok
}

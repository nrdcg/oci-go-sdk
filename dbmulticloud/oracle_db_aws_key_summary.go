...
// OracleDbAwsKeySummary Oracle Oracle DB AWS Key Resource Summary.
type OracleDbAwsKeySummary struct {
...
func (m OracleDbAwsKeySummary) String() string {
...
func (m OracleDbAwsKeySummary) ValidateEnumValue() (bool, error) {
	errMessage := []string{}

...
// CreateOracleDbAwsIdentityConnectorDetails Create Oracle DB AWS Identity Connector resource object.
type CreateOracleDbAwsIdentityConnectorDetails struct {
	...
	OidcScope *string `mandatory:"true" json:"oidcScope"`
	...
	ServiceRoleDetails []ServiceRoleDetail `mandatory:"true" json:"serviceRoleDetails"`
...
func (m CreateOracleDbAwsIdentityConnectorDetails) String() string {
...
func (m CreateOracleDbAwsIdentityConnectorDetails) ValidateEnumValue() (bool, error) {
	errMessage := []string{}

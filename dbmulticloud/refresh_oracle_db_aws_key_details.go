...
// RefreshOracleDbAwsKeyDetails Details for to refresh Oracle DB AWS Key resource.
type RefreshOracleDbAwsKeyDetails struct {

	// The OCID (https://docs.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the Oracle DB AWS Connector resource.
	OracleDbAwsConnectorId *string `mandatory:"false" json:"oracleDbAwsConnectorId"`
}

func (m RefreshOracleDbAwsKeyDetails) String() string {
...
func (m RefreshOracleDbAwsKeyDetails) ValidateEnumValue() (bool, error) {
	errMessage := []string{}

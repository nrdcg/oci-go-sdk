...
// ChangeOracleDbAwsIdentityConnectorCompartmentDetails Details of the new compartment to contain the Oracle DB AWS Identity Connector resource.
type ChangeOracleDbAwsIdentityConnectorCompartmentDetails struct {
...
func (m ChangeOracleDbAwsIdentityConnectorCompartmentDetails) String() string {
...
func (m ChangeOracleDbAwsIdentityConnectorCompartmentDetails) ValidateEnumValue() (bool, error) {
	errMessage := []string{}

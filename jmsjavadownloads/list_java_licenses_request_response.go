...
// # See also
//
// Click https://docs.oracle.com/en-us/iaas/tools/go-sdk-examples/latest/jmsjavadownloads/ListJavaLicenses.go.html to see an example of how to use ListJavaLicensesRequest.
...
func (request ListJavaLicensesRequest) ReplaceMandatoryParamInPath(client *common.BaseClient, mandatoryParamMap map[string][]common.TemplateParamForPerRealmEndpoint) {
}
...
const (
	...
	ListJavaLicensesLicenseTypeBcl        ListJavaLicensesLicenseTypeEnum = "BCL"
...
var mappingListJavaLicensesLicenseTypeEnum = map[string]ListJavaLicensesLicenseTypeEnum{
	...
	"BCL":        ListJavaLicensesLicenseTypeBcl,

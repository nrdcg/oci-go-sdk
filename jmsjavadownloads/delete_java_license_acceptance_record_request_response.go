...
// # See also
//
// Click https://docs.oracle.com/en-us/iaas/tools/go-sdk-examples/latest/jmsjavadownloads/DeleteJavaLicenseAcceptanceRecord.go.html to see an example of how to use DeleteJavaLicenseAcceptanceRecordRequest.
...
func (request DeleteJavaLicenseAcceptanceRecordRequest) ReplaceMandatoryParamInPath(client *common.BaseClient, mandatoryParamMap map[string][]common.TemplateParamForPerRealmEndpoint) {
	if mandatoryParamMap["javaLicenseAcceptanceRecordId"] != nil {
		templateParam := mandatoryParamMap["javaLicenseAcceptanceRecordId"]
		for _, template := range templateParam {
			replacementParam := *request.JavaLicenseAcceptanceRecordId

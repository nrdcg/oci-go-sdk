...
// # See also
//
// Click https://docs.oracle.com/en-us/iaas/tools/go-sdk-examples/latest/jmsjavadownloads/ListJavaLicenseAcceptanceRecords.go.html to see an example of how to use ListJavaLicenseAcceptanceRecordsRequest.
...
func (request ListJavaLicenseAcceptanceRecordsRequest) ReplaceMandatoryParamInPath(client *common.BaseClient, mandatoryParamMap map[string][]common.TemplateParamForPerRealmEndpoint) {
...
const (
	...
	ListJavaLicenseAcceptanceRecordsLicenseTypeBcl        ListJavaLicenseAcceptanceRecordsLicenseTypeEnum = "BCL"
...
var mappingListJavaLicenseAcceptanceRecordsLicenseTypeEnum = map[string]ListJavaLicenseAcceptanceRecordsLicenseTypeEnum{
	...
	"BCL":        ListJavaLicenseAcceptanceRecordsLicenseTypeBcl,

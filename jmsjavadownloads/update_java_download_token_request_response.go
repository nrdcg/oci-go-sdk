...
// # See also
//
// Click https://docs.oracle.com/en-us/iaas/tools/go-sdk-examples/latest/jmsjavadownloads/UpdateJavaDownloadToken.go.html to see an example of how to use UpdateJavaDownloadTokenRequest.
...
func (request UpdateJavaDownloadTokenRequest) ReplaceMandatoryParamInPath(client *common.BaseClient, mandatoryParamMap map[string][]common.TemplateParamForPerRealmEndpoint) {
	if mandatoryParamMap["javaDownloadTokenId"] != nil {
		templateParam := mandatoryParamMap["javaDownloadTokenId"]
		for _, template := range templateParam {
			replacementParam := *request.JavaDownloadTokenId

...
type UpdatePrivateSoftwareSourceDetails struct {
...
func (m UpdatePrivateSoftwareSourceDetails) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeUpdatePrivateSoftwareSourceDetails UpdatePrivateSoftwareSourceDetails
	s := struct {
		DiscriminatorParam string `json:"softwareSourceType"`
		MarshalTypeUpdatePrivateSoftwareSourceDetails
	}{
		"PRIVATE",
		(MarshalTypeUpdatePrivateSoftwareSourceDetails)(m),
	}

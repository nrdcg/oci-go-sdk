...
type SysadminEvent struct {
	...
	Data *SysadminEventData `mandatory:"true" json:"data"`
...
func (m SysadminEvent) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeSysadminEvent SysadminEvent
	s := struct {
		DiscriminatorParam string `json:"type"`
		MarshalTypeSysadminEvent
	}{
		"SYSADMIN",
		(MarshalTypeSysadminEvent)(m),
	}

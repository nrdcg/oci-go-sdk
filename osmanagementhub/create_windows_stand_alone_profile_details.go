...
type CreateWindowsStandAloneProfileDetails struct {
...
func (m CreateWindowsStandAloneProfileDetails) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeCreateWindowsStandAloneProfileDetails CreateWindowsStandAloneProfileDetails
	s := struct {
		DiscriminatorParam string `json:"profileType"`
		MarshalTypeCreateWindowsStandAloneProfileDetails
	}{
		"WINDOWS_STANDALONE",
		(MarshalTypeCreateWindowsStandAloneProfileDetails)(m),
	}

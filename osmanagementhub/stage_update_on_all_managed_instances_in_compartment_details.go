...
// StageUpdateOnAllManagedInstancesInCompartmentDetails Provides the information used to update all packages of a specified type on managed instances within the specified compartment.
type StageUpdateOnAllManagedInstancesInCompartmentDetails struct {
...
func (m StageUpdateOnAllManagedInstancesInCompartmentDetails) String() string {
...
func (m StageUpdateOnAllManagedInstancesInCompartmentDetails) ValidateEnumValue() (bool, error) {
	errMessage := []string{}

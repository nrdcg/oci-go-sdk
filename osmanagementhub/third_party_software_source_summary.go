...
type ThirdPartySoftwareSourceSummary struct {
...
func (m ThirdPartySoftwareSourceSummary) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeThirdPartySoftwareSourceSummary ThirdPartySoftwareSourceSummary
	s := struct {
		DiscriminatorParam string `json:"softwareSourceType"`
		MarshalTypeThirdPartySoftwareSourceSummary
	}{
		"THIRD_PARTY",
		(MarshalTypeThirdPartySoftwareSourceSummary)(m),
	}

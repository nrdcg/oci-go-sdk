...
type ThirdPartySoftwareSource struct {
...
func (m ThirdPartySoftwareSource) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeThirdPartySoftwareSource ThirdPartySoftwareSource
	s := struct {
		DiscriminatorParam string `json:"softwareSourceType"`
		MarshalTypeThirdPartySoftwareSource
	}{
		"THIRD_PARTY",
		(MarshalTypeThirdPartySoftwareSource)(m),
	}

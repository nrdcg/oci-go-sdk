...
// StageUpdateOnManagedInstanceDetails Provides the information used to stage updates on an instance.
type StageUpdateOnManagedInstanceDetails struct {
...
func (m StageUpdateOnManagedInstanceDetails) String() string {
...
func (m StageUpdateOnManagedInstanceDetails) ValidateEnumValue() (bool, error) {
	errMessage := []string{}

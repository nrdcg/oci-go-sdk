...
func (m SchemasDatabaseToolsConnectionDetails) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeSchemasDatabaseToolsConnectionDetails SchemasDatabaseToolsConnectionDetails
	s := struct {
		DiscriminatorParam string `json:"connectionType"`
		MarshalTypeSchemasDatabaseToolsConnectionDetails
	}{
		"DATABASE_TOOLS_CONNECTION",
		(MarshalTypeSchemasDatabaseToolsConnectionDetails)(m),
	}

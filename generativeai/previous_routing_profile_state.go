...
// PreviousRoutingProfileState A bounded snapshot of the previous state of a routing profile. This object intentionally omits `previousState` to
// avoid recursive nesting.
type PreviousRoutingProfileState struct {
	...
	LifecycleState RoutingProfileLifecycleStateEnum `mandatory:"false" json:"lifecycleState,omitempty"`
...
func (m PreviousRoutingProfileState) String() string {
...
func (m PreviousRoutingProfileState) ValidateEnumValue() (bool, error) {
	errMessage := []string{}

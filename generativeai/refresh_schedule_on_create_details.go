...
func (m RefreshScheduleOnCreateDetails) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeRefreshScheduleOnCreateDetails RefreshScheduleOnCreateDetails
	s := struct {
		DiscriminatorParam string `json:"type"`
		MarshalTypeRefreshScheduleOnCreateDetails
	}{
		"ON_CREATE",
		(MarshalTypeRefreshScheduleOnCreateDetails)(m),
	}

...
// UpdateHostedApplicationIamDetails The data to update a hosted application.
type UpdateHostedApplicationIamDetails struct {
...
func (m UpdateHostedApplicationIamDetails) String() string {
...
func (m UpdateHostedApplicationIamDetails) ValidateEnumValue() (bool, error) {
	errMessage := []string{}

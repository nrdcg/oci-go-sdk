...
// CreateHostedApplicationIamDetails The details required to create a hosted application.
type CreateHostedApplicationIamDetails struct {
...
func (m CreateHostedApplicationIamDetails) String() string {
...
func (m CreateHostedApplicationIamDetails) ValidateEnumValue() (bool, error) {
	errMessage := []string{}

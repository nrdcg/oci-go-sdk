...
// Availability Describes where and how a model is deployed
type Availability struct {
	...
	ServingModes []ServingModeEnum `mandatory:"false" json:"servingModes"`
	...
	SupportedReplacements []string `mandatory:"false" json:"supportedReplacements"`
}

func (m Availability) String() string {
...
func (m Availability) ValidateEnumValue() (bool, error) {
	errMessage := []string{}

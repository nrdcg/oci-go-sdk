...
func (m CreateSchemasDatabaseToolsConnectionDetails) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeCreateSchemasDatabaseToolsConnectionDetails CreateSchemasDatabaseToolsConnectionDetails
	s := struct {
		DiscriminatorParam string `json:"connectionType"`
		MarshalTypeCreateSchemasDatabaseToolsConnectionDetails
	}{
		"DATABASE_TOOLS_CONNECTION",
		(MarshalTypeCreateSchemasDatabaseToolsConnectionDetails)(m),
	}

...
func (m OutboundNetworkingConfig) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
	if _, ok := GetMappingOutboundNetworkingConfigNetworkModeEnum(string(m.NetworkMode)); !ok && m.NetworkMode != "" {
		errMessage = append(errMessage, fmt.Sprintf("unsupported enum value for NetworkMode: %s. Supported values are: %s.", m.NetworkMode, strings.Join(GetOutboundNetworkingConfigNetworkModeEnumStringValues(), ",")))
	}
...
var mappingOutboundNetworkingConfigNetworkModeEnum = map[string]OutboundNetworkingConfigNetworkModeEnum{
	"MANAGED": OutboundNetworkingConfigNetworkModeManaged,
	"CUSTOM":  OutboundNetworkingConfigNetworkModeCustom,
}

var mappingOutboundNetworkingConfigNetworkModeEnumLowerCase = map[string]OutboundNetworkingConfigNetworkModeEnum{
	"managed": OutboundNetworkingConfigNetworkModeManaged,
	"custom":  OutboundNetworkingConfigNetworkModeCustom,
}
...
func GetOutboundNetworkingConfigNetworkModeEnumValues() []OutboundNetworkingConfigNetworkModeEnum {
	values := make([]OutboundNetworkingConfigNetworkModeEnum, 0)
	for _, v := range mappingOutboundNetworkingConfigNetworkModeEnum {
...
func GetMappingOutboundNetworkingConfigNetworkModeEnum(val string) (OutboundNetworkingConfigNetworkModeEnum, bool) {
	enum, ok := mappingOutboundNetworkingConfigNetworkModeEnumLowerCase[strings.ToLower(val)]
	return enum, ok
}

...
func (m CreateSingleDockerArtifactDetails) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeCreateSingleDockerArtifactDetails CreateSingleDockerArtifactDetails
	s := struct {
		DiscriminatorParam string `json:"artifactType"`
		MarshalTypeCreateSingleDockerArtifactDetails
	}{
		"SIMPLE_DOCKER_ARTIFACT",
		(MarshalTypeCreateSingleDockerArtifactDetails)(m),
	}

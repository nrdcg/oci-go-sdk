...
// CreateHostedApplicationBaseDetails Common creation properties shared by HostedApplication and HostedApplicationIam.
type CreateHostedApplicationBaseDetails struct {
...
func (m CreateHostedApplicationBaseDetails) String() string {
...
func (m CreateHostedApplicationBaseDetails) ValidateEnumValue() (bool, error) {
	errMessage := []string{}

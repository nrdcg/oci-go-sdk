...
func (m CreateApplicationChannelResult) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeCreateApplicationChannelResult CreateApplicationChannelResult
	s := struct {
		DiscriminatorParam string `json:"type"`
		MarshalTypeCreateApplicationChannelResult
	}{
		"APPLICATION",
		(MarshalTypeCreateApplicationChannelResult)(m),
	}

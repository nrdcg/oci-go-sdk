...
func (m TrainSkillQueryEntityParameter) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeTrainSkillQueryEntityParameter TrainSkillQueryEntityParameter
	s := struct {
		DiscriminatorParam string `json:"type"`
		MarshalTypeTrainSkillQueryEntityParameter
	}{
		"QUERY_ENTITY",
		(MarshalTypeTrainSkillQueryEntityParameter)(m),
	}

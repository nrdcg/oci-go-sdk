...
// StartDbSystemDetails DB System start parameters to update ocpu, memory, shape and configuration.
type StartDbSystemDetails struct {
...
func (m StartDbSystemDetails) ValidateEnumValue() (bool, error) {
	errMessage := []string{}

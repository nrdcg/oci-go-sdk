...
// SortingCapability Describes sorting support for an insight type.
type SortingCapability struct {
	...
	DefaultSort *SortingDefault `mandatory:"false" json:"defaultSort"`
}

func (m SortingCapability) String() string {
...
func (m SortingCapability) ValidateEnumValue() (bool, error) {
	errMessage := []string{}

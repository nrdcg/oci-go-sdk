...
// CreateReplicationConfigDetails Details of the replication configuration that is applicable when database system gets the
// PRIMARY_DB_SYSTEM role.
// This configuration does not have any effect on database systems with other roles.
type CreateReplicationConfigDetails struct {
...
func (m CreateReplicationConfigDetails) ValidateEnumValue() (bool, error) {
	errMessage := []string{}

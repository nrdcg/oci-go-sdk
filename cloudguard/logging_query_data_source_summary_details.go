...
func (m LoggingQueryDataSourceSummaryDetails) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeLoggingQueryDataSourceSummaryDetails LoggingQueryDataSourceSummaryDetails
	s := struct {
		DiscriminatorParam string `json:"dataSourceFeedProvider"`
		MarshalTypeLoggingQueryDataSourceSummaryDetails
	}{
		"LOGGINGQUERY",
		(MarshalTypeLoggingQueryDataSourceSummaryDetails)(m),
	}

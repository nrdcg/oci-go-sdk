...
func (m InstanceSecurityServiceConfiguration) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeInstanceSecurityServiceConfiguration InstanceSecurityServiceConfiguration
	s := struct {
		DiscriminatorParam string `json:"serviceConfigurationType"`
		MarshalTypeInstanceSecurityServiceConfiguration
	}{
		"INSTANCE_SECURITY",
		(MarshalTypeInstanceSecurityServiceConfiguration)(m),
	}

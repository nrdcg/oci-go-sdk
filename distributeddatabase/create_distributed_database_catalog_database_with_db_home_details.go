...
// CreateDistributedDatabaseCatalogDatabaseWithDbHomeDetails Configuration for creating a distributed database catalog using a pre-existing Database Home.
type CreateDistributedDatabaseCatalogDatabaseWithDbHomeDetails struct {
...
func (m CreateDistributedDatabaseCatalogDatabaseWithDbHomeDetails) GetTdeWalletPassword() *string {
	return m.TdeWalletPassword
}

// GetTdeWalletPasswordSecretId returns TdeWalletPasswordSecretId
func (m CreateDistributedDatabaseCatalogDatabaseWithDbHomeDetails) GetTdeWalletPasswordSecretId() *string {
	return m.TdeWalletPasswordSecretId
}

// GetTdeWalletPasswordSecretVersionNumber returns TdeWalletPasswordSecretVersionNumber
func (m CreateDistributedDatabaseCatalogDatabaseWithDbHomeDetails) GetTdeWalletPasswordSecretVersionNumber() *int {
	return m.TdeWalletPasswordSecretVersionNumber
}

func (m CreateDistributedDatabaseCatalogDatabaseWithDbHomeDetails) String() string {
...
func (m CreateDistributedDatabaseCatalogDatabaseWithDbHomeDetails) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
...
func (m CreateDistributedDatabaseCatalogDatabaseWithDbHomeDetails) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeCreateDistributedDatabaseCatalogDatabaseWithDbHomeDetails CreateDistributedDatabaseCatalogDatabaseWithDbHomeDetails
	s := struct {
		DiscriminatorParam string `json:"source"`
		MarshalTypeCreateDistributedDatabaseCatalogDatabaseWithDbHomeDetails
	}{
		"EXISTING_DB_HOME",
		(MarshalTypeCreateDistributedDatabaseCatalogDatabaseWithDbHomeDetails)(m),
	}

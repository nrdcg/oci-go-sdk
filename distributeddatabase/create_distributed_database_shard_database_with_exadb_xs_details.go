...
// CreateDistributedDatabaseShardDatabaseWithExadbXsDetails Configuration for creating a distributed database shard using an existing ExaDB-XS VM cluster.
type CreateDistributedDatabaseShardDatabaseWithExadbXsDetails struct {
...
func (m CreateDistributedDatabaseShardDatabaseWithExadbXsDetails) GetTdeWalletPassword() *string {
	return m.TdeWalletPassword
}

// GetTdeWalletPasswordSecretId returns TdeWalletPasswordSecretId
func (m CreateDistributedDatabaseShardDatabaseWithExadbXsDetails) GetTdeWalletPasswordSecretId() *string {
	return m.TdeWalletPasswordSecretId
}

// GetTdeWalletPasswordSecretVersionNumber returns TdeWalletPasswordSecretVersionNumber
func (m CreateDistributedDatabaseShardDatabaseWithExadbXsDetails) GetTdeWalletPasswordSecretVersionNumber() *int {
	return m.TdeWalletPasswordSecretVersionNumber
}

func (m CreateDistributedDatabaseShardDatabaseWithExadbXsDetails) String() string {
...
func (m CreateDistributedDatabaseShardDatabaseWithExadbXsDetails) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
...
func (m CreateDistributedDatabaseShardDatabaseWithExadbXsDetails) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeCreateDistributedDatabaseShardDatabaseWithExadbXsDetails CreateDistributedDatabaseShardDatabaseWithExadbXsDetails
	s := struct {
		DiscriminatorParam string `json:"source"`
		MarshalTypeCreateDistributedDatabaseShardDatabaseWithExadbXsDetails
	}{
		"XS_EXISTING_CLUSTER",
		(MarshalTypeCreateDistributedDatabaseShardDatabaseWithExadbXsDetails)(m),
	}

...
// CreateShardPeerWithDedicatedInfraDetails Details required for creation of autonomous dedicated infrastructure based shard peer.
type CreateShardPeerWithDedicatedInfraDetails struct {
...
func (m CreateShardPeerWithDedicatedInfraDetails) String() string {
...
func (m CreateShardPeerWithDedicatedInfraDetails) ValidateEnumValue() (bool, error) {
	errMessage := []string{}

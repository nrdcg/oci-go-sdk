...
type DistributedDbVmCluster struct {
	...
	LicenseModel DistributedDbVmClusterLicenseModelEnum `mandatory:"false" json:"licenseModel,omitempty"`
...
func (m DistributedDbVmCluster) ValidateEnumValue() (bool, error) {
	errMessage := []string{}

	if _, ok := GetMappingDistributedDbVmClusterLicenseModelEnum(string(m.LicenseModel)); !ok && m.LicenseModel != "" {
		errMessage = append(errMessage, fmt.Sprintf("unsupported enum value for LicenseModel: %s. Supported values are: %s.", m.LicenseModel, strings.Join(GetDistributedDbVmClusterLicenseModelEnumStringValues(), ",")))
	}
	if len(errMessage) > 0 {
...
// DistributedDbVmClusterLicenseModelEnum Enum with underlying type: string
type DistributedDbVmClusterLicenseModelEnum string

// Set of constants representing the allowable values for DistributedDbVmClusterLicenseModelEnum
const (
	DistributedDbVmClusterLicenseModelLicenseIncluded     DistributedDbVmClusterLicenseModelEnum = "LICENSE_INCLUDED"
	DistributedDbVmClusterLicenseModelBringYourOwnLicense DistributedDbVmClusterLicenseModelEnum = "BRING_YOUR_OWN_LICENSE"
)

var mappingDistributedDbVmClusterLicenseModelEnum = map[string]DistributedDbVmClusterLicenseModelEnum{
	"LICENSE_INCLUDED":       DistributedDbVmClusterLicenseModelLicenseIncluded,
	"BRING_YOUR_OWN_LICENSE": DistributedDbVmClusterLicenseModelBringYourOwnLicense,
}

var mappingDistributedDbVmClusterLicenseModelEnumLowerCase = map[string]DistributedDbVmClusterLicenseModelEnum{
	"license_included":       DistributedDbVmClusterLicenseModelLicenseIncluded,
	"bring_your_own_license": DistributedDbVmClusterLicenseModelBringYourOwnLicense,
}

// GetDistributedDbVmClusterLicenseModelEnumValues Enumerates the set of values for DistributedDbVmClusterLicenseModelEnum
func GetDistributedDbVmClusterLicenseModelEnumValues() []DistributedDbVmClusterLicenseModelEnum {
	values := make([]DistributedDbVmClusterLicenseModelEnum, 0)
	for _, v := range mappingDistributedDbVmClusterLicenseModelEnum {
		values = append(values, v)
	}
	return values
}

// GetDistributedDbVmClusterLicenseModelEnumStringValues Enumerates the set of values in String for DistributedDbVmClusterLicenseModelEnum
func GetDistributedDbVmClusterLicenseModelEnumStringValues() []string {
	return []string{
		"LICENSE_INCLUDED",
...
// GetMappingDistributedDbVmClusterLicenseModelEnum performs case Insensitive comparison on enum value and return the desired enum
func GetMappingDistributedDbVmClusterLicenseModelEnum(val string) (DistributedDbVmClusterLicenseModelEnum, bool) {
	enum, ok := mappingDistributedDbVmClusterLicenseModelEnumLowerCase[strings.ToLower(val)]
	return enum, ok
}

...
// CreateDistributedDatabaseShardDatabaseWithExadbXdDetails Configuration for creating a distributed database shard using an existing ExaDB-D VM cluster.
type CreateDistributedDatabaseShardDatabaseWithExadbXdDetails struct {
...
func (m CreateDistributedDatabaseShardDatabaseWithExadbXdDetails) GetTdeWalletPassword() *string {
	return m.TdeWalletPassword
}

// GetTdeWalletPasswordSecretId returns TdeWalletPasswordSecretId
func (m CreateDistributedDatabaseShardDatabaseWithExadbXdDetails) GetTdeWalletPasswordSecretId() *string {
	return m.TdeWalletPasswordSecretId
}

// GetTdeWalletPasswordSecretVersionNumber returns TdeWalletPasswordSecretVersionNumber
func (m CreateDistributedDatabaseShardDatabaseWithExadbXdDetails) GetTdeWalletPasswordSecretVersionNumber() *int {
	return m.TdeWalletPasswordSecretVersionNumber
}

func (m CreateDistributedDatabaseShardDatabaseWithExadbXdDetails) String() string {
...
func (m CreateDistributedDatabaseShardDatabaseWithExadbXdDetails) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
...
func (m CreateDistributedDatabaseShardDatabaseWithExadbXdDetails) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeCreateDistributedDatabaseShardDatabaseWithExadbXdDetails CreateDistributedDatabaseShardDatabaseWithExadbXdDetails
	s := struct {
		DiscriminatorParam string `json:"source"`
		MarshalTypeCreateDistributedDatabaseShardDatabaseWithExadbXdDetails
	}{
		"XD_EXISTING_CLUSTER",
		(MarshalTypeCreateDistributedDatabaseShardDatabaseWithExadbXdDetails)(m),
	}

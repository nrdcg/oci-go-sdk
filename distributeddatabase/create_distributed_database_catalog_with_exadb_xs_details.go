...
func (m CreateDistributedDatabaseCatalogWithExadbXsDetails) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeCreateDistributedDatabaseCatalogWithExadbXsDetails CreateDistributedDatabaseCatalogWithExadbXsDetails
	s := struct {
		DiscriminatorParam string `json:"source"`
		MarshalTypeCreateDistributedDatabaseCatalogWithExadbXsDetails
	}{
		"EXADB_XS",
		(MarshalTypeCreateDistributedDatabaseCatalogWithExadbXsDetails)(m),
	}

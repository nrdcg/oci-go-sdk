...
// CreateDistributedDatabaseShardWithExadbXsNewClusterDetails Configuration for creating a distributed database shard on a new ExaDB-XS VM cluster.
type CreateDistributedDatabaseShardWithExadbXsNewClusterDetails struct {
...
func (m CreateDistributedDatabaseShardWithExadbXsNewClusterDetails) GetTdeWalletPassword() *string {
	return m.TdeWalletPassword
}

// GetTdeWalletPasswordSecretId returns TdeWalletPasswordSecretId
func (m CreateDistributedDatabaseShardWithExadbXsNewClusterDetails) GetTdeWalletPasswordSecretId() *string {
	return m.TdeWalletPasswordSecretId
}

// GetTdeWalletPasswordSecretVersionNumber returns TdeWalletPasswordSecretVersionNumber
func (m CreateDistributedDatabaseShardWithExadbXsNewClusterDetails) GetTdeWalletPasswordSecretVersionNumber() *int {
	return m.TdeWalletPasswordSecretVersionNumber
}

func (m CreateDistributedDatabaseShardWithExadbXsNewClusterDetails) String() string {
...
func (m CreateDistributedDatabaseShardWithExadbXsNewClusterDetails) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
...
func (m CreateDistributedDatabaseShardWithExadbXsNewClusterDetails) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeCreateDistributedDatabaseShardWithExadbXsNewClusterDetails CreateDistributedDatabaseShardWithExadbXsNewClusterDetails
	s := struct {
		DiscriminatorParam string `json:"source"`
		MarshalTypeCreateDistributedDatabaseShardWithExadbXsNewClusterDetails
	}{
		"XS_NEW_CLUSTER",
		(MarshalTypeCreateDistributedDatabaseShardWithExadbXsNewClusterDetails)(m),
	}

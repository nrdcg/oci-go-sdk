...
// CreateDistributedDatabaseCatalogDatabaseWithExadbXdDetails Configuration for creating a distributed database catalog using an existing ExaDB-D VM cluster.
type CreateDistributedDatabaseCatalogDatabaseWithExadbXdDetails struct {
...
func (m CreateDistributedDatabaseCatalogDatabaseWithExadbXdDetails) GetTdeWalletPassword() *string {
	return m.TdeWalletPassword
}

// GetTdeWalletPasswordSecretId returns TdeWalletPasswordSecretId
func (m CreateDistributedDatabaseCatalogDatabaseWithExadbXdDetails) GetTdeWalletPasswordSecretId() *string {
	return m.TdeWalletPasswordSecretId
}

// GetTdeWalletPasswordSecretVersionNumber returns TdeWalletPasswordSecretVersionNumber
func (m CreateDistributedDatabaseCatalogDatabaseWithExadbXdDetails) GetTdeWalletPasswordSecretVersionNumber() *int {
	return m.TdeWalletPasswordSecretVersionNumber
}

func (m CreateDistributedDatabaseCatalogDatabaseWithExadbXdDetails) String() string {
...
func (m CreateDistributedDatabaseCatalogDatabaseWithExadbXdDetails) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
...
func (m CreateDistributedDatabaseCatalogDatabaseWithExadbXdDetails) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeCreateDistributedDatabaseCatalogDatabaseWithExadbXdDetails CreateDistributedDatabaseCatalogDatabaseWithExadbXdDetails
	s := struct {
		DiscriminatorParam string `json:"source"`
		MarshalTypeCreateDistributedDatabaseCatalogDatabaseWithExadbXdDetails
	}{
		"XD_EXISTING_CLUSTER",
		(MarshalTypeCreateDistributedDatabaseCatalogDatabaseWithExadbXdDetails)(m),
	}

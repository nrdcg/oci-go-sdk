...
// CreateDistributedDatabaseShardDatabaseWithDbHomeDetails Configuration for creating a distributed database shard using a pre-existing Database Home.
type CreateDistributedDatabaseShardDatabaseWithDbHomeDetails struct {
...
func (m CreateDistributedDatabaseShardDatabaseWithDbHomeDetails) GetTdeWalletPassword() *string {
	return m.TdeWalletPassword
}

// GetTdeWalletPasswordSecretId returns TdeWalletPasswordSecretId
func (m CreateDistributedDatabaseShardDatabaseWithDbHomeDetails) GetTdeWalletPasswordSecretId() *string {
	return m.TdeWalletPasswordSecretId
}

// GetTdeWalletPasswordSecretVersionNumber returns TdeWalletPasswordSecretVersionNumber
func (m CreateDistributedDatabaseShardDatabaseWithDbHomeDetails) GetTdeWalletPasswordSecretVersionNumber() *int {
	return m.TdeWalletPasswordSecretVersionNumber
}

func (m CreateDistributedDatabaseShardDatabaseWithDbHomeDetails) String() string {
...
func (m CreateDistributedDatabaseShardDatabaseWithDbHomeDetails) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
...
func (m CreateDistributedDatabaseShardDatabaseWithDbHomeDetails) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeCreateDistributedDatabaseShardDatabaseWithDbHomeDetails CreateDistributedDatabaseShardDatabaseWithDbHomeDetails
	s := struct {
		DiscriminatorParam string `json:"source"`
		MarshalTypeCreateDistributedDatabaseShardDatabaseWithDbHomeDetails
	}{
		"EXISTING_DB_HOME",
		(MarshalTypeCreateDistributedDatabaseShardDatabaseWithDbHomeDetails)(m),
	}

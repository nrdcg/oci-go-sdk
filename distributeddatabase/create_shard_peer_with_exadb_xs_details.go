...
// CreateShardPeerWithExadbXsDetails Details required for creation of ExadbXs infrastructure based shard peer.
type CreateShardPeerWithExadbXsDetails struct {
...
func (m CreateShardPeerWithExadbXsDetails) String() string {
...
func (m CreateShardPeerWithExadbXsDetails) ValidateEnumValue() (bool, error) {
	errMessage := []string{}

...
// CreateDistributedDatabaseCatalogWithExadbXsNewClusterDetails Configuration for creating a distributed database catalog on a new ExaDB-XS VM cluster.
type CreateDistributedDatabaseCatalogWithExadbXsNewClusterDetails struct {
...
func (m CreateDistributedDatabaseCatalogWithExadbXsNewClusterDetails) GetTdeWalletPassword() *string {
	return m.TdeWalletPassword
}

// GetTdeWalletPasswordSecretId returns TdeWalletPasswordSecretId
func (m CreateDistributedDatabaseCatalogWithExadbXsNewClusterDetails) GetTdeWalletPasswordSecretId() *string {
	return m.TdeWalletPasswordSecretId
}

// GetTdeWalletPasswordSecretVersionNumber returns TdeWalletPasswordSecretVersionNumber
func (m CreateDistributedDatabaseCatalogWithExadbXsNewClusterDetails) GetTdeWalletPasswordSecretVersionNumber() *int {
	return m.TdeWalletPasswordSecretVersionNumber
}

func (m CreateDistributedDatabaseCatalogWithExadbXsNewClusterDetails) String() string {
...
func (m CreateDistributedDatabaseCatalogWithExadbXsNewClusterDetails) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
...
func (m CreateDistributedDatabaseCatalogWithExadbXsNewClusterDetails) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeCreateDistributedDatabaseCatalogWithExadbXsNewClusterDetails CreateDistributedDatabaseCatalogWithExadbXsNewClusterDetails
	s := struct {
		DiscriminatorParam string `json:"source"`
		MarshalTypeCreateDistributedDatabaseCatalogWithExadbXsNewClusterDetails
	}{
		"XS_NEW_CLUSTER",
		(MarshalTypeCreateDistributedDatabaseCatalogWithExadbXsNewClusterDetails)(m),
	}

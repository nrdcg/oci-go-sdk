...
// CreateDistributedDatabaseShardWithExadbXsNewVaultAndClusterDetails Configuration for creating a distributed database shard on a new ExaDB-XS VM cluster and storage vault.
...
func (m CreateDistributedDatabaseShardWithExadbXsNewVaultAndClusterDetails) GetTdeWalletPassword() *string {
	return m.TdeWalletPassword
}

// GetTdeWalletPasswordSecretId returns TdeWalletPasswordSecretId
func (m CreateDistributedDatabaseShardWithExadbXsNewVaultAndClusterDetails) GetTdeWalletPasswordSecretId() *string {
	return m.TdeWalletPasswordSecretId
}

// GetTdeWalletPasswordSecretVersionNumber returns TdeWalletPasswordSecretVersionNumber
func (m CreateDistributedDatabaseShardWithExadbXsNewVaultAndClusterDetails) GetTdeWalletPasswordSecretVersionNumber() *int {

...
// ComputeHostGroupSummary Summary information for a compute host group.
type ComputeHostGroupSummary struct {
...
func (m ComputeHostGroupSummary) String() string {
...
func (m ComputeHostGroupSummary) ValidateEnumValue() (bool, error) {
	errMessage := []string{}

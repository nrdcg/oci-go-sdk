...
// FirmwareBundleSummary Summary of a firmware bundle, returned in list operations.
type FirmwareBundleSummary struct {
...
func (m FirmwareBundleSummary) String() string {
...
func (m FirmwareBundleSummary) ValidateEnumValue() (bool, error) {
	errMessage := []string{}

...
// CreateComputeHostGroupDetails Detail information for a compute host group.
type CreateComputeHostGroupDetails struct {
	...
	IsTargetedPlacementRequired *bool `mandatory:"true" json:"isTargetedPlacementRequired"`
...
func (m CreateComputeHostGroupDetails) String() string {
...
func (m CreateComputeHostGroupDetails) ValidateEnumValue() (bool, error) {
	errMessage := []string{}

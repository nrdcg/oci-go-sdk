...
func (m DatabaseToolsMcpToolsetGenAiSqlAssistantSummary) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeDatabaseToolsMcpToolsetGenAiSqlAssistantSummary DatabaseToolsMcpToolsetGenAiSqlAssistantSummary
	s := struct {
		DiscriminatorParam string `json:"type"`
		MarshalTypeDatabaseToolsMcpToolsetGenAiSqlAssistantSummary
	}{
		"GENAI_SQL_ASSISTANT",
		(MarshalTypeDatabaseToolsMcpToolsetGenAiSqlAssistantSummary)(m),
	}

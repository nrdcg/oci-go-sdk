...
func (m DatabaseToolsMcpToolsetBuiltInSqlToolsSummary) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeDatabaseToolsMcpToolsetBuiltInSqlToolsSummary DatabaseToolsMcpToolsetBuiltInSqlToolsSummary
	s := struct {
		DiscriminatorParam string `json:"type"`
		MarshalTypeDatabaseToolsMcpToolsetBuiltInSqlToolsSummary
	}{
		"BUILT_IN_SQL_TOOLS",
		(MarshalTypeDatabaseToolsMcpToolsetBuiltInSqlToolsSummary)(m),
	}

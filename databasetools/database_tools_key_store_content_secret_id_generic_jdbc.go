...
func (m DatabaseToolsKeyStoreContentSecretIdGenericJdbc) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeDatabaseToolsKeyStoreContentSecretIdGenericJdbc DatabaseToolsKeyStoreContentSecretIdGenericJdbc
	s := struct {
		DiscriminatorParam string `json:"valueType"`
		MarshalTypeDatabaseToolsKeyStoreContentSecretIdGenericJdbc
	}{
		"SECRETID",
		(MarshalTypeDatabaseToolsKeyStoreContentSecretIdGenericJdbc)(m),
	}

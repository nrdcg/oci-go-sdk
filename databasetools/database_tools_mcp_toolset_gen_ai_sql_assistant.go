...
func (m DatabaseToolsMcpToolsetGenAiSqlAssistant) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeDatabaseToolsMcpToolsetGenAiSqlAssistant DatabaseToolsMcpToolsetGenAiSqlAssistant
	s := struct {
		DiscriminatorParam string `json:"type"`
		MarshalTypeDatabaseToolsMcpToolsetGenAiSqlAssistant
	}{
		"GENAI_SQL_ASSISTANT",
		(MarshalTypeDatabaseToolsMcpToolsetGenAiSqlAssistant)(m),
	}

...
func (m DatabaseToolsKeyStorePasswordSecretIdPostgresqlSummary) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeDatabaseToolsKeyStorePasswordSecretIdPostgresqlSummary DatabaseToolsKeyStorePasswordSecretIdPostgresqlSummary
	s := struct {
		DiscriminatorParam string `json:"valueType"`
		MarshalTypeDatabaseToolsKeyStorePasswordSecretIdPostgresqlSummary
	}{
		"SECRETID",
		(MarshalTypeDatabaseToolsKeyStorePasswordSecretIdPostgresqlSummary)(m),
	}

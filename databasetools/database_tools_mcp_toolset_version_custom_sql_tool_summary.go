...
func (m DatabaseToolsMcpToolsetVersionCustomSqlToolSummary) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeDatabaseToolsMcpToolsetVersionCustomSqlToolSummary DatabaseToolsMcpToolsetVersionCustomSqlToolSummary
	s := struct {
		DiscriminatorParam string `json:"type"`
		MarshalTypeDatabaseToolsMcpToolsetVersionCustomSqlToolSummary
	}{
		"CUSTOM_SQL_TOOL",
		(MarshalTypeDatabaseToolsMcpToolsetVersionCustomSqlToolSummary)(m),
	}

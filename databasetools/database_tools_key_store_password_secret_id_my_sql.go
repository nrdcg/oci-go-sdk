...
func (m DatabaseToolsKeyStorePasswordSecretIdMySql) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeDatabaseToolsKeyStorePasswordSecretIdMySql DatabaseToolsKeyStorePasswordSecretIdMySql
	s := struct {
		DiscriminatorParam string `json:"valueType"`
		MarshalTypeDatabaseToolsKeyStorePasswordSecretIdMySql
	}{
		"SECRETID",
		(MarshalTypeDatabaseToolsKeyStorePasswordSecretIdMySql)(m),
	}

...
func (m DatabaseToolsConnectionOracleDatabaseProxyClientNoProxySummary) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeDatabaseToolsConnectionOracleDatabaseProxyClientNoProxySummary DatabaseToolsConnectionOracleDatabaseProxyClientNoProxySummary
	s := struct {
		DiscriminatorParam string `json:"proxyAuthenticationType"`
		MarshalTypeDatabaseToolsConnectionOracleDatabaseProxyClientNoProxySummary
	}{
		"NO_PROXY",
		(MarshalTypeDatabaseToolsConnectionOracleDatabaseProxyClientNoProxySummary)(m),
	}

...
func (m DatabaseToolsConnectionOracleDatabaseProxyClientNoProxy) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeDatabaseToolsConnectionOracleDatabaseProxyClientNoProxy DatabaseToolsConnectionOracleDatabaseProxyClientNoProxy
	s := struct {
		DiscriminatorParam string `json:"proxyAuthenticationType"`
		MarshalTypeDatabaseToolsConnectionOracleDatabaseProxyClientNoProxy
	}{
		"NO_PROXY",
		(MarshalTypeDatabaseToolsConnectionOracleDatabaseProxyClientNoProxy)(m),
	}

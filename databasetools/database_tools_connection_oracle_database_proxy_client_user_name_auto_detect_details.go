...
func (m DatabaseToolsConnectionOracleDatabaseProxyClientUserNameAutoDetectDetails) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeDatabaseToolsConnectionOracleDatabaseProxyClientUserNameAutoDetectDetails DatabaseToolsConnectionOracleDatabaseProxyClientUserNameAutoDetectDetails
	s := struct {
		DiscriminatorParam string `json:"proxyAuthenticationType"`
		MarshalTypeDatabaseToolsConnectionOracleDatabaseProxyClientUserNameAutoDetectDetails
	}{
		"USER_NAME_AUTO_DETECT",
		(MarshalTypeDatabaseToolsConnectionOracleDatabaseProxyClientUserNameAutoDetectDetails)(m),
	}

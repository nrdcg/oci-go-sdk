...
func (m DatabaseToolsConnectionOracleDatabaseProxyClientUserNameAutoDetectSummary) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeDatabaseToolsConnectionOracleDatabaseProxyClientUserNameAutoDetectSummary DatabaseToolsConnectionOracleDatabaseProxyClientUserNameAutoDetectSummary
	s := struct {
		DiscriminatorParam string `json:"proxyAuthenticationType"`
		MarshalTypeDatabaseToolsConnectionOracleDatabaseProxyClientUserNameAutoDetectSummary
	}{
		"USER_NAME_AUTO_DETECT",
		(MarshalTypeDatabaseToolsConnectionOracleDatabaseProxyClientUserNameAutoDetectSummary)(m),
	}

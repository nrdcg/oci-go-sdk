...
func (m DatabaseToolsMcpServerStorageObjectStorage) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeDatabaseToolsMcpServerStorageObjectStorage DatabaseToolsMcpServerStorageObjectStorage
	s := struct {
		DiscriminatorParam string `json:"type"`
		MarshalTypeDatabaseToolsMcpServerStorageObjectStorage
	}{
		"OBJECT_STORAGE",
		(MarshalTypeDatabaseToolsMcpServerStorageObjectStorage)(m),
	}

...
func (m DatabaseToolsMcpToolsetCustomSqlTool) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeDatabaseToolsMcpToolsetCustomSqlTool DatabaseToolsMcpToolsetCustomSqlTool
	s := struct {
		DiscriminatorParam string `json:"type"`
		MarshalTypeDatabaseToolsMcpToolsetCustomSqlTool
	}{
		"CUSTOM_SQL_TOOL",
		(MarshalTypeDatabaseToolsMcpToolsetCustomSqlTool)(m),
	}

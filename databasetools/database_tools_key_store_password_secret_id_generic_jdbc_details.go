...
func (m DatabaseToolsKeyStorePasswordSecretIdGenericJdbcDetails) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeDatabaseToolsKeyStorePasswordSecretIdGenericJdbcDetails DatabaseToolsKeyStorePasswordSecretIdGenericJdbcDetails
	s := struct {
		DiscriminatorParam string `json:"valueType"`
		MarshalTypeDatabaseToolsKeyStorePasswordSecretIdGenericJdbcDetails
	}{
		"SECRETID",
		(MarshalTypeDatabaseToolsKeyStorePasswordSecretIdGenericJdbcDetails)(m),
	}

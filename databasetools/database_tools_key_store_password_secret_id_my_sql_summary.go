...
func (m DatabaseToolsKeyStorePasswordSecretIdMySqlSummary) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeDatabaseToolsKeyStorePasswordSecretIdMySqlSummary DatabaseToolsKeyStorePasswordSecretIdMySqlSummary
	s := struct {
		DiscriminatorParam string `json:"valueType"`
		MarshalTypeDatabaseToolsKeyStorePasswordSecretIdMySqlSummary
	}{
		"SECRETID",
		(MarshalTypeDatabaseToolsKeyStorePasswordSecretIdMySqlSummary)(m),
	}

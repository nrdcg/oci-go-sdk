...
func (m UpdateDatabaseToolsMcpToolsetGenAiSqlAssistantDetails) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeUpdateDatabaseToolsMcpToolsetGenAiSqlAssistantDetails UpdateDatabaseToolsMcpToolsetGenAiSqlAssistantDetails
	s := struct {
		DiscriminatorParam string `json:"type"`
		MarshalTypeUpdateDatabaseToolsMcpToolsetGenAiSqlAssistantDetails
	}{
		"GENAI_SQL_ASSISTANT",
		(MarshalTypeUpdateDatabaseToolsMcpToolsetGenAiSqlAssistantDetails)(m),
	}

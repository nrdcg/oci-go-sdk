...
func (m DatabaseToolsConnectionPostgresqlSummary) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeDatabaseToolsConnectionPostgresqlSummary DatabaseToolsConnectionPostgresqlSummary
	s := struct {
		DiscriminatorParam string `json:"type"`
		MarshalTypeDatabaseToolsConnectionPostgresqlSummary
	}{
		"POSTGRESQL",
		(MarshalTypeDatabaseToolsConnectionPostgresqlSummary)(m),
	}
...
func (m *DatabaseToolsConnectionPostgresqlSummary) UnmarshalJSON(data []byte) (e error) {
	model := struct {
		...
		KeyStores          []DatabaseToolsKeyStorePostgresqlSummary `json:"keyStores"`
	...
	m.KeyStores = make([]DatabaseToolsKeyStorePostgresqlSummary, len(model.KeyStores))

...
func (m DatabaseToolsKeyStoreContentSecretIdGenericJdbcSummary) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeDatabaseToolsKeyStoreContentSecretIdGenericJdbcSummary DatabaseToolsKeyStoreContentSecretIdGenericJdbcSummary
	s := struct {
		DiscriminatorParam string `json:"valueType"`
		MarshalTypeDatabaseToolsKeyStoreContentSecretIdGenericJdbcSummary
	}{
		"SECRETID",
		(MarshalTypeDatabaseToolsKeyStoreContentSecretIdGenericJdbcSummary)(m),
	}

...
func (m DatabaseToolsMcpToolsetCustomizableReportingTools) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeDatabaseToolsMcpToolsetCustomizableReportingTools DatabaseToolsMcpToolsetCustomizableReportingTools
	s := struct {
		DiscriminatorParam string `json:"type"`
		MarshalTypeDatabaseToolsMcpToolsetCustomizableReportingTools
	}{
		"CUSTOMIZABLE_REPORTING_TOOLS",
		(MarshalTypeDatabaseToolsMcpToolsetCustomizableReportingTools)(m),
	}
